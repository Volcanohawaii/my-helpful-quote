...
const elementPrescriptions12 = { /* (너가 쓰던 그대로) */ 
  "木":[
    ...
    "확장☆ 협업과 외주로 속도를 올리되 품질 체크포인트를 두세요.",
...
const enPrescriptions12 = { /* (너가 쓰던 그대로) */
  ...
  "土":[
    ...
    "Grand Master☆ Resource management is key (time and money).",
  ...
  "水":[
    ...
    "Mastery☆ Reset with walk and sleep at over-immersion signals.",
