...
const i18n = {
    ko: {
        ...
        nextMission: "내세 행복 보장을 위한 수행" // ← 요청하신 대로 수정 완료!
    },
    en: {
        ...
        nextMission: "Soul practice to guarantee afterlife happiness" // ← 영어 버전도 보강!
    }
};
...
console.log("💎 Quotes.js Master loaded with 'Soul Practice' update!");
