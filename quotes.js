...
const detailedDesc81 = {
    1: "<b>목(木)의 발아와 독창성</b> 모든 숫자의 시작이자 태초의 생명력을 의미합니다. 당신의 이름 소리가 이 진동을 만나면 무에서 유를 창조하는 독보적인 독립심으로 발현됩니다. <b>장점</b>은 흔들리지 않는 추진력과 선구자적 기질이지만, <b>단점</b>으로는 주변의 조언을 무시하는 독단에 빠질 우려가 있습니다. <b>조언:</b> 수(水)의 유연함을 받아들여 추진력에 윤활유를 더하십시오.",
    2: "<b>목(木)의 분산과 적응력</b> 하나의 생명이 둘로 나뉘며 환경에 적응하는 기운입니다. 이름의 파동이 이 수리를 통과하면 타인의 감정을 예민하게 읽는 공감 능력이 극대화됩니다. <b>장점</b>은 뛰어난 협동심과 유연함이지만, <b>단점</b>으로는 토(土)의 응집력이 약해 마무리가 흐려지거나 결단력이 부족할 수 있습니다. <b>조언:</b> 자신만의 확고한 루틴을 설계하여 운의 지지대를 확보하십시오.",
    3: "<b>화(火)의 팽창과 명예</b> 불꽃이 피어오르듯 에너지가 사방으로 뻗어 나가는 형상입니다. 당신의 성명 에너지가 이 진동과 결합하면 대중의 시선을 사로잡는 화려한 스타성으로 나타납니다. <b>장점</b>은 창의적 자기표현과 빠른 두뇌 회전이지만, <b>단점</b>으로는 금(金)의 결단력이 부족하여 겉은 화려하나 실속이 없을 수 있습니다. <b>조언:</b> 실질적인 성과를 수치화하여 관리하는 습관을 기르십시오.",
    4: "<b>화(火)의 과열과 변동</b> 열기가 너무 강해 기존의 질서가 타버리고 새로운 변화가 일어나는 기운입니다. 파괴적 혁신을 통해 시대를 앞서가는 감각을 부여합니다. <b>장점</b>은 기존 틀을 깨는 비범한 아이디어지만, <b>단점</b>으로는 수(水)의 냉정함이 결핍되어 감정의 기복으로 일을 그르칠 위험이 있습니다. <b>조언:</b> 중요한 결정 전에는 반드시 24시간의 냉각기를 가지십시오.",
    5: "<b>토(土)의 중심과 안락</b> 대지가 만물을 품어 안듯 모든 기운이 중심으로 모여 안정을 이루는 수리입니다. 이름의 기운이 이 지점에서 균형을 잡으면 주변에 사람이 모이고 재물이 쌓입니다. <b>장점</b>은 두터운 신망과 평온한 가정운이지만, <b>단점</b>으로는 목(木)의 개척 정신이 약해져 매너리즘에 빠지기 쉽습니다. <b>조언:</b> 일상에 작은 변화를 주어 운의 흐름이 고이지 않게 하십시오.",
    6: "<b>토(土)의 응집과 계승</b> 단단한 흙이 보석을 품듯 조상의 덕이나 기존의 기반을 지켜내는 힘이 강합니다. 성명의 파동이 이 안정을 만나면 조직의 핵심에서 신뢰받는 리더가 됩니다. <b>장점</b>은 풍부한 인덕과 성실함이지만, <b>단점</b>으로는 화(火)의 순발력이 부족해 변화의 타이밍을 놓칠 수 있습니다. <b>조언:</b> 새로운 기술과 트렌드를 적극적으로 수용하여 기반을 현대화하십시오.",
    7: "<b>금(金)의 예리함과 성취</b> 정련된 칼날처럼 목표를 향해 날카롭게 파고드는 결단력의 상징입니다. 이름의 소리가 이 금속의 진동을 만나면 타의 추종을 불허하는 전문 지식과 권위를 갖게 됩니다. <b>장점</b>은 강인한 의지와 완벽주의적 성취지만, <b>단점</b>으로는 목(木)의 자비심이 부족해 주변에 적을 만들기 쉽습니다. <b>조언:</b> 칼날을 칼집에 넣듯 부드러운 언어 기술을 연마하십시오.",
    8: "<b>금(金)의 축적과 끈기</b> 단단한 원석이 보석이 되기까지 견뎌내는 집념의 기운입니다. 당신의 이름 에너지가 이 진동과 결합하면 자수성가하여 거대한 부를 일구는 토대가 됩니다. <b>장점</b>은 성실한 자산 축적과 인내심이지만, <b>단점</b>으로는 수(水)의 소통력이 약해 고집불통의 이미지를 줄 수 있습니다. <b>조언:</b> 번 만큼 베푸는 사회적 환원을 통해 명예의 품격을 높이십시오.",
    9: "<b>수(水)의 심연과 통찰</b> 깊은 밤의 바다처럼 보이지 않는 진리와 지혜를 탐구하는 영적인 수리입니다. 이름의 파동이 이 깊은 물을 통과하면 천재적인 직관력과 예술적 감수성을 갖게 됩니다. <b>장점</b>은 비상한 지능과 예리한 감각이지만, <b>단점</b>으로는 화(火)의 현실적 열정이 부족해 고독감과 허무주의에 빠질 수 있습니다. <b>조언:</b> 당신의 아이디어를 실체화해 줄 현실적 파트너와 동행하십시오.",
    10: "<b>수(水)의 종결과 허망</b> 모든 물줄기가 바다에서 하나로 모여 사라지듯, 끝과 시작이 교차하는 공허의 기운입니다. 만물을 수용하는 넓은 마음을 부여하지만 현실적 결실은 약할 수 있습니다. <b>장점</b>은 다재다능함과 비범한 수용력이지만, <b>단점</b>으로는 토(土)의 중심축이 약해 성과가 흩어지기 쉽습니다. <b>조언:</b> 분산된 에너지를 매일 한 가지의 구체적 목표에만 집중시키십시오.",
    11: "<b>목(木)의 재생과 부흥</b> 마른 가지에서 새순이 돋아나듯 위기를 기회로 바꾸는 강력한 생명력의 수리입니다. 이름의 에너지가 이 재생의 기운을 얻으면 정체된 삶에 혁신을 일으킵니다. <b>장점</b>은 빠른 회복력과 주도적인 리더십이지만, <b>단점</b>으로는 초기 성공 후 화(火)의 절제력이 약해져 자만할 수 있습니다. <b>조언:</b> 성취의 순간에 고개를 숙이는 겸손을 시스템화하십시오.",
    12: "<b>목(木)의 고립과 인내</b> 거친 바위 틈에서 자라나는 나무처럼 환경의 제약이 많은 명식입니다. 내적인 사고는 깊어지나 외부와의 소통에서 마찰이 생길 수 있습니다. <b>장점</b>은 독보적인 전문 기술과 깊은 철학적 사고지만, <b>단점</b>으로는 금(金)의 결단력이 부족해 주변에 이용당할 위험이 있습니다. <b>조언:</b> 자신만의 확실한 선을 긋고 주권을 설계하는 법을 배우십시오.",
    13: "<b>화(火)의 광채와 지략</b> 태양이 세상을 비추듯 지혜가 빛을 발하여 대중을 이끄는 달변가의 수리입니다. 이름의 소리가 이 빛의 진동을 만나면 뛰어난 처세술과 언변으로 명성을 얻습니다. <b>장점</b>은 총명함과 탁월한 사교력이지만, <b>단점</b>으로는 수(水)의 깊이가 부족하여 가벼워 보이거나 구설에 오를 수 있습니다. <b>조언:</b> 경청을 통해 타인의 신뢰를 쌓는 침묵의 기술을 병행하십시오.",
    14: "<b>화(火)의 산란과 고민</b> 불꽃이 바람에 흔들리듯 예민한 감각이 분석으로 치우쳐 스스로를 괴롭히는 기운입니다. 사물의 이면을 꿰뚫는 투시 능력은 좋습니다. <b>장점</b>은 정밀한 분석력과 섬세한 감수성이지만, <b>단점</b>으로는 토(土)의 정서적 완충 지대가 부족해 극심한 스트레스를 자초합니다. <b>조언:</b> 명상을 통해 뇌 에너지를 주기적으로 리셋하고 단순하게 사십시오.",
    15: "<b>토(土)의 조화와 덕망</b> 만물을 기르는 대지 위에 비가 내리듯 하늘의 복과 인간의 덕이 합치되는 길수입니다. 당신의 이름이 이 화합의 진동을 만나면 만인을 이끄는 부드러운 카리스마가 생깁니다. <b>장점</b>은 풍부한 인복과 원만한 성품이지만, <b>단점</b>으로는 목(木)의 공격적 추진력이 부족해 결정적 기회를 놓칠 수 있습니다. <b>조언:</b> 가끔은 악역을 자처하더라도 단호한 결단을 연습하십시오.",
    16: "<b>토(土)의 재복과 자비</b> 두터운 흙 속에서 보물이 발견되듯 재물이 스스로 굴러 들어오는 안정된 복록의 상징입니다. 이름의 에너지가 이 지점에 도달하면 경제적 자립도가 급격히 상승합니다. <b>장점</b>은 뜻밖의 횡재수와 안정적인 자산 운영이지만, <b>단점</b>으로는 금(金)의 냉철함이 부족해 타인의 부탁을 거절 못 하고 손해를 봅니다. <b>조언:</b> 공과 사를 칼같이 구분하여 주권적 경제 관념을 세우십시오.",
    17: "<b>금(金)의 투지와 돌파</b> 강철을 벼려 검을 만들듯 어떠한 고난도 정면으로 돌파하는 강력한 투쟁심의 수리입니다. 이름의 소리가 이 금속의 진동을 얻으면 권력과 명예를 동시에 쟁취합니다. <b>장점</b>은 독보적인 결단력과 용기지만, <b>단점</b>으로는 목(木)의 유연함이 결여되어 부러지기 쉬운 성향입니다. <b>조언:</b> 우회로가 때로는 가장 빠른 길임을 명심하고 유연함을 기르십시오.",
    18: "<b>금(金)의 신념과 완성</b> 변치 않는 금석처럼 한 우물을 파서 결국 대업을 완수하는 강력한 의지의 상징입니다. 당신의 성명 에너지가 이 진동과 결합하면 분야의 마스터가 됩니다. <b>장점</b>은 흔들리지 않는 자기 신념과 성실함이지만, <b>단점</b>으로는 화(火)의 융통성이 부족하여 주변과 고립될 우려가 있습니다. <b>조언:</b> 외부 전문가의 피드백을 데이터로 수용하여 자신의 논리를 업데이트하십시오.",
    19: "<b>수(水)의 심연과 직관</b> 수리상 '9'는 깊은 지혜와 영성을 상징하는 수(水)의 극치입니다. 당신의 이름 파동이 이 수리를 통과하면 남들이 보지 못하는 이면을 읽어내는 천재적인 통찰력으로 치환됩니다. <b>장점</b>은 독보적인 예술성과 직관력이지만, <b>단점</b>으로는 현실과의 괴리에서 오는 고독감과 정신적 예민함이 뒤따릅니다. <b>조언:</b> 깊은 생각을 토(土)의 현실적 실행력으로 고정시키고 구체적인 결과물을 만드십시오.",
    20: "<b>수(水)의 범람과 이상</b> 거대한 바다와 같은 에너지가 잠재되어 있으나 이를 가둘 제방(土)이 부족한 형국입니다. 지능은 비상하나 실행력이 분산되는 특성이 있습니다. <b>장점</b>은 원대한 이상과 넓은 포용력이지만, <b>단점</b>으로는 에너지가 흩어져 중도 좌절할 기운이 서려 있습니다. <b>조언:</b> 목(木)의 실행 에너지를 빌려 거대한 목표를 아주 작은 단위로 쪼개어 정복하십시오.",
    21: "<b>목(木)의 두령과 위엄</b> 산 정상을 향해 뻗어가는 거대한 나무의 기상입니다. 조직을 이끄는 카리스마가 당신의 성명 에너지와 결합되어 강력한 권위로 나타납니다. <b>장점</b>은 탁월한 리더십과 책임감이지만, <b>단점</b>으로는 금(金)의 제어가 부족할 경우 독선적으로 비쳐 주변의 반발을 살 수 있습니다. <b>조언:</b> 아랫사람의 의견을 데이터로 수집하고 분석하는 포용력 있는 덕장이 되십시오.",
    22: "<b>목(木)의 기교와 고난</b> 화려한 덩굴 식물이 가지를 뻗듯 재능은 많으나 지지대인 토(土)가 부족하여 늘 마음이 불안정한 기운입니다. <b>장점</b>은 섬세한 기술력과 창의적인 감각이지만, <b>단점</b>으로는 대인관계의 갈등으로 인해 본인의 성과가 저평가될 수 있습니다. <b>조언:</b> 화려한 기교보다 정직한 성실함을 브랜드로 삼아 신뢰를 구축하십시오.",
    23: "<b>화(火)의 융성과 폭발</b> 한낮의 태양처럼 열기가 정점에 달해 창의성과 명예가 폭발하는 강력한 수리입니다. 이름의 파동이 이 불꽃을 만나면 세상의 중심에 서게 됩니다. <b>장점</b>은 압도적인 실행력과 스타성이지만, <b>단점</b>으로는 수(水)의 조절 장치가 약해 성공 후의 과열로 건강을 해칠 수 있습니다. <b>조언:</b> 중요한 결정 전에는 반드시 혼자만의 시간을 가져 열기를 식히십시오.",
    24: "<b>화(火)의 결실과 축재</b> 뜨거운 열기로 황금을 제련하듯 에너지를 실질적인 부로 변환하는 천부적인 능력을 부여합니다. <b>장점</b>은 뛰어난 재무 감각과 안정적인 재산 축적이지만, <b>단점</b>으로는 금(金)의 절제력이 결여되면 탐욕으로 비쳐 명예가 훼손될 수 있습니다. <b>조언:</b> 부의 가치를 높이기 위해 사회적 환원과 나눔을 병행하십시오.",
    25: "<b>토(土)의 조화와 지략</b> 단단한 흙이 물길을 내듯 어떤 위기 상황도 유연하게 넘기는 영리한 중재자의 기운입니다. <b>장점</b>은 빠른 상황 판단력과 대인관계의 원만함이지만, <b>단점</b>으로는 목(木)의 솔직함이 부족하여 기회주의자로 오해받을 수 있습니다. <b>조언:</b> 투명한 소통 방식을 통해 본인의 진정성을 데이터로 증명하십시오.",
    26: "<b>토(土)의 풍파와 영웅</b> 거친 비바람을 견디며 단단해지는 명식으로 위기 속에서 비로소 진가를 발휘하는 영웅적 수리입니다. <b>장점</b>은 불굴의 의지와 위기 관리 능력이지만, <b>단점</b>으로는 화(火)의 평온함이 부족하여 스스로 힘든 길을 자처하는 성향이 있습니다. <b>조언:</b> 불필요한 싸움은 피하고 에너지를 핵심 목표에만 효율적으로 배분하십시오.",
    27: "<b>금(金)의 비판과 고립</b> 정밀한 저울처럼 사물의 시비곡직을 가리는 힘이 최고조에 달한 기운입니다. 이름의 에너지가 이 금속을 만나면 분석의 대가가 됩니다. <b>장점</b>은 신랄한 비판 정신과 논리력이지만, <b>단점</b>으로는 수(水)의 포용력이 약해 주변 사람들과의 거리가 멀어질 수 있습니다. <b>조언:</b> 비판 뒤에는 반드시 건설적인 대안을 제시하여 사람을 살리는 언어를 쓰십시오.",
    28: "<b>금(金)의 팽창과 파란</b> 거대한 쇳덩이가 부딪치듯 큰 사업과 큰 야망을 품는 담력이 좋은 수리입니다. <b>장점</b>은 대범한 지략과 넓은 활동 영역이지만, <b>단점</b>으로는 토(土)의 세밀한 관리력이 부족하여 시스템의 기초가 부실해질 수 있습니다. <b>조언:</b> 디테일에 강한 참모를 곁에 두고 시스템의 구멍을 메우는 일에 집중하십시오.",
    29: "<b>수(水)의 지혜와 평온</b> 흐르는 강물이 바다에 도달하듯 지혜가 완성되어 사회적 지위와 안정을 동시에 거머쥐는 길수입니다. <b>장점</b>은 깊은 통찰력과 두터운 신망이지만, <b>단점</b>으로는 목(木)의 도전 에너지가 약해져 현실에 안주하기 쉽습니다. <b>조언:</b> 끊임없이 새로운 분야를 학습하여 당신의 운세를 젊게 유지하십시오.",
    30: "<b>수(水)의 부침과 역전</b> 바다의 파도처럼 성패가 극단적으로 엇갈리는 드라마틱한 운명의 파동입니다. <b>장점</b>은 어떤 바닥에서도 다시 올라오는 회복력이지만, <b>단점</b>으로는 화(火)의 평정심이 부족하여 감정의 기복에 따라 운이 요동칩니다. <b>조언:</b> 마음의 중심을 잡아줄 확고한 철학적 기반을 구축하여 흔들림을 방지하십시오.",
    31: "<b>목(木)의 인복과 자생</b> 푸른 숲이 비를 만나듯 주변의 도움을 받아 거대한 성취를 이루는 전형적인 자수성가 수리입니다. <b>장점</b>은 뛰어난 대인관계와 행운의 결합이지만, <b>단점</b>으로는 수(水)의 주관이 약해 타인의 의견에 휘둘릴 리스크가 있습니다. <b>조언:</b> 결정적인 순간에는 타인의 조언보다 본인의 데이터를 믿으십시오.",
    32: "<b>목(木)의 통신과 기회</b> 바람을 타고 씨앗이 멀리 퍼지듯 정보와 사람이 당신을 찾아오는 순풍의 기운입니다. <b>장점</b>은 의외의 재물운과 탁월한 소통력이지만, <b>단점</b>으로는 금(金)의 성실함이 뒷받침되지 않으면 요행을 바라는 마음이 생길 수 있습니다. <b>조언:</b> 운이 좋을 때일수록 실력을 더 치열하게 벼리는 내실을 다지십시오.",
    33: "<b>화(火)의 제왕과 실현</b> 태양이 머리 위에 있듯 야망과 실현력이 최고조에 달해 조직의 정점에 서는 수리입니다. <b>장점</b>은 압도적인 카리스마와 명예지만, <b>단점</b>으로는 수(水)의 겸손함이 결여되어 독단으로 적을 만들 위험이 큽니다. <b>조언:</b> 성공의 공을 주변 동료들에게 적극적으로 돌려 당신의 성을 견고하게 지키십시오.",
    34: "<b>화(火)의 인내와 연단</b> 용광로 속에서 철을 녹이듯 뼈를 깎는 인내가 요구되는 명식입니다. 이 시련을 넘기면 위대한 마스터가 됩니다. <b>장점</b>은 극한의 상황을 견디는 정신력이지만, <b>단점</b>으로는 토(土)의 긍정 에너지가 약해지면 극심한 비관주의에 빠질 수 있습니다. <b>조언:</b> 작은 성취를 꾸준히 축하하며 자신에게 긍정적인 데이터를 주입하십시오.",
    35: "<b>토(土)의 온화와 중재</b> 비옥한 들판처럼 평화롭고 온화한 기운이 흘러 주변 사람들을 편안하게 만드는 치유의 수리입니다. <b>장점</b>은 원만한 인간관계와 가정의 행복이지만, <b>단점</b>으로는 화(火)의 개척력이 부족하여 큰 기회를 놓칠 수 있습니다. <b>조언:</b> 안전지대를 벗어나 가끔은 과감하고 파격적인 도전을 시도하십시오.",
    36: "<b>토(土)의 의리와 희생</b> 두터운 흙이 길을 내어 만인이 지나가게 하듯 헌신으로 명예를 쌓는 협객의 기운입니다. <b>장점</b>은 강한 의리와 타인의 추앙이지만, <b>단점</b>으로는 수(水)의 실속 에너지가 부족하여 남 좋은 일만 하다가 본인의 기반을 놓칠 수 있습니다. <b>조언:</b> 자신의 성공이 타인을 돕는 가장 큰 밑천임을 잊지 마십시오.",
    37: "<b>금(金)의 장인과 권위</b> 보석을 깎아내는 정밀함으로 특정 분야의 대체 불가능한 권위자가 되는 전문가의 수리입니다. <b>장점</b>은 독보적인 실력과 독립심이지만, <b>단점</b>으로는 목(木)의 공감력이 결여된 차가운 성격으로 오해받을 수 있습니다. <b>조언:</b> 당신의 기술을 따뜻한 인간적 언어로 공유하여 대중의 지지를 얻으십시오.",
    38: "<b>금(金)의 문학과 예술</b> 예리한 금속 촉으로 글을 쓰듯 감성과 이성이 조화되어 문화적 성취를 거두는 기운입니다. <b>장점</b>은 예리한 표현력과 결과 중심의 성과지만, <b>단점</b>으로는 화(火)의 조급함이 섞이면 절차를 무시하고 무리수를 둘 수 있습니다. <b>조언:</b> 결과보다 과정의 정당성과 공정성을 매 순간 체크하며 나아가십시오.",
    39: "<b>수(水)의 완성과 영광</b> 모든 강물이 바다에 닿아 고요를 찾듯 부귀와 명예가 동시에 찾아오는 완성의 수리입니다. <b>장점</b>은 사회적 지위와 경제적 풍요지만, <b>단점</b>으로는 토(土)의 경각심이 부족해지면 성공의 함정에 빠져 방탕해질 수 있습니다. <b>조언:</b> 최고의 자리에 있을 때 최악의 상황을 대비하는 리스크 관리를 멈추지 마십시오.",
    40: "<b>수(水)의 변동과 불안</b> 바다 한가운데서 폭풍을 만난 형상으로 개척 의지는 강하나 기반이 늘 요동치는 기운입니다. <b>장점</b>은 변화무쌍한 환경에 대한 빠른 적응력이지만, <b>단점</b>으로는 화(火)의 중심 기운이 약해 투기적인 일로 자산을 잃을 위험이 있습니다. <b>조언:</b> 변동성이 큰 일보다는 장기적인 데이터를 기반으로 한 안정적인 길을 선택하십시오.",
    41: "<b>목(木)의 통솔과 성장</b> 거대한 나무가 숲을 이루듯 인덕과 리더십을 결합하여 큰 조직을 이끄는 거물의 수리입니다. <b>장점</b>은 탁월한 경영 능력과 대중의 신뢰지만, <b>단점</b>으로는 금(金)의 자기 관리력이 부족해 과로로 건강을 해칠 수 있습니다. <b>조언:</b> 성공을 위해 몸을 혹사하기보다 휴식과 운동을 경영의 일부로 포함하십시오.",
    42: "<b>목(木)의 자력과 고행</b> 척박한 땅에 홀로 뿌리 내린 나무처럼 초반 고생은 많으나 결국 스스로 일어서는 기운입니다. <b>장점</b>은 누구에게도 의존하지 않는 자생력이지만, <b>단점</b>으로는 토(土)의 지지 기반이 약해 주변의 도움을 받기 힘듭니다. <b>조언:</b> 자기 신뢰를 잃지 마십시오. 당신의 시련은 거대한 성의 단단한 주춧돌이 될 것입니다.",
    43: "<b>화(火)의 과시와 허상</b> 불꽃은 높이 솟으나 연료가 부족하여 겉은 화려하지만 속이 빈 형국의 수리입니다. <b>장점</b>은 뛰어난 브랜드 가치와 외적인 매력이지만, <b>단점</b>으로는 수(水)의 축적 에너지가 부족하여 실질적인 자산 관리에 취약합니다. <b>조언:</b> 보여지는 이미지에 투자하는 돈의 절반을 실질적인 자산 확보에 쓰십시오.",
    44: "<b>화(火)의 미궁과 혁신</b> 에너지가 혼돈 속에 갇혀 방황이 많으나 이를 극복하면 시대를 바꾸는 혁신가가 됩니다. <b>장점</b>은 비범한 창의력과 반전의 드라마지만, <b>단점</b>으로는 토(土)의 평정심이 부족하여 부정적인 생각의 루프에 빠지기 쉽습니다. <b>조언:</b> 부정적인 생각이 들 때는 몸을 움직여 강제로 뇌의 회로를 전환하십시오.",
    45: "<b>토(土)의 통합과 대성</b> 대지가 모든 생명을 하나로 묶어 꽃 피우듯 명예로운 성공과 안정을 동시에 누리는 길수입니다. <b>장점</b>은 두터운 신망과 통합적 리더십이지만, <b>단점</b>으로는 목(木)의 비판적 안목이 약해 주변의 아첨을 구별하지 못할 수 있습니다. <b>조언:</b> 단소리보다 쓴소리를 하는 참모를 가까이 두어 현실 감각을 유지하십시오.",
    46: "<b>토(土)의 고민과 방황</b> 땅이 갈라지듯 내적인 갈등이 많아 통찰력은 좋으나 실천력이 따르지 못하는 기운입니다. <b>장점</b>은 깊은 사유와 이면을 읽는 능력이지만, <b>단점</b>으로는 금(金)의 응집력이 부족해 재능을 여러 곳에 낭비하기 쉽습니다. <b>조언:</b> 오직 한 가지 목표를 정해 10년 이상 깊게 파고드는 집요함을 장착하십시오.",
    47: "<b>금(金)의 견고와 성공</b> 단단한 바위산 위에 핀 꽃처럼 인내의 시간을 거쳐 말년에 거대한 부를 쌓는 대기만성 수리입니다. <b>장점</b>은 변치 않는 신용과 장기적인 자산 형성력이지만, <b>단점</b>으로는 화(火)의 발산력이 약해 젊은 시절 고생이 길어질 수 있습니다. <b>조언:</b> 현재의 시련을 당신의 가치를 증명하기 위한 필수 데이터로 여기십시오.",
    48: "<b>금(金)의 조언과 덕망</b> 예리한 칼을 정의롭게 쓰는 스승처럼 지도자의 참모 역할을 훌륭히 수행하는 인격의 수리입니다. <b>장점</b>은 현명한 판단력과 높은 도덕적 가치지만, <b>단점</b>으로는 수(水)의 유연함이 부족하여 본인의 엄격한 잣대를 타인에게 강요할 수 있습니다. <b>조언:</b> 타인의 실수를 비판하기보다 보완해 주는 자비로운 태도를 기르십시오.",
    49: "<b>수(水)의 유연과 변신</b> 물이 그릇에 따라 모양을 바꾸듯 변화무쌍한 환경에서 최상의 생존력을 발휘하는 기운입니다. <b>장점</b>은 빠른 상황 적응력과 다재다능함이지만, <b>단점</b>으로는 토(土)의 주관이 부족하여 기회주의자로 보일 우려가 있습니다. <b>조언:</b> 상황에 따라 변하더라도 절대 변하지 않는 당신만의 핵심 가치를 정립하십시오.",
    50: "<b>수(水)의 요동과 협력</b> 바다 한가운데서 큰 승부를 거는 도박사적 기질로 인해 성패가 드라마틱하게 나뉘는 수리입니다. <b>장점</b>은 큰 기회를 잡아채는 담력이지만, <b>단점</b>으로는 화(火)의 이성적 통제가 약해 무리한 투자나 배신의 리스크가 큽니다. <b>조언:</b> 직관보다 법적 근거와 데이터적 증거를 우선하여 리스크를 차단하십시오.",
    51: "<b>목(木)의 곡절과 사계</b> 나무가 사계절을 겪으며 나이테를 새기듯 성패의 굴곡이 빈번한 드라마틱한 운명입니다. <b>장점</b>은 풍부한 경험과 변화를 즐기는 역동성이지만, <b>단점</b>으로는 금(金)의 유지력이 부족해 늘 새로 시작해야 할 수도 있습니다. <b>조언:</b> 변화 자체를 당신의 전문 기술로 승화시켜 컨설턴트나 전략가로 활동하십시오.",
    52: "<b>목(木)의 준비와 도약</b> 깊은 숲에서 힘을 기르다 때가 되면 거대한 성취를 이루는 지략가형 수리입니다. <b>장점</b>은 탄탄한 내실과 결정적인 기회 포착 능력이지만, <b>단점</b>으로는 수(水)의 휴식 에너지가 결여되어 피로가 누적될 수 있습니다. <b>조언:</b> 정기적인 건강 검진과 강제적인 휴식을 통해 장기전의 에너지를 비축하십시오.",
    53: "<b>화(火)의 외양과 내빈</b> 타오르는 불길이 겉만 비추어 인맥은 화려하나 진정으로 마음 나눌 곳이 부족한 기운입니다. <b>장점</b>은 뛰어난 사교술과 대중적 인지도지만, <b>단점</b>으로는 토(土)의 진중함이 부족해 사기를 당하거나 이용당할 리스크가 있습니다. <b>조언:</b> 많은 사람보다 진솔한 소수의 관계를 깊게 다지는 것에 에너지를 쓰십시오.",
    54: "<b>화(火)의 억압과 고난</b> 불꽃이 흙에 덮여 빛을 발하지 못하듯 책임감은 강하나 환경이 받쳐주지 않는 형국입니다. <b>장점</b>은 극도의 성실함과 신의지만, <b>단점</b>으로는 금(金)의 재복이 약해 무리하게 사업을 확장하면 패망할 위험이 큽니다. <b>조언:</b> 무리하게 앞서가지 말고 내실을 닦으며 조력자가 나타날 때를 기다리십시오.",
    55: "<b>토(土)의 겸손과 광채</b> 보석이 흙 속에 숨겨져 있어 겸손한 자세를 유지할 때 비로소 가치가 드러나는 수리입니다. <b>장점</b>은 깊은 내공과 신중함이지만, <b>단점</b>으로는 목(木)의 과시욕이 고개를 들면 주변의 시기로 공든 탑이 무너집니다. <b>조언:</b> 화려함을 추구하기보다 '무거움'을 당신의 퍼스널 브랜드로 삼으십시오.",
    56: "<b>토(土)의 우유부단과 정체</b> 대지가 안개에 싸여 길을 찾지 못하듯 재능은 있으나 결정적 순간에 주저하는 기운입니다. <b>장점</b>은 넓은 포용력과 신중함이지만, <b>단점</b>으로는 화(火)의 결단력이 부족해 조연의 역할에 머무르기 쉽습니다. <b>조언:</b> 완벽함보다 빠른 실행을 습관화하여 기회의 타이밍을 데이터로 잡으십시오.",
    57: "<b>금(金)의 질서와 개척</b> 차가운 칼날로 새 길을 내듯 무질서한 환경에서 완벽한 시스템을 세우는 데 성공하는 수리입니다. <b>장점</b>은 독보적인 개척 정신과 질서 수립 능력이지만, <b>단점</b>으로는 수(水)의 포용력이 부족해 독단적 리더가 될 수 있습니다. <b>조언:</b> 성공의 결과물을 구성원들과 공정하게 나누어 내부의 저항을 관리하십시오.",
    58: "<b>금(金)의 끈기와 축적</b> 오랜 세월을 견딘 바위처럼 끈기 있게 노력하여 결국 자수성가하는 성취의 기운입니다. <b>장점</b>은 성실함과 견고한 자산 토대지만, <b>단점</b>으로는 목(木)의 베풂이 부족해 수전노라는 평을 들어 노년이 고립될 수 있습니다. <b>조언:</b> 재물보다 사람을 남기는 투자를 통해 당신의 말년을 풍요롭게 설계하십시오.",
    59: "<b>수(水)의 방랑과 인내</b> 강물이 목적지 없이 흐르듯 재주는 많으나 한 곳에 뿌리 내리지 못하는 기운입니다. <b>장점</b>은 다방면의 비범한 재능과 높은 이상이지만, <b>단점</b>으로는 토(土)의 지탱력이 부족해 유혹에 약하고 끈기가 부족합니다. <b>조언:</b> 강제적인 데드라인과 외부의 규율을 설정하여 당신의 재능을 규격화하십시오.",
    60: "<b>수(水)의 풍파와 갈등</b> 거센 파도가 들이치듯 인간관계에서 배신과 갈등이 잦을 수 있는 드라마틱한 명식입니다. <b>장점</b>은 위기를 겪으며 생기는 노련함과 통찰력이지만, <b>단점</b>으로는 화(火)의 안목이 부족해 사람의 옥석을 가리지 못합니다. <b>조언:</b> 타인의 일에 깊이 개입하기보다 본인의 내면을 강화하는 것에 집중하십시오.",
    61: "<b>목(木)의 현명과 수장</b> 지혜가 완숙해져 조직의 핵심에서 존경받는 지도자 역할을 수행하는 명예의 수리입니다. <b>장점</b>은 고결한 품격과 원칙 준수지만, <b>단점</b>으로는 금(金)의 냉정함이 부족해 사적인 감정에 이끌려 대업을 망칠 수 있습니다. <b>조언:</b> 감정 데이터보다 원칙과 수치 데이터를 최우선 가치로 삼으십시오.",
    62: "<b>목(木)의 연단과 희생</b> 땔감이 되어 불을 밝히듯 남을 돕는 일에 헌신하다 본인의 기운을 소진하기 쉬운 기운입니다. <b>장점</b>은 숭고한 봉사 정신과 자비심이지만, <b>단점</b>으로는 토(土)의 자기 방어 기운이 약해 실속 없이 지칠 수 있습니다. <b>조언:</b> 타인을 돕기 전 본인의 체력과 경제적 기반을 먼저 견고하게 구축하십시오.",
    63: "<b>화(火)의 결실과 성공</b> 열매가 태양의 기운을 받아 빨갛게 익듯 노력에 대한 정당한 보상을 누리는 길수입니다. <b>장점</b>은 원만한 재물운과 사회적 명성이지만, <b>단점</b>으로는 수(水)의 경각심이 약해지면 내부 관리 소홀로 무너질 수 있습니다. <b>조언:</b> 모든 것이 잘 풀릴 때 가장 취약한 부분을 점검하는 습관을 지키십시오.",
    64: "<b>화(火)의 안개와 정체</b> 불꽃이 짙은 안개에 갇혀 자신의 빛을 온전히 발휘하지 못하는 형상의 수리입니다. <b>장점</b>은 내밀한 사유와 신비로운 예술 감각이지만, <b>단점</b>으로는 금(金)의 정리 능력이 부족해 주변 환경이 늘 어수선합니다. <b>조언:</b> 주변의 불필요한 물건과 인맥을 싹 비우고 오직 핵심 가치 하나에만 몰입하십시오.",
    65: "<b>토(土)의 평온과 영광</b> 대지가 만물을 완성하여 추수하듯 삶의 후반기에 높은 명예를 얻는 최고의 길수입니다. <b>장점</b>은 완벽한 복덕과 타인의 추앙이지만, <b>단점</b>으로는 목(木)의 오만함이 생겨 아랫사람의 마음을 잃을 수 있습니다. <b>조언:</b> 높은 자리에 있을수록 가장 낮은 곳의 데이터를 살피는 자세를 유지하십시오.",
    66: "<b>토(土)의 동요와 신용</b> 지진이 일어난 땅처럼 사람을 잘못 믿어 그간 쌓아온 신용이 추락할 수 있는 기운입니다. <b>장점</b>은 유연한 상황 대처와 포용력이지만, <b>단점</b>으로는 수(水)의 유연함이 독이 되어 무리한 부탁을 거절하지 못합니다. <b>조언:</b> 보증이나 금전 거래는 절대 금물이며, 모든 계약은 서류로 명확히 처리하십시오.",
    67: "<b>금(金)의 예술과 통솔</b> 정교한 악기를 연주하듯 섬세한 감각과 리더십을 결합하여 독창적 성취를 거두는 기운입니다. <b>장점</b>은 창의적 조직 운영과 미적 감각이지만, <b>단점</b>으로는 화(火)의 사교 에너지가 부족하여 소외감을 느낄 수 있습니다. <b>조언:</b> 팀원들과 감정적 주파수를 맞추는 시간을 정기적으로 계획에 포함하십시오.",
    68: "<b>금(金)의 지략과 창업</b> 정밀한 설계도로 건물을 올리듯 완벽한 전략으로 시스템을 구축하여 성공하는 수리입니다. <b>장점</b>은 비범한 지모와 흔들리지 않는 경영 감각이지만, <b>단점</b>으로는 목(木)의 인간미가 결여되어 주변을 숨 막히게 할 수 있습니다. <b>조언:</b> 효율적인 명령 체계 위에 인간적인 유머와 여유를 한 방울 섞으십시오.",
    69: "<b>수(水)의 고립과 정체</b> 물이 한곳에 고여 썩기 쉽듯 꿈은 원대하나 현실적인 실행 데이터가 뒷받침되지 않는 기운입니다. <b>장점</b>은 깊은 학문적 소양과 높은 정신 세계지만, <b>단점</b>으로는 토(土)의 지지력이 없어 조급함으로 무리수를 두기 쉽습니다. <b>조언:</b> 기본기부터 다시 다지십시오. 당신의 운은 기초가 튼튼할 때 비로소 흐릅니다.",
    70: "<b>수(水)의 멸절과 공허</b> 모든 에너지가 소멸하고 휴식기에 접어든 형국으로 뼈 빠지게 일해도 보상이 적은 수리입니다. <b>장점</b>은 세속적 욕망에서 벗어난 고결한 정신성이지만, <b>단점</b>으로는 화(火)의 밝은 기운이 부족해 우울감에 빠질 수 있습니다. <b>조언:</b> 종교나 명상, 봉사 활동을 통해 보이지 않는 가치를 삶의 의미로 삼으십시오.",
    71: "<b>목(木)의 내실과 완벽</b> 나무가 단단하게 굳어 재목이 되듯 전문성으로 응집되어 흔들리지 않는 부를 누리는 기운입니다. <b>장점</b>은 독보적인 전문가적 권위와 실리 추구지만, <b>단점</b>으로는 금(金)의 융통성이 결여되어 자기만의 성안에 갇힐 수 있습니다. <b>조언:</b> 당신의 기준에 맞지 않는 사람들도 포용할 수 있는 바다와 같은 마음을 연습하십시오.",
    72: "<b>목(木)의 요동과 추진</b> 성장이 너무 빨라 내실이 약해질 수 있는 명식으로 추진력은 좋으나 기복이 심한 기운입니다. <b>장점</b>은 젊고 역동적인 에너지와 도전 정신이지만, <b>단점</b>으로는 수(水)의 리스크 관리가 안 되어 감정적 투자가 손실로 이어집니다. <b>조언:</b> 모든 투자의 근거를 숫자에 기반하고, 열기가 오를 때 한 걸음 물러나십시오.",
    73: "<b>화(火)의 마무리와 질서</b> 불이 꺼지기 전 가장 밝은 빛을 내듯 지혜롭게 삶을 정돈하고 새 시대를 준비하는 수리입니다. <b>장점</b>은 원숙한 판단력과 명예로운 마무리지만, <b>단점</b>으로는 토(土)의 안주 기운이 강해지면 미래 권력을 놓치게 됩니다. <b>조언:</b> 과거의 영광에 집착하지 말고 당신의 노하우를 후대에 전수하는 교육자가 되십시오.",
    74: "<b>화(火)의 쇠퇴와 고난</b> 연료가 떨어진 등불처럼 환경적 제약으로 인해 능력을 발휘하기 힘든 고단한 수리입니다. <b>장점</b>은 극한을 견디는 인내와 도덕적 자부심이지만, <b>단점</b>으로는 목(木)의 희망 에너지가 고갈되어 비관적 선택을 하기 쉽습니다. <b>조언:</b> 철학이나 역사 공부를 통해 인간 삶의 거대한 인과율을 공부하고 멘탈을 강화하십시오.",
    75: "<b>토(土)의 균형과 평화</b> 대지가 완전한 평형을 이루어 만물이 안식하듯 평화롭고 안정적인 노년을 보장하는 길수입니다. <b>장점</b>은 높은 인격과 균형 잡힌 가치관이지만, <b>단점</b>으로는 금(金)의 결단력이 부족하여 결정적 순간에 실기를 할 수 있습니다. <b>조언:</b> 인생의 중요 고비에서는 타인의 의견에 묻어가지 말고 단호한 결단을 내리십시오.",
    76: "<b>토(土)의 분산과 유출</b> 흙이 바람에 날리듯 실속 없이 에너지가 새어나가고 지출이 많은 불안정한 기운입니다. <b>장점</b>은 넓은 활동 범위와 대범한 씀씀이지만, <b>단점</b>으로는 수(水)의 응집력이 결여되어 버는 만큼 모이지 않는 고질적 병폐가 있습니다. <b>조언:</b> 자산 관리 전문가의 도움을 받거나 강제적으로 돈을 묶어두는 시스템을 마련하십시오.",
    77: "<b>금(金)의 원칙과 투쟁</b> 칼과 칼이 부딪치듯 자신의 옳음만을 고집하여 외부와 끊임없이 마찰을 빚는 기운입니다. <b>장점</b>은 강직한 원칙 준수와 불의에 맞서는 용기지만, <b>단점</b>으로는 목(木)의 조화 기운이 약해 성패가 자주 엇갈립니다. <b>조언:</b> '내가 옳다'는 생각보다 '함께 살아야 한다'는 상생의 가치를 제1원칙으로 삼으십시오.",
    78: "<b>금(金)의 신중과 예방</b> 칼을 칼집에 넣고 주변을 살피듯 극도의 조심성으로 초반 안정을 꾀하는 선길후흉의 기운입니다. <b>장점</b>은 완벽한 준비성과 리스크 관리력이지만, <b>단점</b>으로는 화(火)의 낙천적 에너지가 부족해 걱정만 하느라 도전하지 못합니다. <b>조언:</b> 일어날 확률이 5% 미만인 걱정은 데이터로 삭제하고 과감히 세상 밖으로 나가십시오.",
    79: "<b>수(수)의 은둔과 지혜</b> 깊은 골짜기의 샘물처럼 지혜는 깊으나 알아주는 이가 없어 고독하게 세월을 보내는 기운입니다. <b>장점</b>은 명예를 탐하지 않는 고결함과 전문 지식이지만, <b>단점</b>으로는 토(土)의 자기 홍보력이 약해 능력을 썩히기 쉽습니다. <b>조언:</b> 당신의 깊은 통찰을 세상과 나누십시오. 적극적으로 홍보할 때 당신의 명성이 비로소 흐릅니다.",
    80: "<b>수(水)의 종말과 성찰</b> 모든 물이 바다 끝에서 고요해지듯 정신적 고결함은 높으나 세속적인 운세는 약해진 기운입니다. <b>장점</b>은 우주의 진리를 깨닫는 명상적 지혜지만, <b>단점</b>으로는 화(火)의 생기가 부족해 현실 세계와 유리될 리스크가 큽니다. <b>조언:</b> 소소한 일상의 기쁨을 찾아 매일 햇볕을 쬐고 몸의 감각을 일깨우는 습관을 가지십시오.",
    81: "<b>환희의 대순환과 완성</b> 81수리의 마지막이자 다시 1로 돌아가는 오행의 대화합 지점으로, 완벽한 복덕을 누리는 숫자입니다. 당신의 이름이 도달한 이 지점은 새로운 차원의 운명을 여는 환희의 문입니다. <b>장점</b>은 만물과의 조화와 최상의 명예운이지만, <b>단점</b>으로는 성공에 취해 목(木)의 자만심이 생겨 시련을 자초할 수 있습니다. <b>조언:</b> 얻은 성취를 사회에 환원하는 순환의 법칙을 실천할 때 당신의 운명은 영원히 빛날 것입니다."
};
const detailedDesc81En = {
    1: "<b>Wood: Sprouting and Originality</b> This is the origin of all numbers, symbolizing primordial vital energy. When your name resonance meets this vibration, it manifests as unrivaled independence to create something from nothing. <b>Strengths</b> include relentless drive and a pioneering spirit, while <b>weaknesses</b> involve a tendency toward dogmatism, ignoring external feedback. <b>Advice:</b> Incorporate the flexibility of Water to lubricate your forward momentum.",
    2: "<b>Wood: Fragmentation and Adaptability</b> Represents a single life splitting into two to adapt to the environment. This resonance maximizes your empathetic ability to sense others' emotions. <b>Strengths</b> are exceptional cooperation and flexibility, but <b>weaknesses</b> include weak Earth-cohesion, leading to indecision or a lack of closure. <b>Advice:</b> Design a firm personal routine to secure a solid foundation for your fortune.",
    3: "<b>Fire: Expansion and Honor</b> Like a rising flame, this energy spreads in all directions. When combined with your name energy, it manifests as a radiant 'star quality' that draws public attention. <b>Strengths</b> include creative self-expression and quick wit, but <b>weaknesses</b> involve a lack of Metal-decisiveness, risking a flashy exterior with little substance. <b>Advice:</b> Develop a habit of quantifying and managing your practical achievements.",
    4: "<b>Fire: Overheating and Volatility</b> Excessive heat that burns old orders to spark new transformation. It grants a visionary sense ahead of its time. <b>Strengths</b> are radical innovation and extraordinary ideas, but <b>weaknesses</b> include a lack of Water-calm, risking failure through emotional instability. <b>Advice:</b> Establish a 24-hour 'cooling period' before making any major life decisions.",
    5: "<b>Earth: Centrality and Comfort</b> Like the earth embracing all life, all energies gather at the center to achieve stability. If your name balances here, people and wealth naturally accumulate. <b>Strengths</b> are deep public trust and a peaceful domestic life, but <b>weaknesses</b> involve a loss of Wood-pioneering spirit, leading to complacency. <b>Advice:</b> Introduce small changes into your daily life to prevent your luck from stagnating.",
    6: "<b>Earth: Cohesion and Heritage</b> Firm soil protecting jewels, symbolizing the power to preserve ancestral legacy or existing foundations. This vibration makes you a trusted leader at the core of an organization. <b>Strengths</b> are abundant social virtue and sincerity, but <b>weaknesses</b> involve a lack of Fire-agility, causing missed timings. <b>Advice:</b> Actively embrace new technologies and trends to modernize your foundations.",
    7: "<b>Metal: Sharpness and Achievement</b> Symbolizes a refined blade piercing through goals with sharp decisiveness. This resonance grants unrivaled expertise and authority. <b>Strengths</b> are invincible will and perfectionist achievement, but <b>weaknesses</b> involve a lack of Wood-mercy, making it easy to create enemies. <b>Advice:</b> Like a blade in a sheath, refine the art of soft and diplomatic communication.",
    8: "<b>Metal: Accumulation and Grit</b> The energy of persistence, where raw ore endures until it becomes a gem. When combined with your name, it forms the foundation for self-made wealth. <b>Strengths</b> are diligent asset accumulation and endurance, but <b>weaknesses</b> include weak Water-communication, risking a stubborn image. <b>Advice:</b> Enhance the dignity of your honor through social contribution and sharing.",
    9: "<b>Water: Abyss and Insight</b> A spiritual vibration exploring invisible truths and wisdom like the deep sea at night. It grants extraordinary intuition and artistic sensitivity. <b>Strengths</b> are brilliant intelligence and keen senses, but <b>weaknesses</b> involve a lack of Fire-passion, leading to solitude and nihilism. <b>Advice:</b> Walk alongside a realistic partner who can help manifest your abstract visions.",
    10: "<b>Water: Termination and Void</b> A state where all rivers meet the sea and vanish, symbolizing the intersection of ends and beginnings. It grants a vast heart but may yield weak practical results. <b>Strengths</b> are versatility and extraordinary receptivity, but <b>weaknesses</b> involve a weak Earth-axis, causing results to scatter. <b>Advice:</b> Focus your fragmented energy on a single, concrete goal every single day.",
    11: "<b>Wood: Revival and Prosperity</b> Like a sprout emerging from a dry branch, this is the power to turn crisis into opportunity. It brings innovation to a stagnant life. <b>Strengths</b> are fast recovery and proactive leadership, but <b>weaknesses</b> involve potential arrogance after initial success due to weak Fire-regulation. <b>Advice:</b> Systematize humility the moment you reach your peak of achievement.",
    12: "<b>Wood: Isolation and Endurance</b> Like a tree growing in a rock crevice, this profile faces many environmental constraints. While inner thought deepens, social friction may arise. <b>Strengths</b> are unrivaled technical expertise and deep philosophical thought, but <b>weaknesses</b> include a lack of Metal-decisiveness, risking exploitation. <b>Advice:</b> Learn to draw clear personal boundaries and design your own sovereignty.",
    13: "<b>Fire: Radiance and Strategy</b> Wisdom that shines like the sun to enlighten the masses. This resonance brings fame through exceptional eloquence and social wit. <b>Strengths</b> are brilliance and superb sociability, but <b>weaknesses</b> involve shallow Water-depth, risking a light image or scandals. <b>Advice:</b> Practice the art of silence and active listening to build deeper trust with others.",
    14: "<b>Fire: Scattering and Deliberation</b> A sensitive sense that flickers like a flame in the wind, often leading to over-analysis and self-torment. You see hidden truths well. <b>Strengths</b> are precise analytical power and delicate sensitivity, but <b>weaknesses</b> include a lack of Earth-buffer, causing extreme stress. <b>Advice:</b> Regularly reset your mental energy through meditation and keep your life simple.",
    15: "<b>Earth: Harmony and Prestige</b> A lucky state where divine blessing meets human virtue, like rain falling on fertile land. It creates a soft charisma that leads many. <b>Strengths</b> are abundant social luck and a harmonious nature, but <b>weaknesses</b> involve a lack of Wood-aggression, causing missed opportunities. <b>Advice:</b> Practice firm decisiveness even if you must occasionally play the 'tough' role.",
    16: "<b>Earth: Wealth and Compassion</b> Symbolizes stable fortune where wealth is discovered like treasure in the soil. This profile enjoys high financial independence. <b>Strengths</b> are unexpected windfalls and stable asset management, but <b>weaknesses</b> involve weak Metal-logic, risking personal loss by failing to say 'no.' <b>Advice:</b> Strictly separate business from personal sentiment to protect your assets.",
    17: "<b>Metal: Will and Breakthrough</b> A powerful competitive spirit that breaks through hardships like a forged sword. This profile acquires both power and honor. <b>Strengths</b> are unrivaled decisiveness and courage, but <b>weaknesses</b> involve a lack of Wood-flexibility, making you prone to snapping under pressure. <b>Advice:</b> Remember that detours are often shortcuts; cultivate strategic flexibility.",
    18: "<b>Metal: Conviction and Completion</b> Symbolizes an invincible will that digs 'one well' until a grand task is completed. You are destined to be a master of your field. <b>Strengths</b> are unshakeable self-belief and sincerity, but <b>weaknesses</b> involve a lack of Fire-adaptability, risking social isolation. <b>Advice:</b> Use external feedback as data to periodically update and upgrade your own logic.",
    19: "<b>Water: Deep Sea and Intuition</b> The number 9 represents the peak of Water, symbolizing profound wisdom and spirituality. This resonance creates a genius-level insight into the hidden side of things. <b>Strengths</b> are unique artistry and intuition, but <b>weaknesses</b> involve emotional sensitivity and detachment from reality. <b>Advice:</b> Ground your deep thoughts with Earth’s practical execution and create concrete results.",
    20: "<b>Water: Flood and Idealism</b> Possesses massive energy like the ocean, but lacks the levee (Earth) to contain it. Intelligence is high, but execution tends to scatter. <b>Strengths</b> are grand vision and vast tolerance, but <b>weaknesses</b> include a risk of mid-way collapse. <b>Advice:</b> Borrow Wood’s execution energy to break your grand goals into very small, manageable units.",
    21: "<b>Wood: Sovereignty and Dignity</b> The majestic image of a giant tree reaching the mountain peak. Your charisma and authority manifest powerfully. <b>Strengths</b> are superb leadership and responsibility, but <b>weaknesses</b> include potential dogmatism without Metal-regulation. <b>Advice:</b> Become a magnanimous leader who collects and analyzes the concerns of subordinates as vital data.",
    22: "<b>Wood: Artistry and Hardship</b> Like a flowering vine, you have much talent but lack the Earth-support, leading to emotional instability. <b>Strengths</b> are delicate technical skills and creative sense, but <b>weaknesses</b> involve relationship friction devaluing your achievements. <b>Advice:</b> Focus on honest sincerity over flashy tricks to build long-term trust as your brand.",
    23: "<b>Fire: Prosperity and Explosion</b> Like the midday sun, heat peaks to explode into creativity and fame. This profile puts you at the center of the world. <b>Strengths</b> are overwhelming execution and star power, but <b>weaknesses</b> include weak Water-cooling, risking health failure through over-exertion. <b>Advice:</b> Take intentional solo time to cool your inner heat before making major moves.",
    24: "<b>Fire: Fruition and Accumulation</b> Grants the innate talent to refine gold with heat, converting energy into tangible wealth. <b>Strengths</b> are superb fiscal sense and stable asset gathering, but <b>weaknesses</b> involve a lack of Metal-moderation, risking a greedy image. <b>Advice:</b> Balance your wealth building with social contribution to elevate your reputation.",
    25: "<b>Earth: Harmony and Resourcefulness</b> Like firm soil guiding water, you are a clever mediator navigating crises with ease. <b>Strengths</b> are fast judgment and social harmony, but <b>weaknesses</b> include a lack of Wood-sincerity, risking a reputation for opportunism. <b>Advice:</b> Use transparent communication to prove your integrity through consistent data.",
    26: "<b>Earth: Storms and Heroism</b> A heroic profile that becomes stronger through trials, truly shining in the face of crisis. <b>Strengths</b> are invincible will and crisis management, but <b>weaknesses</b> include a lack of Fire-serenity, often choosing the hard path for yourself. <b>Advice:</b> Avoid unnecessary battles and allocate your energy efficiently toward core goals.",
    27: "<b>Metal: Critique and Isolation</b> Like a precision scale, the power to distinguish right from wrong is at its peak. You are a master of analysis. <b>Strengths</b> are sharp critical spirit and logic, but <b>weaknesses</b> include weak Water-embrace, risking social distance from others. <b>Advice:</b> Transform your critical language into constructive alternatives that empower people.",
    28: "<b>Metal: Expansion and Surge</b> Daring spirit to launch grand businesses and embrace large ambitions. <b>Strengths</b> are bold strategy and a wide range of activity, but <b>weaknesses</b> include a lack of Earth-meticulousness, risking a shaky foundation. <b>Advice:</b> Keep a detailed-oriented partner by your side to focus on plugging the holes in your systems.",
    29: "<b>Water: Wisdom and Peace</b> Like a river reaching the sea, wisdom is completed to secure both status and stability. <b>Strengths</b> are deep insight and public trust, but <b>weaknesses</b> involve a lack of Wood-challenge, leading to complacency. <b>Advice:</b> Constantly learn new fields to keep your luck and your mindset young and vibrant.",
    30: "<b>Water: Flux and Turnaround</b> A dramatic fate where success and failure alternate like ocean waves. <b>Strengths</b> are resilience to rise from any bottom, but <b>weaknesses</b> include a lack of Fire-composure, causing your luck to swing with your mood. <b>Advice:</b> Build a firm philosophical foundation to stabilize your inner center against external shifts.",
    31: "<b>Wood: Social Luck and Self-Reliance</b> Like a forest meeting rain, you achieve grand success through the support of those around you. <b>Strengths</b> are superb interpersonal bonds and luck, but <b>weaknesses</b> involve weak Water-conviction, risking loss of identity to others' opinions. <b>Advice:</b> Trust your own data over others' advice at critical turning points.",
    32: "<b>Wood: Communication and Opportunity</b> Like seeds spreading via the wind, information and people naturally find you. <b>Strengths</b> are unexpected wealth and social talent, but <b>weaknesses</b> include a lack of Metal-sincerity, which may lead to relying solely on luck. <b>Advice:</b> Intensify your internal skills even more when luck is on your side to turn it into mastery.",
    33: "<b>Fire: Imperial Majesty and Manifestation</b> With the sun directly overhead, your ambition and realization are unmatched, leading you to the peak. <b>Strengths</b> are overwhelming charisma and honor, but <b>weaknesses</b> involve a lack of Water-humility, risking isolation. <b>Advice:</b> Actively attribute your success to your team to keep your castle walls strong and secure.",
    34: "<b>Fire: Endurance and Tempering</b> Requires immense patience, like melting iron in a furnace. Passing this trial makes you a true master. <b>Strengths</b> are mental fortitude under extreme conditions, but <b>weaknesses</b> involve a risk of deep pessimism if Earth-optimism fades. <b>Advice:</b> Celebrate small wins frequently to feed your mind with positive data points.",
    35: "<b>Earth: Gentleness and Mediation</b> Like fertile fields, a peaceful energy that makes everyone around you feel comfortable. <b>Strengths</b> are harmonious relationships and domestic bliss, but <b>weaknesses</b> involve a lack of Fire-pioneering, risking missed big leaps. <b>Advice:</b> Occasionally step out of your comfort zone and try a radical, bold challenge.",
    36: "<b>Earth: Loyalty and Sacrifice</b> Like a bridge made of soil, you build honor through dedication and serving others. <b>Strengths</b> are unshakeable loyalty and public respect, but <b>weaknesses</b> include a lack of Water-practicality, risking personal loss. <b>Advice:</b> Never forget that your own success is the primary fuel required to help others effectively.",
    37: "<b>Metal: Craftsmanship and Authority</b> A specialist profile, becoming an irreplaceable authority through precision. <b>Strengths</b> are unrivaled skill and independence, but <b>weaknesses</b> involve a lack of Wood-empathy, making you appear cold or unapproachable. <b>Advice:</b> Share your expert knowledge using warm, human language to gain mass support.",
    38: "<b>Metal: Literature and Art</b> Harmony of emotion and reason, producing achievements in both practical and artistic fields. <b>Strengths</b> are sharp expression and result-oriented performance, but <b>weaknesses</b> involve Fire-impatience, which may lead to cutting corners. <b>Advice:</b> Consistently check the justice and fairness of your process, not just the final result.",
    39: "<b>Water: Completion and Glory</b> Like all rivers reaching the ocean, this is a state of total completion bringing wealth and fame. <b>Strengths</b> are social status and fiscal abundance, but <b>weaknesses</b> include Fire-complacency, risking a fall from grace. <b>Advice:</b> Maintain risk management for worst-case scenarios even while enjoying your peak position.",
    40: "<b>Water: Volatility and Unrest</b> Like a storm at sea, your pioneering spirit is strong but your foundation is perpetually shaky. <b>Strengths</b> are fast adaptation to shifting environments, but <b>weaknesses</b> include weak Fire-center, risking asset loss through speculation. <b>Advice:</b> Choose the path of long-term data over momentary intuition or high-volatility deals.",
    41: "<b>Wood: Command and Growth</b> Like a forest growing together, you lead large organizations by merging virtue and leadership. <b>Strengths</b> are superb management and public trust, but <b>weaknesses</b> include weak Metal-self-care, risking health failure. <b>Advice:</b> Include rest and wellness as core components of your professional management strategy.",
    42: "<b>Wood: Self-Reliance and Trial</b> Like a tree rooted in barren soil, youth is difficult but you rise purely through your own strength. <b>Strengths</b> are unrivaled self-sufficiency, but <b>weaknesses</b> involve a lack of Earth-support, making help hard to find. <b>Advice:</b> Never lose self-trust. Your current trials are the solid bricks for your future castle.",
    43: "<b>Fire: Ostentation and Illusion</b> High flames but lacking fuel; flashy on the outside but hollow within. <b>Strengths</b> are high brand value and outward charm, but <b>weaknesses</b> include a lack of Water-accumulation, making you fiscally fragile. <b>Advice:</b> Allocate half of the energy you spend on your image toward building real, tangible assets.",
    44: "<b>Fire: Labyrinth and Innovation</b> Trapped in chaos with many hardships, but overcoming them makes you a world-changing innovator. <b>Strengths</b> are extraordinary creativity and dramatic turnarounds, but <b>weaknesses</b> involve Earth-instability, causing negative loops. <b>Advice:</b> When negative thoughts hit, move your body immediately to force a mental reset.",
    45: "<b>Earth: Integration and Mastery</b> Like the earth unifying all life, you enjoy honorable success and total stability. <b>Strengths</b> are deep trust and unified leadership, but <b>weaknesses</b> include a lack of Wood-critique, failing to spot deceptive flattery. <b>Advice:</b> Keep a 'devil's advocate' close to you to maintain a sharp sense of reality.",
    46: "<b>Earth: Deliberation and Wandering</b> Shaky ground with much inner conflict; insight is good but execution is weak. <b>Strengths</b> are deep 사유 and reading hidden meanings, but <b>weaknesses</b> include a lack of Metal-focus, wasting talent in many places. <b>Advice:</b> Choose just one goal and develop a 10-year obsession to achieve true mastery.",
    47: "<b>Metal: Fortitude and Success</b> Like a flower blooming on a rock, you accumulate massive wealth late in life through endurance. <b>Strengths</b> are unshakeable credit and long-term asset growth, but <b>weaknesses</b> involve weak Fire-expansion, making youth bitter. <b>Advice:</b> View your current trials as essential data points required to prove your eventual worth.",
    48: "<b>Metal: Advice and Virtue</b> Like a sage using a blade for justice, you excel as a mentor to leaders. <b>Strengths</b> are wise judgment and high moral values, but <b>weaknesses</b> involve a lack of Water-flexibility, imposing your standards on others. <b>Advice:</b> Cultivate a compassionate attitude that seeks to supplement others' flaws rather than just critiquing them.",
    49: "<b>Water: Flexibility and Transformation</b> Exceptional survival skills in shifting environments, like water changing to fit its vessel. <b>Strengths</b> are fast adaptation and versatility, but <b>weaknesses</b> include a lack of Earth-conviction, risking a reputation for opportunism. <b>Advice:</b> No matter how much you adapt, establish a core set of unchanging personal values.",
    50: "<b>Water: Surge and Partnership</b> Gambler's instinct on the high seas; success and failure are dramatic and extreme. <b>Strengths</b> are daring courage to seize big chances, but <b>weaknesses</b> include weak Fire-control, risking total loss via betrayal. <b>Advice:</b> Prioritize legal and data-driven evidence over intuition to block unnecessary risks.",
    51: "<b>Wood: Flux and the Four Seasons</b> Like a tree marking rings through the seasons, a dramatic fate with frequent ups and downs. <b>Strengths</b> are rich experience and dynamic energy, but <b>weaknesses</b> include a lack of Metal-stability, requiring frequent restarts. <b>Advice:</b> Transform change itself into your professional skill as a consultant or strategist.",
    52: "<b>Wood: Preparation and Leap</b> Nurturing strength in a deep forest until the time is right for a grand leap. <b>Strengths</b> are solid internal substance and perfect timing, but <b>weaknesses</b> include a lack of Water-rest, leading to burnout. <b>Advice:</b> Systematize mandatory rest to preserve your vital energy for the long-term journey.",
    53: "<b>Fire: Flash and Hollow</b> Outwardly burning bright but lacking sincerity in your social circle. <b>Strengths</b> are social wit and public recognition, but <b>weaknesses</b> involve a lack of Earth-prudence, risking fraud or exploitation. <b>Advice:</b> Focus your energy on deepening a few sincere relationships rather than managing many shallow ones.",
    54: "<b>Fire: Suppression and Trial</b> Like a flame covered by soil, responsibility is high but the environment is restrictive. <b>Strengths</b> are extreme sincerity and faith, but <b>weaknesses</b> involve weak Metal-wealth; over-expansion leads to ruin. <b>Advice:</b> Do not rush forward; polish your internal substance while waiting for the right ally to appear.",
    55: "<b>Earth: Modesty and Radiance</b> A jewel hidden in soil; value only shines when you maintain a humble posture. <b>Strengths</b> are deep internal power and prudence, but <b>weaknesses</b> involve Wood-vanity, which invites jealousy and collapse. <b>Advice:</b> Use 'simplicity' and 'gravitas' as your strategic personal brand to protect your success.",
    56: "<b>Earth: Indecision and Stagnation</b> Like land covered in fog, you have talent but hesitate at critical moments. <b>Strengths</b> are vast tolerance and caution, but <b>weaknesses</b> involve a lack of Fire-decisiveness, keeping you in supporting roles. <b>Advice:</b> Habituate fast execution over perfection to seize opportunities based on hard data.",
    57: "<b>Metal: Order and Pioneering</b> Like a sharp blade forging a new path, you succeed in establishing systems in chaos. <b>Strengths</b> are unique pioneering spirit and organizational skill, but <b>weaknesses</b> involve a lack of Water-embrace, risking a dogmatic image. <b>Advice:</b> Fairly share the fruits of your success with your team to manage internal resistance.",
    58: "<b>Metal: Persistence and Gathering</b> Like a rock enduring for ages, you eventually achieve self-made wealth through grit. <b>Strengths</b> are sincerity and a solid asset foundation, but <b>weaknesses</b> include a lack of Wood-generosity, risking a lonely old age. <b>Advice:</b> Invest in people as much as wealth to ensure your later years are socially rich.",
    59: "<b>Water: Wandering and Endurance</b> Like a river without a destination, you have many talents but lack a place to root them. <b>Strengths</b> are diverse skills and high ideals, but <b>weaknesses</b> include an Earth-instability, making you vulnerable to temptation. <b>Advice:</b> Establish rigid deadlines and external rules to standardize your natural talents.",
    60: "<b>Water: Storms and Friction</b> Dramatic fate with frequent relationship conflicts or betrayals like ocean surges. <b>Strengths</b> are veteran-level wisdom and foresight gained from trials, but <b>weaknesses</b> involve Fire-blindness to others' true nature. <b>Advice:</b> Focus on strengthening your own inner world rather than deeply involving yourself in others' affairs.",
    61: "<b>Wood: Wisdom and Chieftain</b> Completed wisdom leads you to a respected position at the core of an organization. <b>Strengths</b> are noble dignity and adherence to principles, but <b>weaknesses</b> include a lack of Metal-coldness, risking duty for emotion. <b>Advice:</b> Prioritize principles and numeric data over personal sentiment in all professional dealings.",
    62: "<b>Wood: Tempering and Sacrifice</b> Like wood becoming fuel for others' light, you risk exhausting yourself for others' sake. <b>Strengths</b> are noble altruism and compassion, but <b>weaknesses</b> involve weak Earth-self-defense, leading to burnout. <b>Advice:</b> Secure your own physical and financial foundation before fully committing to helping others.",
    63: "<b>Fire: Fruition and Success</b> Like fruit ripening under the sun, you enjoy rightful rewards for your consistent efforts. <b>Strengths</b> are harmonious wealth and social fame, but <b>weaknesses</b> involve Water-negligence, risking a sudden internal collapse. <b>Advice:</b> Keep a habit of auditing your weakest points even when everything is going perfectly.",
    64: "<b>Fire: Fog and Stagnation</b> A flame trapped in fog, unable to fully express its brilliance. <b>Strengths</b> are deep 사유 and mysterious artistic sense, but <b>weaknesses</b> include a lack of Metal-organization, keeping your life cluttered. <b>Advice:</b> Boldly cut away unnecessary items and social ties to focus entirely on one core value.",
    65: "<b>Earth: Peace and Glory</b> Like the earth harvesting all it has grown, you enjoy high honor late in life. <b>Strengths</b> are perfect divine blessing and public prestige, but <b>weaknesses</b> involve Wood-arrogance, losing the hearts of subordinates. <b>Advice:</b> Maintain a low-profile stance and look after the most vulnerable members of your circle.",
    66: "<b>Earth: Shaking and Credit</b> Like land hit by an earthquake, misplaced trust can cause a sudden fall in reputation or credit. <b>Strengths</b> are flexible response and tolerance, but <b>weaknesses</b> involve Water-flexibility becoming a toxin. <b>Advice:</b> Never provide financial guarantees or lend money based on sentiment; keep all deals strictly formal.",
    67: "<b>Metal: Art and Leadership</b> Like playing a precision instrument, you merge delicate sense with leadership for unique success. <b>Strengths</b> are creative management and aesthetic sense, but <b>weaknesses</b> involve Fire-sociality gaps, causing feelings of isolation. <b>Advice:</b> Systematically plan time to synchronize your emotional frequency with your team members.",
    68: "<b>Metal: Resourcefulness and Founding</b> Like building from perfect blueprints, you succeed via flawless strategic systems. <b>Strengths</b> are extraordinary intelligence and unshakeable managerial sense, but <b>weaknesses</b> involve a lack of Wood-humanity. <b>Advice:</b> Mix a drop of human humor and vulnerability into your efficient command structure.",
    69: "<b>Water: Isolation and Stagnation</b> Stagnant water prone to rotting; grand dreams lacking practical execution data. <b>Strengths</b> are deep academic knowledge and high spiritual world, but <b>weaknesses</b> include Earth-instability, risking desperate moves. <b>Advice:</b> Rebuild your basic skills from the ground up. Your luck only flows when your foundation is solid.",
    70: "<b>Water: Extinction and Emptiness</b> Fading energy yields low rewards for immense effort; a period for spiritual rest. <b>Strengths</b> are noble spirituality detached from worldly greed, but <b>weaknesses</b> include weak Fire-vitality, risking depression. <b>Advice:</b> Use altruism, meditation, or religion to find the true meaning of your existence beyond material gain.",
    71: "<b>Wood: Substance and Perfection</b> Hardened wood becoming a pillar; concentrated expertise yields unshakeable wealth. <b>Strengths</b> are unrivaled authority and practical gain, but <b>weaknesses</b> involve a lack of Metal-flexibility, becoming trapped in your own castle. <b>Advice:</b> Practice the 'wisdom of the sea' to embrace even those who do not meet your standards.",
    72: "<b>Wood: Volatility and Drive</b> Growth so fast that internal substance may be weak; strong drive but extreme swings. <b>Strengths</b> are young, dynamic energy and daring spirit, but <b>weaknesses</b> involve weak Water-risk management, causing fiscal loss. <b>Advice:</b> Base all investment on hard numbers and take a step back when your inner heat rises.",
    73: "<b>Fire: Conclusion and Order</b> Like the brightest light before a flame fades, you wisely organize life and prepare for a new era. <b>Strengths</b> are mature judgment and honorable closure, but <b>weaknesses</b> include Earth-complacency, risking future power loss. <b>Advice:</b> Do not obsess over past glory; become an educator who transfers know-how to the next generation.",
    74: "<b>Fire: Decline and Hardship</b> Like a lamp out of fuel, environmental constraints make it difficult to fully express your talent. <b>Strengths</b> are endurance under limits and moral pride, but <b>weaknesses</b> involve Wood-hope depletion. <b>Advice:</b> Strengthen your mental muscle by studying philosophy or history to understand the macro cycles of life.",
    75: "<b>Earth: Balance and Peace</b> Perfect equilibrium ensuring a peaceful and stable later life. <b>Strengths</b> are high character and balanced values, but <b>weaknesses</b> include Metal-indecision, risking missed timings at critical turns. <b>Advice:</b> At major life crossroads, do not follow the crowd; make a firm, personal, and decisive choice.",
    76: "<b>Earth: Dispersion and Leakage</b> Energy scattering like soil in the wind; high income but even higher expenses. <b>Strengths</b> are a wide range of activity and bold spending, but <b>weaknesses</b> include Water-cohesion failure, risking zero accumulation. <b>Advice:</b> Use a professional asset manager or an automated system to 'lock' your wealth away.",
    77: "<b>Metal: Principles and Struggle</b> Like blades clashing, you obsess over being 'right,' leading to constant external friction. <b>Strengths</b> are rigid integrity and courage against injustice, but <b>weaknesses</b> include weak Wood-harmony, causing frequent swings. <b>Advice:</b> Prioritize the value of 'coexistence' over being 'correct' as your primary life principle.",
    78: "<b>Metal: Caution and Precaution</b> Like a blade in a sheath, extreme caution brings early-life stability but may delay breakthroughs. <b>Strengths</b> are perfect preparation and risk management, but <b>weaknesses</b> include Fire-optimism lack. <b>Advice:</b> Delete all worries with less than a 5% chance of occurring and step boldly out into the world.",
    79: "<b>Water: Seclusion and Wisdom</b> Like a spring in a deep valley, wisdom is profound but goes unacknowledged for a long time. <b>Strengths</b> are niche expertise and a noble spirit, but <b>weaknesses</b> include weak Earth-self-promotion. <b>Advice:</b> Share your deep insights with the world. Your reputation only flows when you actively promote your vision.",
    80: "<b>Water: Finality and Reflection</b> Calm at the edge of the sea; spiritual height is high but worldly luck is fading. <b>Strengths</b> are meditative wisdom and cosmic understanding, but <b>weaknesses</b> include Fire-vitality lack. <b>Advice:</b> Find joy in small daily routines, get plenty of sunlight, and stay connected to the physical world.",
    81: "<b>Bliss: Grand Cycle and Completion</b> The final point of 81 numerology and the restart of the cycle; perfect harmony. When your name reaches here, you open a new dimension of fate. <b>Strengths</b> are total harmony and supreme honor, but <b>weaknesses</b> involve Wood-arrogance causing new trials. <b>Advice:</b> Realize the 'law of circulation' by returning your achievements to society to keep your light eternal."
};
