...
const elementPrescriptions24 = {
    "목(木)": [
        "당신의 시그니처인 목(木)은 정체된 환경을 뚫고 솟아오르는 강력한 독립심과 자생력을 의미합니다. 대한의 혹한을 견딘 성명의 에너지가 선천적 수(水)기를 흡수하여, 부모나 타인의 도움 없이 스스로 가업을 일으키려는 개척자적 사고를 갖게 되었습니다. 당신은 간섭받는 것을 매우 싫어하며, 직업적으로는 <b>벤처 빌더, 신규 사업 기획자, 혹은 독자적 노선을 걷는 전문 경영인</b> 분야가 천직입니다. 에너지를 잘 활용하기 위해 독단적인 결정을 경계하고, 주변의 조언을 시스템적으로 수렴하는 협업 루틴을 실천하십시오.",
        "당신의 시그니처인 목(木)은 멈추지 않는 확장과 교육적 사명을 상징합니다. 입춘의 기운을 타고나 본래 생명력이 강했는데, 성명의 기운이 이를 다시 한번 중첩하여 타인을 가르치고 바른 길로 인도하려는 혁신가적 기질을 완성했습니다. 당신은 아이디어를 시스템화하여 전파하는 것을 선호하며, <b>학교 교사, 에듀테크 디렉터, 혹은 커리어 패스 멘토</b> 분야에서 최고의 효율을 냅니다. 에너지를 관리하려면 완벽주의적 고집을 내려놓고, 타인의 성장 속도를 기다려주는 인내심을 실천하십시오.",
        "당신의 시그니처인 목(木)은 사람과 상황을 연결하는 유연한 소통과 중재의 에너지를 의미합니다. 우수의 비를 머금어 수용성이 뛰어난 성품이었으나, 성명이 강직한 원칙을 더해주어 부드러움 속에 날카로운 칼날을 가진 중재자가 되었습니다. 당신은 정의로운 질서를 세우는 것을 좋아하며, <b>인사 관리(HR), 기업 교육 전문가, 혹은 전문 심리 상담가</b>가 잘 어울립니다. 에너지를 높이기 위해 공과 사의 경계를 철저히 하고, 주기적으로 혼자만의 시간을 통해 내면 에너지를 충전하십시오.",
        "당신의 시그니처인 목(木)은 정체된 분위기를 단숨에 깨뜨리는 혁신적 주파수를 가집니다. 경칩의 각성 에너지가 성명의 파동과 만나 잠자던 조직에 변화를 일으키는 실행가적 사고를 갖게 되었습니다. 당신은 기존의 관습을 타파하는 파격적인 제안을 즐기며, <b>브랜드 전략가, 마케팅 디렉터, 혹은 트렌드 세터</b> 분야에서 빛이 납니다. 에너지를 활용하기 위해 넘치는 영감을 수치로 증명하고, 효율적으로 자원을 배분하는 전략적 사고를 실천하십시오.",
        "당신의 시그니처인 목(木)은 사물의 본질을 구조화하고 원칙을 고수하는 설계 능력을 의미합니다. 춘분의 균형점이 성명에 깃들어 감정에 휘둘리지 않고 최적의 해답을 찾아내는 이성적 사고를 갖게 되었습니다. 당신은 복잡한 세상을 단순한 공식으로 정리하는 것을 좋아하며, <b>시스템 설계자, 연구원, 혹은 전문 기술 가이드</b> 계열이 잘 어울립니다. 에너지를 잘 활용하기 위해 자신의 논리에만 갇히지 말고, 대중의 언어로 소통하며 자신의 설계를 검증받는 과정을 실천하십시오.",
        "당신의 시그니처인 목(木)은 타인의 잠재력을 발견하여 성장을 돕는 자비로운 가이드를 상징합니다. 청명의 맑은 통찰력이 성명의 기운과 결합하여 사람의 강점을 즉각 파악하고 교육하려는 사고를 갖게 되었습니다. 당신은 타인의 삶이 긍정적으로 변화할 때 큰 성취감을 느끼며, <b>유치원 교사, 학교 교사, 혹은 인재 개발(HRD) 전문가</b> 분야에서 독보적입니다. 에너지를 지키기 위해 타인의 감정에 지나치게 몰입하지 말고, 본인의 정서적 주권을 지키는 연습을 실천하십시오.",
        "당신의 시그니처인 목(木)은 정보를 체계화하여 실용적 자산으로 전환하는 실전 경제 지혜를 의미합니다. 곡우의 풍요로운 기운이 성명과 만나 지식을 현실의 자본으로 바꾸는 비즈니스 사고를 갖게 되었습니다. 당신은 가치 있는 정보를 선별하고 큐레이션 하는 것을 선호하며, <b>약사, 제약 유통 전략가, 혹은 데이터 에디터</b> 분야가 천직입니다. 에너지를 활용하기 위해 머릿속의 지식을 즉시 실용적인 결과물이나 유통망으로 연결하는 기계적 습관을 실천하십시오.",
        "당신의 시그니처인 목(木)은 고결한 이상을 추구하며 사회에 긍정적인 영향을 주는 예술적 감수성을 상징합니다. 입하의 기운에 성명의 화려함이 더해져 미적 가치와 도덕적 가치를 동시에 실현하려는 고결한 사고를 갖게 되었습니다. 당신은 아름다움과 조화를 통해 세상을 정화하는 것을 좋아하며, <b>비주얼 디자이너, 공간 미학자, 혹은 문화 콘텐츠 기획자</b> 계열이 잘 어울립니다. 에너지를 높이기 위해 자신만의 가치를 대중의 언어로 당당히 설득하는 커뮤니케이션을 실천하십시오.",
        "당신의 시그니처인 목(木)은 조직 전체의 흐름을 한눈에 장악하는 거시적 리더십을 의미합니다. 소만의 충만한 기운이 성명과 만나 큰 대의를 주도하고 정점을 향해 나아가는 야망가적 사고를 갖게 되었습니다. 당신은 거대 프로젝트를 진두지휘하는 것을 즐기며, <b>총괄 관리자, 고위 행정직 공무원, 혹은 사업 총괄 본부장</b> 분야에서 성공합니다. 에너지를 잘 쓰기 위해 자리에 오를수록 낮은 곳의 소리를 경청하고 포용력을 갖추는 리더의 덕목을 실천하십시오.",
        "당신의 시그니처인 목(木)은 찰나의 기회를 포착하여 승리로 이끄는 예리한 직관을 의미합니다. 망종의 분주함 속에서 성명의 날카로운 기운이 결합하여 리스크를 기회로 바꾸는 승부사적 사고를 갖게 되었습니다. 당신은 경쟁을 통해 성과를 쟁취하는 과정을 선호하며, <b>전문 투자자, 글로벌 영업 전략가, 혹은 전문 딜러</b> 분야가 천직입니다. 에너지를 보존하기 위해 단기적인 승리보다 장기적인 공존의 가치를 먼저 계산하는 거시적 습관을 실천하십시오.",
        "당신의 시그니처인 목(木)은 흔들리지 않는 중심을 바탕으로 군더더기를 걷어내는 정밀 분석력을 의미합니다. 하지의 강렬한 빛 아래에서 성명의 냉철함이 더해져 본질적인 것만 남기는 완벽주의적 사고를 갖게 되었습니다. 당신은 결점 없는 결과물을 만들어내는 공정을 선호하며, <b>품질 감사관, 정책 기획 전문가, 혹은 공정 설계자</b> 계열이 잘 어울립니다. 에너지를 잘 활용하기 위해 주변의 유혹에 흔들리지 않고 오직 본질에만 집중하는 결단력을 매 순간 실천하십시오.",
        "당신의 시그니처인 목(木)은 보이지 않는 곳에서 거대한 성취를 일구는 끈기 있는 인내심을 의미합니다. 소서의 지열을 성명이 흡수하여 내실 있는 성장을 추구하는 실속가적 사고를 갖게 되었습니다. 당신은 기초를 튼튼히 다지고 시스템을 안착시키는 과정을 선호하며, <b>플랫폼 운영 리더, 전략 연구원, 혹은 에듀테크 콘텐츠 개발자</b> 분야에서 탁월합니다. 에너지를 높이기 위해 작은 성취를 이룰 때마다 스스로에게 명확한 보상을 주어 지속 가능한 환경을 구축하십시오.",
        "당신의 시그니처인 목(木)은 극한의 압박 속에서도 해답을 찾아내는 강인한 생존력을 상징합니다. 대서의 폭염이라는 혹독한 환경을 성명이 정면 돌파하며 어떤 위기도 성장판으로 삼는 경영자적 사고를 갖게 되었습니다. 당신은 복잡하게 얽힌 문제를 해결하는 과정에서 희열을 느끼며, <b>위기관리 매니저, 구조조정 전문가, 혹은 전문 경영 컨설턴트</b> 분야가 천직입니다. 에너지를 잘 활용하기 위해 자신의 독판적인 판단보다는 주변의 지혜로운 조언을 경청하는 유연함을 실천하십시오.",
        "당신의 시그니처인 목(木)은 결실의 가치를 미리 파악하고 질서를 수호하는 냉철한 판단력을 의미합니다. 입추의 서늘한 기운이 성명의 단호함과 만나 조직의 기준을 세우고 투명성을 지키는 수호자적 사고를 갖게 되었습니다. 당신은 흐트러짐 없는 원칙을 고수하는 환경을 좋아하며, <b>준법 감사인, 품질 관리 책임자, 혹은 법률 조력자</b> 계열이 잘 어울립니다. 에너지를 높이기 위해 비판 뒤에 반드시 건설적인 대안을 제시하는 생산적인 언어 습관을 실천하십시오.",
        "당신의 시그니처인 목(木)은 파편화된 정보를 하나로 묶어 가치를 극대화하는 갈무리 능력을 의미합니다. 처서의 정리하는 기운이 성명과 만나 방대한 데이터를 본질 위주로 재구성하는 분석적 사고를 갖게 되었습니다. 당신은 무질서 속에서 일관된 규칙을 찾아내는 것을 선호하며, <b>데이터 사이언티스트, 기록물 전문가, 혹은 정보 전략가</b> 분야에서 활약합니다. 에너지를 활용하기 위해 '완벽보다는 완결'을 최우선으로 삼아 실행의 속도를 높이는 연습을 실천하십시오.",
        "당신의 시그니처인 목(木)은 미세한 틈조차 놓치지 않는 장인 정신과 정교한 감각을 상징합니다. 백로의 투명한 환경이 성명의 완벽주의와 결합하여 한 치의 오차도 허용하지 않는 하이엔드 전문가적 사고를 갖게 되었습니다. 당신은 최고급 퀄리티의 결과물을 생산하는 것을 즐기며, <b>정밀 기계 설계자, 기술 고문, 혹은 특수 공정 전문가</b> 분야가 천직입니다. 에너지를 보존하기 위해 주기적으로 미시적인 작업에서 벗어나 세상의 전체적인 흐름을 살피는 안목을 실천하십시오.",
        "당신의 시그니처인 목(木)은 사회적 균형을 수호하고 공정한 가치를 실천하는 정의감을 의미합니다. 추분의 조화로운 기운이 성명의 강직함과 만나 옳고 그름을 명확히 판별하는 법치주의적 사고를 갖게 되었습니다. 당신은 약속과 규칙을 준수하며 공평한 보상을 중시하며, <b>판사, 변호사, 혹은 시민 사회 활동가</b> 계열이 잘 어울립니다. 에너지를 잘 쓰기 위해 법의 논리 이전에 사람의 삶에 담긴 수많은 사연을 포용하려는 유연한 태도를 실천하십시오.",
        "당신의 시그니처인 목(木)은 서늘한 지성으로 다가올 위기를 대비하는 치밀한 전략적 사고를 의미합니다. 한로의 차가운 기운이 성명의 지능과 만나 보이지 않는 흐름을 읽고 대안을 세우는 지략가적 사고를 갖게 되었습니다. 당신은 리스크를 예측하고 시나리오별 대응책을 짜는 것을 즐기며, <b>금융 분석가, 알고리즘 개발자, 혹은 미래 전략 기획자</b> 분야가 천직입니다. 에너지를 높이기 위해 디지털 정보 뒤에 숨겨진 '사람의 진짜 열망'을 읽어내는 감성 훈련을 실천하십시오.",
        "당신의 시그니처인 목(木)은 조직의 안정과 기강을 수호하며 부정을 경계하는 청렴한 가디언의 기운을 상징합니다. 상강의 엄격한 환경이 성명과 만나 자신의 신념을 끝까지 관철하는 단단한 사고를 갖게 되었습니다. 당신은 원칙을 지키며 조직의 기강을 바로잡는 것을 선호하며, <b>경찰, 형사, 보안 총괄 책임자</b> 분야에서 명성을 얻습니다. 에너지를 활용하기 위해 자신의 신념이 독단이 되지 않도록 타인과 타협할 줄 아는 부드러운 화법을 실천하십시오.",
        "당신의 시그니처인 목(木)은 인간사와 비즈니스 이면에 숨겨진 본질을 꿰뚫어 보는 통찰력을 의미합니다. 입동의 에너지를 비축하는 정적인 환경이 성명과 만나 근본적인 원인을 탐구하고 철학적 해답을 찾는 사고를 갖게 되었습니다. 당신은 '왜'라는 질문을 던지고 본질을 파고드는 과정을 좋아하며, <b>전략 컨설턴트, 심리 프로파일러, 혹은 전문 연구원</b> 계열이 잘 어울립니다. 에너지를 지키기 위해 규칙적인 생활로 뇌의 과부하를 막고 현실적인 경제 안정을 최우선으로 관리하십시오.",
        "당신의 시그니처인 목(木)은 사람의 마음을 움직이고 영혼을 치유하는 섬세한 서사의 힘을 상징합니다. 소설의 감성적인 분위기가 성명의 예술적 파동과 만나 타인의 고통을 공감하고 희망을 주는 예술가적 사고를 갖게 되었습니다. 당신은 글과 예술적 매체를 통해 소통하는 것을 선호하며, <b>전화 상담 전문가, 보험 상담가, 혹은 예술 심리 치료사</b> 분야가 천직입니다. 에너지를 높이기 위해 감성에만 치우치지 않도록 구체적이고 현실적인 목표 수치를 설정하는 습관을 실천하십시오.",
        "당신의 시그니처인 목(木)은 세상을 깨우는 지식을 보급하고 포용하는 거대한 교육자의 기운을 의미합니다. 대설의 광활한 포용력이 성명의 잠재력과 상호작용하여 자신의 철학을 널리 알리는 스승의 사고를 갖게 되었습니다. 당신은 지식을 체계화하여 전수하는 것을 즐기며, <b>대학교수, 명강사, 혹은 지식 콘텐츠 디렉터</b> 분야에서 성공합니다. 에너지를 잘 활용하기 위해 자신의 지혜가 세상의 실질적인 부와 연결되는 선순환의 비즈니스 구조를 실천하십시오.",
        "당신의 시그니처인 목(木)은 어둠 속에서 가능성을 발견하고 새 시대를 제안하는 선지자적 에너지를 상징합니다. 동지의 깊은 어둠을 뚫고 나오는 성명의 강력한 주파수가 고정관념을 깨고 파격적인 대안을 제시하는 사고를 갖게 되었습니다. 당신은 새로운 패러다임을 설계하는 것을 좋아하며, <b>사회 혁신가, 창의적 아티스트, 혹은 미래학 사상가</b> 계열이 잘 어울립니다. 에너지를 보존하기 위해 자신의 비범함을 믿되, 대중의 이해 속도를 기다려주는 인내심을 실천하십시오.",
        "당신의 시그니처인 목(木)은 극한의 역경을 견디고 기어이 싹을 틔우는 강인한 자생력을 의미합니다. 소한의 차가운 땅을 뚫고 나오는 성명의 에너지가 시련 속에서도 실질적인 성취를 일구는 집념의 실행가적 사고를 갖게 되었습니다. 당신은 역경을 딛고 보란 듯이 성공하는 과정을 즐기며, <b>군인, 경찰 특공대, 혹은 투자 매니저</b> 분야가 천직입니다. 에너지를 강화하기 위해 독자적인 행동보다는 유력한 파트너와 전략적 동맹을 맺는 기술을 실천하십시오."
    ],
    "화(火)": [
        "당신의 시그니처인 화(火)는 어둠을 밝히고 대중을 매료시키는 화려한 빛과 확산력을 상징합니다. 대한의 추위를 녹이는 따뜻한 화로 같은 성명의 에너지가 내성적인 환경을 상쇄하여 타인의 시선을 사로잡는 마케팅적 사고를 갖게 되었습니다. 당신은 주목받는 환경에서 최고의 효율을 발휘하며, <b>광고 기획자, 마케팅 전략가, 혹은 브랜드 홍보 전문가</b> 계열이 천직입니다. 에너지를 잘 쓰기 위해 열정을 일정한 루틴으로 관리하여 감정의 번아웃을 방지하는 습관을 실천하십시오.",
        "당신의 시그니처인 화(火)는 상상을 현실로 시각화하여 널리 퍼뜨리는 표현의 에너지를 의미합니다. 입춘의 기운과 성명의 화려한 감각이 중첩되어 독창적인 세계관을 구축하는 표현주의적 사고를 갖게 되었습니다. 당신은 새로운 이미지를 창조할 때 가장 강력한 동력을 얻으며, <b>영상 크리에이터, 디지털 아티스트, 혹은 비주얼 디렉터</b> 분야에서 독보적입니다. 에너지를 관리하려면 아이디어를 반드시 결과물로 완성하는 마무리의 집념을 실천하십시오.",
        "당신의 시그니처인 화(火)는 사람 사이의 냉기를 없애고 좌중을 압도하는 사교의 불꽃을 의미합니다. 우수의 따뜻한 기운이 성명의 화려한 언변과 만나 타인의 마음을 무장해제 시키는 뛰어난 커뮤니케이터의 사고를 갖게 되었습니다. 당신은 사람들 앞에서 자신의 메시지를 전달하는 것을 즐기며, <b>방송인, 행사 호스트, 혹은 전문 진행자</b> 분야가 잘 어울립니다. 에너지를 높이기 위해 가끔은 침묵의 무게를 지키고 내면의 힘을 기르는 명상의 시간을 실천하십시오.",
        "당신의 시그니처인 화(火)는 변화를 즉각 포착하여 세상에 알리는 시대의 등불을 상징합니다. 경칩의 역동적인 에너지와 성명의 기민함이 결합하여 새로운 트렌드를 가장 먼저 전파하는 미디어 지향적 사고를 갖게 되었습니다. 당신은 정보를 가공하고 흐름을 선도하는 것을 좋아하며, <b>트렌드 분석가, 뉴스 에디터, 혹은 미디어 기획자</b> 분야에서 빛이 납니다. 에너지를 활용하기 위해 관심을 분산하기보다는 핵심적인 테마 하나에 깊이 몰입하는 집중력을 실천하십시오.",
        "당신의 시그니처인 화(火)는 조직을 돌진하게 만드는 강력한 리더십과 추진력을 의미합니다. 춘분의 균형 잡힌 태양빛이 성명에 깃들어 강렬한 존재감으로 사람들을 이끄는 지휘관적 사고를 갖게 되었습니다. 당신은 명확한 목표를 향해 조직을 독려하고 결과를 내는 것을 즐기며, <b>마케팅 본부장, 전략 프로젝트 매니저, 혹은 영업 리더</b> 계열이 천직입니다. 에너지를 잘 쓰기 위해 객관적인 수치로 자신의 주장을 증명하되, 팀원의 정서적 만족을 살피는 유연함을 실천하십시오.",
        "당신의 시그니처인 화(火)는 공간에 생명을 불어넣고 심미적 가치를 창조하는 예술적 안목을 의미합니다. 청명의 맑은 시야가 성명의 미적 감각과 결합하여 세상을 화려하게 장식하는 미의 전도사적 사고를 갖게 되었습니다. 당신은 시각적인 완성도를 높이는 작업에서 큰 기쁨을 느끼며, <b>인테리어 디렉터, 브랜딩 디자이너, 혹은 전시 기획자</b> 분야에서 성공합니다. 에너지를 활용하기 위해 영감에만 의존하지 말고 현실적인 비즈니스 수익 모델을 스스로 설계하는 실용성을 실천하십시오.",
        "당신의 시그니처인 화(火)는 어떠한 상황에서도 자신을 빛나게 만드는 다재다능한 적응력을 의미합니다. 곡우의 변화무쌍한 에너지가 성명의 다재다능함과 만나 어떤 환경에서도 기회를 만들어내는 자유로운 창작자적 사고를 갖게 되었습니다. 당신은 정해진 틀을 벗어난 자유로운 삶을 추구하며, <b>자유직 기획자, 로컬 크리에이터, 혹은 콘텐츠 디렉터</b> 분야가 잘 어울립니다. 에너지를 지키기 위해 자신만의 확고한 철학적 기준점을 세우고 외부의 평가에 흔들리지 않는 훈련을 실천하십시오.",
        ...
        "당신의 시그니처인 화(火)는 높은 도덕성과 명예를 수호하는 고결한 지도자의 빛을 의미합니다. 소만의 충만한 햇살과 성명의 고결함이 상호작용하여 정의를 실현하고 사회의 어둠을 밝히고자 하는 지도자적 사고를 갖게 되었습니다. 당신은 존경받는 삶을 최고의 가치로 여기며, <b>준법 감사관, 법조 전문직, 혹은 교육계 리더</b> 계열이 잘 어울립니다. 에너지를 잘 쓰기 위해 내면의 뜨거운 정의감을 다스리는 의도적인 명상과 충분한 수면 루틴을 실천하십시오.",
        "당신의 시그니처인 화(火)는 사람을 잇고 에너지를 증폭시키는 네트워킹의 허브를 의미합니다. 망종의 연결되는 기운과 성명의 사교성이 결합하여 방대한 인적 자산을 관리하는 매니지먼트적 사고를 갖게 되었습니다. 당신은 가치 있는 사람들을 연결하여 새로운 비즈니스를 만드는 것을 즐기며, <b>매니지먼트사 리더, 인적자원 분석가, 혹은 커뮤니티 디렉터</b> 분야에서 활약합니다. 에너지를 보존하기 위해 화려한 인맥 관리 뒤에 숨은 본연의 자아를 돌보는 고독의 시간을 실천하십시오.",
        "당신의 시그니처인 화(火)는 자신을 하나의 고유한 브랜드로 만들어 대중을 주도하는 스타성을 상징합니다. 하지의 절정에 달한 빛이 성명의 세련미와 만나 시대를 리드하고 대중의 선망을 받는 브랜드 지향적 사고를 갖게 되었습니다. 당신은 자신을 표현하고 하나의 현상으로 만드는 과정을 좋아하며, <b>톱 인플루언서, 브랜드 총괄 디렉터, 혹은 패션 아트 디렉터</b> 분야가 천직입니다. 에너지를 잘 활용하기 위해 냉정한 자기 객관화를 통해 스스로의 가치를 끊임없이 쇄신하는 혁신을 실천하십시오.",
        "당신의 시그니처인 화(火)는 날카로운 통찰로 사회에 새로운 패러다임을 제안하는 비판적 지성을 의미합니다. 소서의 지열 에너지가 성명의 예리함과 만나 세상을 일깨우고 올바른 가치를 제안하는 비평가적 사고를 갖게 되었습니다. 당신은 지적인 탐구와 사회적 발언을 선호하며, <b>사회 평론가, 정책 비평가, 혹은 전문 칼럼니스트</b> 분야에서 성공합니다. 에너지를 높이기 위해 자신의 날카로운 언어가 타인에게 상처가 되지 않도록 포용력 있는 대안을 함께 제시하는 언어 습관을 실천하십시오.",
        ...
        "당신의 시그니처인 화(火)는 시비를 가려 정의를 실현하고 질서를 세우는 단호한 심판을 의미합니다. 추분의 공정한 기운과 성명의 판단력이 결합하여 사회적 원칙을 지키고 정당한 보상을 실천하는 법치주의적 사고를 갖게 되었습니다. 당신은 투명한 절차와 상식적인 결론을 중요하게 생각하며, <b>행정 소송 전략가, 준법 감사관, 혹은 노무 법인 리더</b> 계열이 잘 어울립니다. 에너지를 강화하기 위해 법의 잣대 이전에 그 속에 담긴 '사람의 존엄성'을 먼저 배려하는 포용을 실천하십시오.",
        ...
        "당신의 시그니처인 화(火)는 보이지 않는 미래를 예견하고 기회를 선점하는 예리한 선견지명을 상징합니다. 입동의 에너지를 비축하는 시기에 성명의 통찰력이 결합하여 숨겨진 진실을 찾아내는 선지자적 사고를 갖게 되었습니다. 당신은 다음 단계의 흐름을 예측하고 방향을 제시하는 과정에서 우위를 점하며, <b>미래학 연구원, 글로벌 투자 분석가, 혹은 트렌드 예측가</b> 계열이 잘 어울립니다. 에너지를 지키기 위해 정보의 과부하 속에서 평정심을 유지하는 규칙적인 명상 습관을 실천하십시오.",
        ...
        "당신의 시그니처인 화(火)는 지식의 등불을 밝혀 인재를 양성하는 고결한 교육의 빛을 상징합니다. 대설의 거대한 포용력과 성명의 찬란한 지혜가 결합하여 학문의 정점에 오르는 구도자적 사고를 갖게 되었습니다. 당신은 지식을 체계화하고 제자를 기르는 삶을 인생의 사명으로 여기며, <b>대학교수, 명예로운 학자, 혹은 지식 재단 이사장</b> 분야가 천직입니다. 에너지를 잘 쓰기 위해 자신의 학문적 성과를 대중이 이해하기 쉬운 실용적인 언어로 번역하는 소통 활동을 실천하십시오.",
    ...
    "토(土)": [
        ...
        "당신의 시그니처인 토(土)는 소외된 이들을 품고 세상의 온도를 높이는 따뜻한 사회적 혁신가를 상징합니다. 소서의 만물을 성숙시키는 인내심과 성명의 온화한 기운이 결합하여 공동체를 지탱하는 든든한 기둥 같은 박애주의적 사고를 갖게 되었습니다. 당신은 봉사와 헌신의 가치를 무엇보다 소중히 여기며, <b>사회적 기업가, 복지 재단 리더, 혹은 NGO 전략가</b> 분야에서 활약합니다. 에너지를 높이기 위해 자신과 같은 뜻을 가진 지혜로운 조언자들을 곁에 두고 그들의 전문성을 활용하는 유연함을 실천하십시오.",
        ...
        "당신의 시그니처인 토(土)는 결과물을 정교하게 분류하여 물류의 흐름을 최적화하는 효율의 대가를 의미합니다. 입추의 결실을 갈무리하는 수렴 기운과 성명의 정밀함이 만나 공급망 전체를 장악하는 물류적 사고를 갖게 되었습니다. 당신은 자원과 물자의 이동 경로를 최적화하여 효율을 내는 것을 선호하며, <b>공급망 관리 리더(SCM), 물류 센터 총괄, 혹은 유통 전략 기획자</b> 분야에서 성공합니다. 에너지를 활용하기 위해 데이터 뒤에 숨겨진 소비자의 미세한 심리 변화를 읽어내는 감성 분석 능력을 실천하십시오.",
    ...
    "금(金)": [
        "당신의 시그니처인 금(金)은 어떠한 시련 속에서도 흔들리지 않는 날카로운 결단력과 결기를 의미합니다. 대한의 혹한 속에서 더욱 단단하게 벼려진 성명의 에너지가 위기 상황에서 가장 강력하게 발현되는 해결사적 사고를 갖게 되었습니다. 당신은 혼란을 잠재우고 질서를 완벽히 바로잡는 과정을 즐기며, <b>경찰 간부, 전문 수술의, 혹은 보안 전략 책임자</b> 계열이 천직입니다. 에너지를 잘 쓰기 위해 날카로운 원칙 위에 따뜻한 인간미를 더해 주변 구성원들의 진심 어린 지지를 이끌어내는 유외내강을 실천하십시오.",
        ...
        "당신의 시그니처인 금(金)은 어떠한 풍파에도 굴하지 않고 시스템의 본질을 지켜내는 강력한 보안 방어력을 의미합니다. 하지의 화려함 속에서도 흔들리지 않는 성명의 견고함이 세상을 지탱하는 기술적 기둥이 되는 수호자적 사고를 갖게 되었습니다. 당신은 안전한 디지털 구조를 설계하고 유지하는 것을 선호하며, <b>시스템 아키텍트, 네트워크 보안 전문가, 혹은 핵심 인프 리더</b> 계열이 잘 어울립니다. 에너지를 높이기 위해 최신 기술 트렌드를 적극적으로 수용하여 자신의 노하우를 가장 현대적으로 유지하십시오.",
    ...
    "수(水)": [
        ...
        "당신의 시그니처인 수(水)는 변화의 파도를 타고 가장 먼저 기회를 선점하는 시장의 선구자적 에너지를 상징합니다. 경칩의 변화를 뚫고 흐르는 강물처럼 성명의 에너지가 당신을 자극하여 미래의 트렌드를 미리 읽는 선견지명적 사고를 갖게 했습니다. 당신은 블루오션을 개척하고 시장을 선점하는 과정에서 쾌감을 느끼며, <b>시장 개척 가이드, 유통 트렌드 분석가, 혹은 글로벌 마케터</b> 분야가 천직입니다. 에너지를 지키기 위해 자신만의 변치 않는 핵심 가치를 설정하고 내면의 중심을 지키는 훈련을 실천하십시오.",
        ...
        "당신의 시그니처인 수(水)는 방대한 지식과 정보를 수집하여 부의 자산으로 바꾸는 지식의 연금술사적 지혜를 의미합니다. 곡우의 풍요로운 비가 성명과 만나 지식의 흐름을 통제하여 실질적 가치를 창출하는 플랫폼적 사고를 갖게 되었습니다. 당신은 가치 창출과 지식 큐레이션을 선호하며, <b>제약 유통 전략가, 지식 플랫폼 디렉터, 혹은 데이터 큐레이션 가이드</b> 분야가 천직입니다. 에너지를 활용하기 위해 머릿속의 방대한 지식을 현실의 자본으로 전환하는 실전 비즈니스 경제 감각을 익혀 실천하십시오.",
        "당신의 시그니처인 수(水)는 과열된 경쟁 속에서도 냉정함을 유지하며 거대한 자본의 흐름을 주도하는 지략가를 의미합니다. 입하의 시작되는 열기를 식히는 성명의 냉철함이 당신을 승기를 잡는 승부사적 사고를 갖게 했습니다. 당신은 숫자의 흐름과 M&A 등 거대 담론을 설계하는 것을 좋아하며, <b>M&A 전략 가이드, 기업 전략 컨설턴트, 혹은 수석 자산 분석가</b> 계열이 잘 어울립니다. 에너지를 지키기 위해 '완벽보다 완결'을 모토로 삼아 실행의 속도를 높이고 결단력을 발휘하는 연습을 매일 실천하십시오.",
        ...
        "당신의 시그니처인 수(水)는 공정함 속에서 법의 정신을 해석하고 사람의 권리를 수호하는 법의 정수를 의미합니다. 추분의 균형감 속에서 성명이 해석의 지혜를 더해 문자를 넘어 정의를 실천하는 투사적 사고를 갖게 되었습니다. 당신은 인권 보호와 정의로운 판결을 선호하며, <b>인권 보호 가이드, 국제법 전략가, 혹은 사회 혁신 기업가</b> 계열이 잘 어울립니다. 에너지를 지키기 위해 세상에 존재하는 수많은 회색 지대를 인정하고 법의 온기를 전하는 따뜻한 법 집행자의 면모를 실천하십시오.",
        ...
        "당신의 시그니처인 수(水)는 인류의 지적 유산 체계화하여 널리 공유하는 지식의 대양과 거물을 의미합니다. 대설의 세상을 덮는 포용력과 성명의 거대한 지혜가 만나 방대한 지식을 하나로 꿰뚫어 정리하는 백과사전적 사고를 갖게 되었습니다. 당신은 지식의 정리와 공유의 가치를 즐기며, <b>지식 플랫폼 CEO, 도서관 관장, 혹은 백과사전 에디터</b> 분야가 천직입니다. 에너지를 높이려면 방대한 정보를 누구나 누릴 수 있는 쉬운 언어로 번역하고 나누는 지식 서비스 봉사를 실천하십시오.",
...
const enPrescriptions24 = {
    "Wood": [
        "Your signature Wood represents a powerful life force and planning ability that pierces through stagnant environments. Originally born during the peak of winter's extreme cold with strong static energy, your name's Wood energy intervened to grant you a pioneering mindset that seeks independence and refuses outside help. You enjoy creating your own path from nothing; careers in <b>Venture Building, New Business Planning, or Strategic Management</b> are your true calling. To utilize your energy well, trust your intuition but practice the routine of implementing your concepts into immediate prototypes.",
        "Your signature Wood symbolizes unstoppable expansion and an educational mission. Born with the budding energy of the early spring, you were already full of creative potential, and your name's energy amplified this to complete an innovative temperament. You prefer systematizing ideas to guide others, making <b>School Teaching, Edutech Directing, or Career Path Mentoring</b> your true calling. To manage your energy, let go of stubborn perfectionism and practice patience while waiting for others to grow at their own pace.",
        "Your signature Wood signifies a flexible communicative energy that smoothly links people and situations. Born during the arrival of gentle spring rains, you originally had a highly receptive nature, but your name added firm principles to make you a mediator with a sharp inner edge. You like establishing a righteous order; <b>HR Strategy, Corporate Training, or Professional Psychology</b> suits you well. To increase your energy, clearly define boundaries between work and life and recharge through regular periods of solitude.",
        ...
        "Your signature Wood represents a logical design capability that structuralizes the essence of things. Born during the perfect balance of day and night in spring, your name allows you to find optimal algorithms between emotion and reason without being swayed by feelings. You like organizing the complex world into simple formulas; <b>System Architecture, Research, or Technical Guidance</b> are your true calling. To use your energy well, do not isolate yourself but practice actively sharing your designs with the world.",
        "Your signature Wood symbolizes a compassionate guide who discovers others' potential and helps them grow. Born during the season of clear vision and insight, your name combined with this energy to grant you an intuitive mind for identifying strengths. You feel the greatest achievement when seeing others' lives change positively, making you unique in <b>Kindergarten Teaching, Talent Development (HRD), or Professional Mentoring</b>. To protect your energy, guard your emotional sovereignty and avoid over-empathizing with others' pain.",
        "Your signature Wood signifies the wisdom to systematize vast information and extract practical value. Born when the earth is soaked for a rich harvest, your name grants you a practical economic mindset that turns knowledge into capital. You prefer curating valuable information, making <b>Pharmaceutical Distribution Strategy, Data Editing, or Technical Instruction</b> your true calling. To utilize your energy, build a habit of immediately transforming conceptual knowledge into commercial distribution networks.",
        "Your signature Wood symbolizes an artistic sensitivity that pursues high ideals and positively influences society. Born as the first greenery of summer expands, your name's splendor was added to grant you a noble mindset that seeks both aesthetic and moral value. You like purifying the world through beauty; <b>Visual Design, Spatial Aesthetics, or Cultural Content Planning</b> suit you well. To increase your energy, practice proudly proving and persuading your values through public communication.",
        "Your signature Wood signifies macroscopic leadership that commands an entire organization at a glance. Born during the height of early growth energy, your name grants you an ambitious mind that leads big causes and aims for the top. You enjoy commanding large-scale projects, succeeding in <b>Business Directing, High-level Administration, or Chief Strategic Operations</b>. To use your energy well, practice the 'Leadership of Virtue' by looking after those in lower positions as you reach higher peaks.",
        "Your signature Wood represents sharp intuition that seizes a moment's opportunity and leads it to victory. Born during the busy season of sowing seeds, your name's sharp energy combined with this flow to grant you a gambler's mind that turns risk into profit. You prefer winning meaningful results through competition, making <b>Professional Investment, Global Sales Strategy, or Specialized Dealing</b> your true calling. To preserve your energy, calculate the value of 'Coexistence' before seeking short-term victory.",
        "Your signature Wood signifies a precise analytical power that removes unnecessary clutter based on an unshakable center. Born under the intense light of the summer solstice, your name's coolness was added to grant you a perfectionist mind that leaves only the essence. You like flawless production processes, making <b>Quality Auditing, Policy Planning, or Process Engineering</b> suit you well. To utilize your energy well, practice the decisiveness to ignore distractions and focus only on the core at every moment.",
        "Your signature Wood signifies persistent patience that achieves great results behind the scenes. Your name absorbed the gradual buildup of summer heat to grant you a practical mind that pursues solid growth and system stability. You prefer laying strong foundations, excelling in <b>Platform Operations, Strategic Research, or Edutech Content Development</b>. To increase your energy, build a habit of giving yourself clear rewards for small achievements to maintain a sustainable working environment.",
        ...
        "Your signature Wood signifies cool judgment that predicts results and protects perfect order. Born as the hint of autumn's cooling air arrives, your name's decisiveness grants you a guardian mind that sets organizational standards. You like environments where unwavering principles are followed; <b>Compliance Auditing, Quality Management, or Legal Assistance</b> suit you well. To increase your energy, practice always suggesting a constructive alternative after a critique to help others grow.",
        "Your signature Wood signifies the ability to organize fragmented information and maximize its value. Born as the heat settles into seasonal order, your name grants you an analytical mind that reconfigures vast data based on its essence. You prefer finding consistent rules in disorder, performing well in <b>Data Science, Records Management, or Information Strategy</b>. To utilize your energy, practice increasing your execution speed with the motto 'Completion over Perfection'.",
        "Your signature Wood symbolizes a master spirit and sophisticated sense that catches even the finest details. Born during the period of transparent morning dew, your name's perfectionism grants you a high-end expert mind that allows no single error. You enjoy creating premium quality results; <b>Precision Engineering, Technical Consulting, or Jewelry Design</b> are your calling. To preserve your energy, practice macroscopic vision by periodically stepping away from work to see the world's overall flow.",
        "Your signature Wood signifies a sense of justice that protects social balance and practices fair value. Born during the perfect balance of day and night in autumn, your name's uprightness grants you a legalistic mind that distinguishes right from wrong. You value strictly following promises and fair rewards, making <b>Legal Professions, Social Innovation, or Policy Administration</b> suit you well. To use your energy well, practice a flexible mindset that embraces the gray areas of human life.",
        "Your signature Wood signifies sophisticated strategic thinking that prepares for upcoming crises with cool intelligence. Born as the cold mountain dew falls, your name's intelligence grants you a strategist's mind that reads invisible flows. You enjoy predicting risks and building scenario-based strategies, making <b>Financial Analysis, Algorithm Development, or Future Strategy Planning</b> your true calling. To increase your energy, practice emotional training to feel the 'real human desire' behind digital information.",
        "Your signature Wood symbolizes the energy of a clean guardian who protects organizational safety and integrity. Born during the first descent of strict frost, your name grants you a solid mind that protects its own beliefs to the end. You prefer establishing discipline and maintaining order, gaining fame in <b>Police Leadership, Criminal Investigation, or Security Operations</b>. To utilize your energy, practice soft communication to make your beliefs more realistic and practical.",
        "Your signature Wood signifies wise insight that pierces deep into the hidden essence of human affairs and business. Born during the storage of early winter energy, your name grants you a philosophical mind that researches fundamental causes. You enjoy the process of asking 'Why' and digging into the core, making <b>Strategy Consulting, Academic Research, or Psychological Profiling</b> suit you well. To protect your energy, prioritize managing realistic economic stability and maintain a regular lifestyle.",
        "Your signature Wood symbolizes the power of delicate narratives that touch people's hearts and heal souls. Born in the sensitive atmosphere of early snow, your name's artistic pulse grants you an artist's mind that provides hope and empathy. You prefer communicating through writing and artistic media, making <b>Insurance Advising, Customer Care Strategy, or Art Therapy</b> your calling. To increase your energy, build a habit of setting clear and realistic numerical goals to balance your sensitivity.",
        "Your signature Wood signifies the energy of a great educator who shares and embraces knowledge that awakens the world. Born during the vast tolerance of heavy snow, your name's potential grants you a teacher's mind that spreads your philosophy. You enjoy systematizing and transferring knowledge to the next generation, succeeding in <b>Keynote Speaking, Scholarly Editing, or Knowledge Content Directing</b>. To utilize your energy well, connect your wisdom to real-world wealth in a virtuous cycle.",
        "Your signature Wood symbolizes a prophetic energy that discovers possibilities in the deepest darkness and suggests a new era. Born in the deepest darkness preparing for light, your name granted you a creative mind that breaks stereotypes and offers alternatives. You like designing new paradigms, making <b>Social Innovation, Creative Art, or Futurist Thought</b> suit you well. To preserve your energy, trust your own uniqueness but practice patience while waiting for the public to catch up.",
        "Your signature Wood signifies resilient self-viability that eventually sprouts through extreme adversity. Born in the frozen ground of late winter, your name's energy achieves results even in hardship through pure tenacity. You enjoy the process of succeeding against all odds, making <b>Special Ops, Military Leadership, or Investment Management</b> your true calling. To strengthen your energy, practice forming strategic alliances with powerful partners rather than acting entirely alone."
    ],
    "Fire": [
        ...
        "Your signature Fire signifies a social flame that heats the air between people and dominates the room. Born during the arrival of warm spring rains, your name met with eloquence to grant you a superior communicator's mind that immediately disarms others. You enjoy delivering your message in front of others, making <b>Broadcasting, Event Hosting, or Professional Live Commerce</b> suit you well. To increase your energy, periodically practice silence to maintain your inner power.",
    ...
    "Earth": [
        ...
        "Your signature Earth signifies a pillar of a huge educational community that grows and develops people. The tolerance of early winter combined with your name's leadership to grant you an educator's mind for laying foundations for the next generation. You like talent development and infrastructure building, performing well in <b>Foundation Chairperson, School Founder, or Global Educational Leadership</b>. To use your energy well, practice spreading your educational philosophy in simple, public language.",
    ...
    "Water": [
        ...
        "Your signature Water symbolizes transparent insight that pierces the essence of events and delivers unfiltered truth. Like a clear spring water, your name's frequency made you an analyst who sees through the core. You enjoy the process of discovering and sharing hidden information in a guide role, performing well in <b>Information Analysis Guide, Investigative Journalism, or Security Systems Auditing</b>. To replenish your energy, practice regular times of resting your brain in nature to clear out thoughts.",
        "Your signature Water signifies the wisdom of an alchemist of knowledge who collects vast information and turns it into assets. The prosperous rain of late spring met your name, resulting in a platform-oriented mind that creates real value by controlling the flow of knowledge. You prefer value creation and being a guide for knowledge, making <b>Data Curation Guide, Knowledge Platform Directing, or Pharmacist Specialist</b> your true calling. To utilize your energy, practice the practical economic sense of converting knowledge into capital.",
        ...
        "Your signature Water symbolizes a noble knowledge leader who enlightens the public with the light of wisdom. Your name's energy sublimated the intense summer light into wisdom, granting you an educator's mind for growing into a giant of intellect. You like being a guide for sharing knowledge and designing macroscopic boards, excelling in <b>Global Business Strategy Guide, Knowledge Sharing Directing, or Professional Authorship</b>. To utilize your energy, practice a virtuous cycle of connecting wisdom to legitimate wealth.",
