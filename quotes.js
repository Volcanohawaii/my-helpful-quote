...
const sideEffectsEn = ["Dessert cravings", "Back-talking", "Zoning out", "Lost socks", "Sauce date OCD", "Involuntary winks", "Mirror dazzled", "Itchy nose", "Glasses search", "Remote hunt", "Snack compulsion", "Late-night kick", "Cat talks", "Phone search", "Elevator panic", "Cart filling", "Dad jokes", "Dog staring", "Menu paralysis", "Wrong shopping", "Internal dance", "Timed hiccups", "Silent earbuds", "Brush space-out", "2 AM cleaning", "Sunny umbrella", "Over-gesturing", "Stranger waving", "Pager fail", "Home urge"];
...
// 9) 데이터 할당 및 초기화 (✅ 이 부분에 누락되었던 elementAttributesKo를 추가했습니다!)
