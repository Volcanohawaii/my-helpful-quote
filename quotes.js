...
const suriPrescription = {
    getRemedy: (num, lackEls, lang) => {
        ...
        const data = {
            ko: {
                actions: [
    /* 목 */ "과감·실행", "추진·강화", "도전", "아침 산책", "식물 원예", "목표 잡기",
    /* 화 */ "창의·발상", "활력·발산", "소통·확대", "일광욕", "격한 운동(火)", "열띤 토론",
    /* 토 */ "중재·화합", "기반 축적", "정리·정돈", "러닝·걷기", "명상·다도", "느긋·휴식",
    /* 금 */ "독립·결단", "예리·분석", "원칙·준수", "근력 운동", "루틴 잡기", "호흡·훈련",
    /* 수 */ "융통성", "지혜 습득", "심연·사색", "수영·입욕", "수분 섭취", "낮잠·숙면"
],
                socials: [
                    /* 목 */ "기본격", "도약격", "발전격", "두령격", "융창격", "고봉격",
                    /* 화 */ "복덕격", "공명격", "성공격", "입신격", "제왕격", "대성격",
                    /* 토 */ "계승격", "통솔격", "덕망격", "안정격", "유덕격", "평화격",
                    /* 금 */ "강건격", "수전격", "건창격", "영웅격", "장성격", "위풍격",
                    /* 수 */ "신성격", "지혜격", "순풍격", "재화격", "총명격", "통찰격"
                ],
                foods: [
                    /* 목 */ "녹색 채소", "신선한 샐러드", "매실차", "청사과", "키위", "신맛 과일",
                    /* 화 */ "붉은 과일", "고추", "토마토", "다크 초콜릿", "자몽", "구기자차",
                ...
                colors: [
                    ...
                    /* 토 */ "노랑", "베이지", "브라운", "황토", "샌드", "카멜",
                    /* 금 */ "화이트", "실버", "그레이", "플래티넘", "아이보리", "크롬",
                    /* 수 */ "네이비", "블랙", "블루", "연하늘", "퍼플", "차콜"
                ]
            },
            en: {
                actions: [
