...
const elementPrescriptions24 = {
    "목(木)": [
        "소한의 혹한이 만물을 얼어붙게 만든 환경이었으나 당신의 이름이 가진 생명력이 그 차가운 에너지를 자양분 삼아 뿌리를 내렸기에 독보적인 자생력이 도출되었습니다. 이러한 환경과 이름의 상호작용은 당신을 극한의 압박 속에서도 길을 찾아내는 <b>벤처 창업가나 리스크 관리자</b>의 길로 인도하며 무에서 유를 창조하는 선구자적 삶을 완성하게 합니다.",
        "대한의 긴 겨울을 버텨낸 대지의 인내심과 당신의 성명이 품은 목(木) 기운이 만나 응축된 에너지를 폭발시키는 힘이 형성되었습니다. 정적인 배경과 동적인 이름의 충돌은 당신을 장기적인 안목을 가진 <b>전략가나 연구 소장</b>으로 성장시켰으며 어떤 시련에도 흔들리지 않는 내실을 다지게 했습니다.",
        "만물이 깨어나는 입춘의 태동기에 당신의 이름이 가진 파동이 더해져 새로운 시대를 여는 강력한 시작의 에너지가 도출되었습니다. 탄생의 기운과 이름의 창조성이 결합하여 당신은 <b>신규 사업 기획자나 혁신가</b>로서 대중의 흐름을 선도하며 세상을 바꾸는 첫 발자국을 떼는 사명을 부여받았습니다.",
        "우수의 부드러운 비가 대지를 적실 때 당신의 이름이 가진 유연한 목(木) 기운이 개입하여 굳어있는 상황을 해소하는 중재의 능력이 극대화되었습니다. 환경의 부드러움과 이름의 연결성이 만나 당신을 <b>인사 관리(HR) 전문가나 교육 담당자</b>로서 사람 사이의 질서를 세우는 핵심 인물로 만들었습니다.",
        "경칩의 천둥소리가 잠든 생명을 깨우듯 당신의 이름이 가진 주파수가 정체된 환경에 강력한 파동을 일으켜 혁신적 감각을 도출해냈습니다. 환경의 자극과 이름의 반응성이 결합하여 당신은 <b>브랜드 디렉터나 마케팅 디렉터</b>로서 조직에 생명력을 불어넣는 폭발적인 에너지를 발휘하게 됩니다.",
        "춘분의 완벽한 균형 속에서 태어난 당신의 환경에 성명의 정밀한 설계 능력이 더해져 본질을 구조화하는 논리적 힘이 완성되었습니다. 낮과 밤의 평등함과 이름의 이성적 판단이 만나 당신은 <b>웹 아키텍트나 전문 연구원</b>으로서 복잡한 세상을 체계적으로 재구성하는 과업을 수행하게 됩니다.",
        "청명의 맑은 통찰력이 대지를 비출 때 당신 이름의 목(木) 기운이 타인의 잠재력을 찾아내는 자비로운 시선을 더했습니다. 맑은 환경과 이름의 가이드적 성향이 결합하여 당신은 <b>전문 강사나 라이프 코치</b>로서 타인의 삶을 변화시키고 성장을 돕는 스승의 길을 걷게 되었습니다.",
        "곡우의 대지를 적시는 지혜가 당신의 이름이 가진 습득 능력과 만나 방대한 정보를 실용적 가치로 변환하는 능력을 도출했습니다. 풍요로운 환경과 이름의 효율성이 상호작용하여 당신을 <b>시장 분석가나 지식 큐레이터</b>로서 독보적인 전문성을 인정받는 지식의 연금술사로 성장시켰습니다.",
        "입하의 푸르름이 확산되는 시기에 당신의 이름이 가진 감수성이 더해져 고결한 이상을 추구하는 예술적 에너지가 완성되었습니다. 계절의 생동감과 이름의 미적 감각이 만나 당신은 <b>디자이너나 문화 활동가</b>로서 세상을 치유하고 아름다움을 전파하는 사명을 수행하게 됩니다.",
        "소만의 성장을 가속하는 에너지와 당신의 성명이 가진 거시적 안목이 결합하여 조직을 한 손에 장악하는 리더의 기질이 도출되었습니다. 충만한 환경과 이름의 장악력이 상호작용하여 당신은 <b>중견기업 CEO나 고위 행정직</b>으로서 큰 흐름을 주도하며 성공의 정점에 오를 운명을 타고났습니다.",
        "망종의 분주한 기운 속에서 당신의 이름이 가진 예리한 직관이 개입하여 찰나의 기회를 포착하는 승부사적 기질을 완성했습니다. 환경의 역동성과 이름의 날카로움이 결합하여 당신은 <b>전문 투자자나 영업 전략 전문가</b>로서 부를 증폭시키고 성과를 쟁취하는 삶을 살게 됩니다.",
        "하지의 강렬한 빛이 이름의 목(木) 기운과 만나 불필요한 것을 쳐내고 본질만 남기는 정밀한 분석력이 도출되었습니다. 극에 달한 환경 에너지를 이름이 제어하며 당신을 <b>도시 설계자나 정책 기획자</b>로서 완벽한 결과물을 만들어내는 완벽주의 리더로 성장시켰습니다.",
        "소서의 서서히 달궈지는 열기와 당신의 성명이 가진 끈기가 만나 내실 있는 성장을 이루는 기초 체력이 형성되었습니다. 환경의 인내와 이름의 지속성이 상호작용하여 당신은 <b>에듀테크 기획자나 서비스 운영자</b>로서 보이지 않는 곳에서 큰 성취를 일구는 일꾼이 되었습니다.",
        "대서의 폭염이라는 극한의 환경을 당신의 이름이 가진 강인한 생존력이 정면으로 돌파하며 압박 속에서 빛나는 경영 능력을 도출했습니다. 극한의 배경과 이름의 돌파력이 만나 당신을 <b>구조조정 전문가나 전문 경영인</b>으로서 난제를 해결하는 해결사로 만들었습니다.",
        "입추의 결실을 예견하는 서늘한 기운과 당신의 이름이 가진 날카로운 판단력이 만나 완벽한 질서를 수호하는 능력이 완성되었습니다. 수렴하는 환경과 이름의 단호함이 결합하여 당신은 <b>품질 관리 실장이나 감사직 공무원</b>으로서 흐트러짐 없는 기준을 세우게 됩니다.",
        "처서의 열기를 식히는 정리의 기운이 당신 이름의 목(木) 기운과 만나 방대한 데이터를 본질 위주로 갈무리하는 능력을 도출했습니다. 정돈되는 환경과 이름의 분석력이 만나 당신을 <b>데이터 사이언티스트나 기록물 전문가</b>로서 지식의 체계를 세우는 역할을 부여했습니다.",
        "백로의 투명한 이슬처럼 맑은 환경과 당신의 성명이 가진 완벽주의적 기질이 결합하여 숙련된 기술을 가진 장인의 에너지를 완성했습니다. 순수한 배경과 이름의 정교함이 상호작용하여 당신은 <b>정밀 기계 설계자나 보석 세공사</b>로서 대가의 반열에 오르게 되었습니다.",
        "추분의 공정함이 지배하는 환경 속에서 당신의 이름이 가진 강직한 성품이 더해져 사회적 균형을 수호하는 정의의 기운이 도출되었습니다. 평등한 배경과 이름의 도덕성이 결합하여 당신은 <b>판사나 변호사</b>로서 법과 원칙을 수호하며 세상의 중심을 잡는 과업을 수행합니다.",
        "한로의 서늘한 지성이 이름의 목(木) 기운과 만나 미래를 대비하는 치밀한 전략적 사고 능력을 완성했습니다. 환경의 차가움과 이름의 유연한 지능이 상호작용하여 당신을 <b>금융 분석가나 알고리즘 개발자</b>로서 보이지 않는 흐름을 읽는 브레인으로 성장시켰습니다.",
        "상강의 서리가 내리는 엄격한 환경과 당신의 이름이 가진 기준점이 만나 조직의 안위를 지키는 청렴한 수호자의 기질이 도출되었습니다. 엄격한 배경과 이름의 단단함이 결합하여 당신은 <b>보안 책임자나 사이버 수사관</b>으로서 악을 멀리하고 질서를 지키는 삶을 살게 됩니다.",
        "입동의 에너지를 비축하는 정적인 환경이 당신의 이름이 가진 통찰력과 만나 깊은 곳을 꿰뚫어 보는 지혜를 완성했습니다. 수렴하는 배경과 이름의 깊이가 상호작용하여 당신은 <b>전략 컨설턴트나 심리 프로파일러</b>로서 인간사와 비즈니스의 이면을 읽는 책사가 되었습니다.",
        "소설의 섬세한 눈송이처럼 감성적인 환경이 당신의 성명이 가진 예술적 파동과 만나 사람의 마음을 움직이는 서사의 능력을 도출했습니다. 섬세한 배경과 이름의 표현력이 결합하여 당신은 <b>예술 치료사나 방송 작가</b>로서 타인의 영혼을 어루만지는 치유자가 되었습니다.",
        "대설의 세상을 덮는 포용력과 당신의 이름이 가진 거대한 잠재력이 상호작용하여 지식을 나누고 세상을 깨우는 스승의 에너지를 완성했습니다. 광활한 배경과 이름의 스케일이 만나 당신은 <b>대학교수나 베스트셀러 작가</b>로서 자신의 철학을 세상에 전파하는 사명을 받았습니다.",
        "동지의 가장 깊은 어둠 속에서 태어난 환경을 당신의 이름이 가진 희망의 주파수가 밝히며 세상을 놀라게 할 천재적 영감을 도출했습니다. 심연의 배경과 이름의 빛이 충돌하여 당신을 <b>철학자나 창의적 예술가</b>로서 고정관념을 깨고 새로운 시대를 제안하는 인물로 성장시켰습니다."
    ],
    "화(火)": [
        "소한의 냉기를 녹이는 따뜻한 화로 같은 당신의 환경과 성명의 화려한 에너지가 만나 대중을 매료시키는 홍보 감각이 도출되었습니다. 차가운 배경과 뜨거운 이름의 조화는 당신을 <b>광고 기획자나 스타일리스트</b>로서 트렌드의 중심에서 빛나게 하는 강력한 카리스마를 부여했습니다.",
        "대한의 혹한 속에서도 꺼지지 않는 불씨를 품은 당신의 성명은 어려운 환경을 기회로 바꾸는 압도적인 긍정 에너지를 형성했습니다. 인내의 배경과 열정적인 이름이 상호작용하여 당신은 <b>전문 경영인이나 마케팅 디렉터</b>로서 정체된 조직에 다시 불을 지피는 구원투수가 되었습니다.",
        "봄의 시작인 입춘의 생동감이 당신 이름의 화(火) 기운과 만나 상상력을 시각화하여 표현하는 독보적인 능력을 도출해냈습니다. 탄생의 기운과 이름의 화려함이 결합하여 당신은 <b>영상 편집자나 웹툰 작가</b>로서 자신만의 독창적인 세계를 구축하고 대중의 시선을 사로잡게 되었습니다.",
        "우수의 비를 증발시키는 뜨거운 열기가 성명에 깃들어 어떠한 장애물도 돌파해내는 추진력과 자신감이 형성되었습니다. 유연한 환경을 압도하는 이름의 에너지가 당신을 <b>영업 본부장이나 사업가</b>로서 거침없이 영토를 확장하는 승부사로 만들었습니다.",
        "경칩의 각성 에너지가 이름의 화(火) 기운과 만나 정보 처리 능력과 변화를 포착하는 안목이 극대화되었습니다. 환경의 자극과 이름의 기민함이 결합하여 당신은 <b>미디어 리포터나 트렌드 분석가</b>로서 새로운 흐름을 가장 먼저 알리는 메신저의 삶을 살게 됩니다.",
        "춘분의 균형 잡힌 빛이 이름과 만나 뚜렷한 존재감과 강력한 실행력을 갖춘 리더의 기질을 완성했습니다. 조화로운 배경과 이름의 카리스마가 상호작용하여 당신은 <b>마케팅 팀장이나 프로젝트 총괄</b>로서 조직을 성공적인 종착역으로 이끄는 길잡이가 되었습니다.",
        "청명의 맑은 시야가 당신 이름의 화(火) 기운과 만나 아름다움을 찾아내고 창조하는 예술적 안목을 도출했습니다. 투명한 환경과 이름의 미적 감각이 결합하여 당신은 <b>인테리어 디자이너나 뷰티 디렉터</b>로서 세상을 화려하게 수놓는 미의 전도사로 성장했습니다.",
        "곡우의 변화무쌍한 에너지가 이름의 다재다능함과 만나 어떠한 상황에서도 자신을 빛나게 만드는 적응력을 완성했습니다. 유동적인 배경과 이름의 순발력이 상호작용하여 당신을 <b>자유직 기획자나 콘텐츠 크리에이터</b>로서 한계가 없는 성취를 이루는 인물로 만들었습니다.",
        "입하의 시작되는 열기가 당신 이름의 화(火) 기운과 만나 목표를 향해 돌진하는 압도적인 열망과 실천력을 도출했습니다. 확산되는 환경과 이름의 투지가 결합하여 당신은 <b>구조조정 전문가나 기업가</b>로서 불가능해 보이던 목표를 현실로 만들어내는 기적을 행하게 됩니다.",
        "소만의 성장을 돕는 강력한 햇살처럼 당신의 성명이 가진 고결한 명예와 정의감이 만나 존경받는 지도자의 기질이 완성되었습니다. 번영하는 배경과 이름의 고결함이 상호작용하여 당신을 <b>법관이나 교육계 지도자</b>로서 세상을 바른 길로 인도하는 빛의 역할을 수행하게 했습니다.",
        "망종의 인적 교류가 활발한 환경과 당신 이름의 화(火) 기운이 만나 사람을 연결하고 에너지를 전파하는 허브의 능력을 도출했습니다. 연결되는 배경과 이름의 사교성이 결합하여 당신은 <b>커뮤니티 매니저나 매니지먼트 대표</b>로서 최고의 수완을 발휘하는 인맥의 왕이 되었습니다.",
        "하지의 절정에 달한 빛이 당신의 이름과 만나 자신을 하나의 브랜드로 만들어내는 강력한 스타성을 완성했습니다. 가장 밝은 환경과 이름의 화려함이 상호작용하여 당신은 <b>패션 디렉터나 인플루언서</b>로서 대중의 시선을 한 몸에 받으며 시대를 리드하는 인물이 되었습니다.",
        "소서의 지열이 이름의 지성적 화(火) 기운과 만나 비판적인 시각으로 새로운 기준을 제시하는 지적인 힘이 도출되었습니다. 달궈지는 배경과 이름의 예리함이 결합하여 당신은 <b>사회 비평가나 정책 평론가</b>로서 대중의 눈을 뜨게 만드는 지성인으로 성장했습니다.",
        "대서의 폭염을 다스리는 냉철한 화(火)의 기운이 이름에 깃들어 뜨거운 가슴과 차가운 머리를 동시에 지닌 지략가의 면모를 완성했습니다. 극한의 배경과 이름의 절제력이 상호작용하여 당신을 <b>M&A 전문가나 기업 전략가</b>로서 복잡한 이해관계를 풀어내는 핵심 인재로 만들었습니다.",
        "입추의 서늘함에 대항하는 이름의 온기가 당신에게 타인의 아픔을 어루만지는 따뜻한 카운슬러의 능력을 부여했습니다. 수렴하는 환경과 이름의 포용력이 결합하여 당신은 <b>심리 상담가나 복지 전문가</b>로서 소외된 곳에 빛을 비추는 삶을 살게 되었습니다.",
        "처서의 정리된 기운이 이름의 명료함과 만나 복잡한 지식을 체계화하여 전달하는 뛰어난 교육자의 기질을 도출했습니다. 정돈되는 배경과 이름의 전달력이 상호작용하여 당신을 <b>학원 원장이나 지식 에디터</b>로서 정보의 가치를 높이는 전문가로 성장시켰습니다.",
        "백로의 순수한 이슬을 빛나게 하는 이름의 화(火) 기운이 당신에게 시각적 완성도를 추구하는 미학자의 재능을 주었습니다. 투명한 배경과 이름의 감각이 결합하여 당신은 <b>VMD나 패션 스타일리스트</b>로서 시각적 혁명을 일으키는 아티스트가 되었습니다.",
        "추분의 공정함 속에서 이름의 화(火) 기운이 옳고 그름을 명확히 가려내는 단호한 심판관의 기질을 도출했습니다. 평등한 배경과 이름의 판단력이 상호작용하여 당신은 <b>준법 감시인이나 노무사</b>로서 사회적 약속을 지키고 정의를 실현하는 과업을 수행하게 되었습니다.",
        "한로의 서리가 내리는 시기에 이름의 화(火) 기운이 세상을 일깨우는 강력한 메시지의 힘을 만들어냈습니다. 차가워지는 환경과 이름의 표현력이 결합하여 당신은 <b>카피라이터나 홍보 전문가</b>로서 사람들의 마음속에 잊히지 않는 문장을 새기는 작가가 되었습니다.",
        "상강의 엄격한 기운 속에서 당신의 성명이 가진 화려한 감각이 만나 척박한 환경에서도 예술적 가치를 창출하는 능력을 도출했습니다. 엄격한 배경과 이름의 창의성이 상호작용하여 당신을 <b>무대 디자이너나 전시 기획자</b>로서 공간에 생명을 불어넣는 창조주로 만들었습니다.",
        "입동의 에너지를 비축하는 시기에 이름의 화(火) 기운이 보이지 않는 진실을 찾아내는 예리한 직관을 완성했습니다. 수렴하는 배경과 이름의 통찰력이 결합하여 당신은 <b>트렌드 예측가나 투자 분석가</b>로서 남들이 보지 못하는 다음 단계를 먼저 내다보는 선지자가 되었습니다.",
        "소설의 정적인 분위기 속에서 당신 성명의 화(火) 기운이 대중의 감성을 자극하는 강력한 스토리텔링 능력을 도출해냈습니다. 조용한 배경과 이름의 극적인 에너지가 상호작용하여 당신을 <b>드라마 작가나 영화 감독</b>으로서 사람들을 웃고 울리는 예술가로 성장시켰습니다.",
        "대설의 거대한 포용력과 이름의 빛나는 지혜가 결합하여 지식을 체계화하고 후대에 전수하는 교육 리더의 자질을 완성했습니다. 광활한 배경과 이름의 명료함이 결합하여 당신은 <b>대학교수나 명예로운 학자</b>로서 지성계의 거목이 되어 사람들의 존경을 받게 되었습니다.",
        "동지의 어둠을 뚫고 나오는 이름의 화(火) 기운이 당신에게 고난 속에서도 희망을 제시하는 철학적 리더의 삶을 부여했습니다. 심연의 배경과 이름의 강력한 빛이 상호작용하여 당신을 <b>정치인이나 사회 운동가</b>로서 어두운 세상을 바꾸고 새로운 질서를 세우는 영웅적 인물로 만들었습니다."
    ],
    "토(土)": [
        "소한의 혹한 속에서 모든 생명을 품고 기다리는 당신의 대지 같은 성명은 조직의 근간을 지탱하는 듬직한 수호자의 기질을 도출했습니다. 차가운 배경과 포용력 있는 이름의 만남은 당신을 <b>자산 관리사나 행정 전문가</b>로서 안정적인 기반을 구축하고 사람들에게 신뢰를 주는 인물로 성장시켰습니다.",
        "대한의 긴 겨울 끝에 만난 당신 이름의 토(土) 기운은 시련 속에서도 결코 흔들리지 않는 태산 같은 중심을 완성했습니다. 인내의 배경과 묵직한 이름이 상호작용하여 당신은 <b>금융 리더나 기업 관리직</b>으로서 위기 상황에서 평정심을 유지하며 조직을 수호하는 핵심 기둥이 되었습니다.",
        "입춘의 시작과 함께 대지에 스며든 이름의 토(土) 기운이 만물을 기르고 화합시키는 따뜻한 모성애적 자질을 도출해냈습니다. 탄생의 기운과 이름의 포용력이 결합하여 당신은 <b>교육자나 아동 상담가</b>로서 생애 초기 단계의 성장을 돕고 바른 길로 인도하는 삶의 터전이 되었습니다.",
        "우수의 부드러운 비를 머금은 비옥한 토양처럼 당신의 성명은 사람과 사람 사이의 갈등을 흡수하는 뛰어난 중재 능력을 완성했습니다. 유연한 환경과 이름의 수용성이 상호작용하여 당신을 <b>인사(HR) 매니저나 커뮤니티 개발자</b>로서 공동체의 화합을 이끄는 정신적 지주로 만들었습니다.",
        "경칩의 역동성을 든든하게 받쳐주는 이름 속 토(土)의 기운이 어떤 상황에서도 흔들리지 않는 치밀한 계획가로서의 면모를 도출했습니다. 변화의 배경과 이름의 신중함이 결합하여 당신은 <b>도시 설계자나 토목 전문가</b>로서 큰 프로젝트의 기초를 닦고 시스템의 안정성을 책임지게 되었습니다.",
        "춘분의 완벽한 균형이 대지 위에 내려앉아 당신의 성명은 확고한 원칙과 신용을 지키는 신뢰의 아이콘으로 자리 잡게 되었습니다. 조화로운 배경과 이름의 정직함이 상호작용하여 당신은 <b>세무사나 공인 회계사</b>로서 독보적인 전문성을 인정받으며 공정한 질서를 수호하는 과업을 수행합니다.",
        "청명의 맑은 기운 아래에서 시스템을 운영하는 당신의 이름은 비효율을 걷어내고 최적의 운영 환경을 만드는 자질을 도출했습니다. 투명한 배경과 이름의 관리 능력이 결합하여 당신은 <b>일반 사무 리더나 공인중개사</b>로서 실무의 정점에서 조직을 지탱하는 유능한 운영자로 성장했습니다.",
        "곡우의 풍요로움을 지켜내는 대지 같은 성명이 당신에게 어떠한 시련에도 굴하지 않는 집념의 전문가 기질을 부여했습니다. 습윤한 배경과 이름의 인내심이 상호작용하여 당신을 <b>수석 엔지니어 혹은 전문 기술 장인</b>으로서 한 분야의 깊이를 완성하는 독보적인 대가로 만들었습니다.",
        "입하의 시작되는 열기를 받아들이는 넓은 평원처럼 당신의 이름은 자산의 가치를 정확히 꿰뚫는 안목 있는 투자자의 기질을 도출했습니다. 확산되는 배경과 이름의 수용력이 결합하여 당신은 <b>부동산 개발자나 감정평가사</b>로서 흔들리지 않는 부의 기초를 닦는 경제적 수완가가 되었습니다.",
        "소만의 성장을 뒷받침하는 묵직한 존재감이 당신의 성명과 만나 자신만의 철학을 세우고 타인을 이끄는 멘토의 에너지를 완성했습니다. 번영하는 배경과 이름의 깊이가 상호작용하여 당신을 <b>대학교수나 정책 자문 위원</b>으로서 많은 이들에게 삶의 올바른 방향을 제시하는 존경받는 리더로 만들었습니다.",
        "망종의 분주함 속에서도 전통의 가치를 보존하는 이름 속 토(土)의 기운이 당신에게 안목 있는 관리자의 감각을 부여했습니다. 역동적인 배경과 이름의 보수적 가치가 결합하여 당신은 <b>박물관 큐레이터나 문화재 전문가</b>로서 명성을 얻으며 시대의 유산을 지키는 사명을 수행하게 되었습니다.",
        "하지의 강렬한 에너지 아래에서 오차 없이 계산하는 당신의 성명은 감정에 휘둘리지 않는 치밀한 살림꾼의 강점을 도출했습니다. 가장 밝은 배경과 이름의 명확함이 상호작용하여 당신은 <b>예산 기획 공무원이나 세무 조사관</b>으로서 조직의 자원을 효율적으로 관리하는 핵심 브레인이 되었습니다.",
        "소서의 달궈진 대지가 이름과 만나 만물을 성숙시키는 인내심과 타인에 대한 깊은 배려심을 완성했습니다. 성숙하는 배경과 이름의 온화함이 결합하여 당신은 <b>복지관 운영자나 사회복지 전문가</b>로서 소외된 이들을 품고 세상의 온도를 높이는 삶의 과업을 걷게 되었습니다.",
        "대서의 뜨거운 열기를 견디며 단단하게 굳어진 당신의 성명은 어떠한 압박 속에서도 흔들리지 않는 무쇠 같은 의지력을 도출했습니다. 극한의 배경과 이름의 단단함이 상호작용하여 당신을 <b>현장 안전 관리자나 중공업 기술 책임자</b>로서 거대한 산업 현장을 지키는 안전의 파수꾼으로 만들었습니다.",
        "입추의 서늘함이 대지에 내려앉아 당신의 성명은 결과물을 가려내고 정리하는 냉철한 관리자의 역량을 완성했습니다. 수렴하는 배경과 이름의 정밀함이 결합하여 당신은 <b>품질 보증 전문가나 물류 총괄 책임자</b>로서 효율적인 유통 체계를 구축하고 성과를 극대화하는 전문가가 되었습니다.",
        "처서의 정돈된 기운과 당신 성명의 묵직한 무게감이 만나 방대한 자료를 체계적으로 분류하고 보관하는 기록자의 기질을 도출했습니다. 정돈되는 배경과 이름의 성실함이 상호작용하여 당신을 <b>도서관장이나 데이터 센터장</b>으로서 인류의 지식을 안전하게 보존하는 지식의 창고지기로 성장시켰습니다.",
        "백로의 투명한 이슬이 대지를 적실 때 당신 이름의 토(土) 기운이 세밀한 부분까지 놓치지 않는 정교한 감각을 완성했습니다. 맑은 배경과 이름의 정밀함이 결합하여 당신은 <b>치과 의사나 정밀 세공 전문가</b>로서 섬세한 손길로 사람들에게 건강과 아름다움을 선물하는 명품 기술자가 되었습니다.",
        "추분의 평등함 속에서 당신의 이름은 모두에게 공평한 기회를 제공하고 균형을 맞추는 사회적 중재자의 역량을 도출했습니다. 공정한 배경과 이름의 평등 의식이 상호작용하여 당신은 <b>노사 조정관이나 평화 활동가</b>로서 갈등이 있는 곳에 화해의 씨앗을 뿌리는 중재 전문가로 활동하게 됩니다.",
        "한로의 차가운 지성이 대지 속에 숨겨진 보석을 찾아내듯 당신의 성명은 가치 있는 것을 발굴해내는 탁월한 감정력을 완성했습니다. 서늘한 배경과 이름의 투시력이 결합하여 당신은 <b>골동품 감정사나 전문 투자 분석가</b>로서 숨겨진 가치를 세상에 드러내는 안목의 대가가 되었습니다. ",
        "상강의 엄격한 기운이 대지 위에 내려앉아 당신의 성명은 흐트러진 질서를 바로잡고 원칙을 세우는 법치의 기운을 도출했습니다. 엄격한 배경과 이름의 강직함이 상호작용하여 당신을 <b>법무사나 출입국 관리 공무원</b>으로서 국가의 체계를 수호하고 정의를 실천하는 인물로 성장시켰습니다.",
        "입동의 에너지를 비축하는 시기에 당신 이름의 토(土) 기운이 보이지 않는 근본을 탐구하고 기초를 다지는 연구자의 자질을 완성했습니다. 수렴하는 배경과 이름의 학구열이 결합하여 당신은 <b>고전학자나 지질학자</b>로서 세상을 지탱하는 본질적인 원리를 탐구하는 지식의 구도자가 되었습니다.",
        "소설의 정적인 분위기 속에서 대지 같은 당신의 이름은 사람들의 불안을 잠재우고 평온을 선사하는 정신적 상담가의 에너지를 도출했습니다. 고요한 배경과 이름의 묵직함이 상호작용하여 당신을 <b>명상 전문가나 요가 스승</b>으로서 현대인들의 지친 마음을 치유하고 삶의 중심을 잡아주는 안내자로 만들었습니다.",
        "대설의 세상을 덮는 포용력이 당신의 성명과 만나 수많은 사람을 가르치고 키워내는 거대한 교육 공동체의 수장 역할을 완성했습니다. 광활한 배경과 이름의 포용력이 결합하여 당신은 <b>장학 재단 이사장이나 대안학교 설립자</b>로서 다음 세대를 위한 든든한 토양을 마련하는 삶을 살게 됩니다.",
        "동지의 어둠 속에서 봄을 준비하는 대지처럼 당신의 이름은 보이지 않는 곳에서 큰 일을 도모하고 성공시키는 지략가의 면모를 도출했습니다. 심연의 배경과 이름의 전략적 성향이 상호작용하여 당신을 <b>정치 전략가나 싱크탱크 연구원</b>으로서 국가와 조직의 미래를 설계하는 보이지 않는 실력자로 만들었습니다."
    ],
    "금(金)": [
        "소한의 혹한 속에서 더욱 단단하게 벼려진 당신의 성명은 위기 상황에서 가장 날카롭게 빛나는 해결사의 기질을 도출했습니다. 차가운 배경과 강직한 이름의 만남은 당신을 <b>경찰 간부나 강력계 형사</b>로서 정의를 실현하고 질서를 어지럽히는 것들을 척결하는 단호한 파수꾼으로 성장시켰습니다.",
        "대한의 긴 추위를 견뎌내며 완성된 당신 이름의 금(金) 기운은 어떠한 유혹에도 흔들리지 않는 강철 같은 신념과 원칙을 완성했습니다. 인내의 배경과 예리한 이름이 상호작용하여 당신은 <b>검찰직 공무원이나 외과 전문의</b>로서 생사를 가르는 결정적인 순간에 오차 없는 판단을 내리는 핵심 인재가 되었습니다.",
        "입춘의 새 기운을 정돈하는 당신 이름의 예리함은 완벽을 추구하는 장인의 면모와 타협하지 않는 정의감을 도출해냈습니다. 탄생의 기운과 이름의 강직함이 결합하여 당신은 <b>감사직 공무원이나 법조인</b>으로서 독보적인 권위를 지키며 사회의 부정을 걸러내는 청렴한 관리자로 활약하게 되었습니다.",
        "우수의 유연함을 단단하게 고정하는 당신의 성명은 구체적인 성과를 내고 계획을 실행하는 실천가의 무기를 완성했습니다. 부드러운 배경과 이름의 실무 능력이 상호작용하여 당신을 <b>기술직 공무원이나 정보 보안 전문가</b>로서 말보다 결과로 자신의 가치를 증명하는 무결점 전문가로 만들었습니다.",
        "경칩의 혼란스러운 역동성 속에서 질서를 세우는 당신의 성명은 무질서에서 규칙을 찾아내는 시스템 정리가의 역량을 도출했습니다. 변화의 배경과 이름의 논리성이 결합하여 당신은 <b>데이터 사이언티스트나 공정 설계자</b>로서 복잡한 구조를 단순화하고 효율을 극대화하는 브레인이 되었습니다.",
        "춘분의 완벽한 균형을 수호하는 당신 이름의 강직함은 사회적 약속을 지키고 공정함을 실천하는 정의의 파수꾼 기질을 완성했습니다. 조화로운 배경과 이름의 도덕성이 상호작용하여 당신은 <b>판사나 헌법 전문가</b>로서 법과 원칙을 수호하며 세상의 중심을 잡는 명예로운 삶을 살게 되었습니다.",
        "청명의 맑은 기운이 당신 이름의 금(金) 기운과 만나 숙련된 기술을 가진 장인의 감각과 스스로에게 엄격한 프로 의식을 도출했습니다. 투명한 배경과 이름의 예리함이 결합하여 당신은 <b>정밀 기계 설계자나 보석 세공사</b>로서 한 치의 오차도 허용하지 않는 명품 결과물을 만들어내는 대가가 되었습니다.",
        "곡우의 변화무쌍한 에너지를 통제하는 당신 성명의 카리스마는 조직을 효율적으로 이끌고 목표를 달성하는 강력한 리더십을 완성했습니다. 유동적인 배경과 이름의 통제력이 상호작용하여 당신을 <b>군 장교나 대기업 임원</b>으로서 큰 권한을 쥐었을 때 가장 빛나는 지휘관으로 성장시켰습니다.",
        "입하의 시작되는 열기를 견고한 결과물로 바꿔놓는 당신 이름의 정밀한 안목은 미세한 부분까지 잡아내는 디테일의 힘을 도출했습니다. 확산되는 배경과 이름의 응축력이 결합하여 당신은 <b>안과 의사나 정밀 기기 공학자</b>로서 미시적인 영역에서 거대한 성취를 이루는 전문가가 되었습니다.",
        "소만의 성숙함을 지켜주는 당신 성명의 강직함은 조직 내 모순을 바로잡고 청렴함을 유지하는 고결한 수호자의 기질을 완성했습니다. 번영하는 배경과 이름의 강직함이 상호작용하여 당신을 <b>준법 감시인이나 사이버 수사관</b>으로서 조직의 건강을 책임지고 투명한 문화를 만드는 주역으로 만들었습니다.",
        "망종의 분주한 데이터를 분석하여 명쾌한 정답을 내놓는 당신 이름의 냉철한 브레인은 리스크를 예측하고 부를 지키는 능력을 도출했습니다. 역동적인 배경과 이름의 분석력이 결합하여 당신은 <b>금융 분석가나 퀀트 매니저</b>로서 숫자의 흐름 속에서 승기를 잡는 차가운 지략가가 되었습니다.",
        "하지의 강렬한 화려함 속에서도 흔들림 없는 중심을 지키는 당신 성명의 금(金) 기운은 시스템의 본질을 지켜내는 강력한 방어력을 완성했습니다. 가장 밝은 배경과 이름의 견고함이 상호작용하여 당신은 <b>네트워크 보안 전문가나 하드웨어 설계자</b>로서 보이지 않는 곳에서 세상을 지탱하는 기술의 기둥이 되었습니다.",
        "소서의 지열 속에서 원석을 제련하듯 당신의 성명은 스스로를 채찍질하며 한계에 도전하는 불굴의 의지력을 도출했습니다. 달궈지는 배경과 이름의 단련력이 결합하여 당신은 <b>특수 부대원이나 전문 스포츠인</b>으로서 신체적, 정신적 한계를 극복하고 인간 승리의 드라마를 쓰는 인물이 되었습니다.",
        "대서의 극한 압박을 이겨내며 날카롭게 벼려진 당신 이름의 금(金) 기운은 위기 상황에서 더 빛나는 과감한 결단력을 완성했습니다. 뜨거운 배경과 이름의 냉정함이 상호작용하여 당신을 <b>구조조정 본부장이나 긴급 구호 팀장</b>으로서 혼란을 잠재우고 생명을 살리는 핵심 리더로 만들었습니다.",
        "입추의 결실을 가려내는 예리한 칼날처럼 당신의 성명은 옥석을 구분하고 명확한 보상을 실천하는 공정한 평가자의 역량을 도출했습니다. 수렴하는 배경과 이름의 가치 판단력이 결합하여 당신은 <b>벤처 캐피털리스트나 심사관</b>으로서 성장 가능성이 있는 대상을 발굴하고 부를 나누는 투자 전문가가 되었습니다.",
        "처서의 열기를 식히고 본질만 남기는 시기에 당신 이름의 금(金) 기운이 복잡한 현상을 단순화하여 해결책을 제시하는 지혜를 완성했습니다. 정돈되는 배경과 이름의 명료함이 상호작용하여 당신을 <b>경영 컨설턴트나 프로세스 혁신 전문가</b>로서 낡은 것을 버리고 새것을 채우는 변화의 선도자로 성장시켰습니다.",
        "백로의 순수한 이슬을 지키는 단단한 바위처럼 당신의 성명은 자신의 신념을 끝까지 관철하는 강력한 주관과 독립심을 도출했습니다. 투명한 배경과 이름의 고집이 결합하여 당신은 <b>자유로운 예술가나 1인 기업가</b>로서 누구에게도 휘둘리지 않는 자신만의 제국을 건설하는 개척자가 되었습니다.",
        "추분의 공정함이 절정에 달했을 때 당신 이름의 금(金) 기운이 법과 정의를 집행하는 추상같은 엄격함을 완성했습니다. 평등한 배경과 이름의 준엄함이 상호작용하여 당신은 <b>교정직 공무원이나 세관장</b>으로서 국가의 경계를 지키고 공정한 가치를 수호하는 공직자로 활약하게 됩니다.",
        "한로의 차가운 지성이 당신 성명과 만나 세상의 난제를 해결하는 수학적 사고력과 논리적 완결성을 도출해냈습니다. 서늘한 배경과 이름의 정밀함이 결합하여 당신은 <b>알고리즘 개발자나 수석 연구원</b>으로서 난공불락의 문제를 풀어내고 기술 발전을 선도하는 인재로 성장했습니다.",
        "상강의 만물을 떨어뜨리는 엄격한 기운 속에서 당신 이름의 금(金) 기운이 진실과 거짓을 가려내는 프로파일링 감각을 완성했습니다. 엄격한 배경과 이름의 투시력이 상호작용하여 당신을 <b>심리 프로파일러나 과학 수사대원</b>으로서 미궁에 빠진 사건의 실마리를 찾아내는 지적 해결사로 만들었습니다.",
        "입동의 에너지를 비축하는 시기에 당신 성명의 단단한 금(金) 기운이 핵심 정보를 지키고 은밀하게 작전을 수행하는 보안 능력을 도출했습니다. 수렴하는 배경과 이름의 기밀성이 결합하여 당신은 <b>국가 정보 요원이나 정보 자산 관리사</b>로서 보이지 않는 곳에서 국가의 안보를 지키는 어둠 속의 영웅이 되었습니다.",
        "소설의 눈이 내리는 풍경 속에서 당신 성명의 금(金) 기운이 냉철한 감성으로 시대를 풍자하고 비판하는 날카로운 필력을 완성했습니다. 정적인 배경과 이름의 예리함이 상호작용하여 당신을 <b>사회 비평가나 시사 논설위원</b>으로서 글 하나로 세상을 일깨우고 권력을 견제하는 지식인으로 만들었습니다.",
        "대설의 세상을 덮는 포용력 아래에서 당신의 이름은 거대한 조직의 기강을 세우고 미래를 설계하는 총괄 설계자의 역량을 도출했습니다. 광활한 배경과 이름의 조직력이 결합하여 당신은 <b>국회의원이나 정당 대표</b>로서 큰 정치를 실천하며 국가의 미래를 열어가는 지도자로 성장하게 됩니다.",
        "동지의 가장 깊은 어둠 속에서 이름의 금(金) 기운이 찬란하게 빛나며 어둠을 뚫고 나오는 다이아몬드 같은 존재감을 완성했습니다. 심연의 배경과 이름의 절대적 가치가 상호작용하여 당신을 <b>역사에 기록될 만한 대가나 외과 수술의 권위자</b>로서 인류에 공헌하는 독보적인 전설로 만들었습니다."
    ],
    "수(水)": [
        "소한의 차가운 물속에 숨겨진 깊은 지혜처럼 당신의 성명은 보이지 않는 흐름을 읽고 대안을 제시하는 현명한 책사의 기질을 도출했습니다. 정적인 배경과 유연한 이름의 만남은 당신을 <b>전략 컨설턴트나 정책 기획자</b>로서 복잡한 상황의 해답을 찾아내는 지적 리더로 성장시켰습니다.",
        "대한의 혹한이 지나기를 기다리며 에너지를 응축한 당신의 성명은 인간 심연의 무의식을 꿰뚫는 감수성과 독창적인 서사 능력을 완성했습니다. 인내의 배경과 깊은 이름이 상호작용하여 당신은 <b>소설가나 예술 심리 치료사</b>로서 사람들의 상처받은 마음을 어루만지고 영혼을 치유하는 인물이 되었습니다.",
        "입춘의 새 생명을 잉태하는 물줄기처럼 당신의 이름은 타인에게 새로운 희망을 주고 잠재력을 일깨우는 가이드의 역량을 도출해냈습니다. 탄생의 기운과 이름의 생명력이 결합하여 당신은 <b>정신건강의학과 의사나 전문 상담가</b>로서 사람들의 마음속에 새로운 삶의 씨앗을 심어주는 삶을 살게 되었습니다.",
        "우수의 부드러운 비와 당신 성명의 유연한 수(水) 기운이 만나 어디서든 적응하고 상대를 설득하는 외교적 수완을 완성했습니다. 유연한 배경과 이름의 적응력이 상호작용하여 당신을 <b>외교관이나 글로벌 마케터</b>로서 세계를 무대로 활동하며 국익을 실현하는 국제적 인재로 만들었습니다.",
        "경칩의 변화하는 에너지 속에서 당신의 성명은 미래의 흐름을 미리 읽어내는 경이로운 직관력과 선견지명을 도출했습니다. 역동적인 배경과 이름의 통찰력이 결합하여 당신은 <b>트렌드 예측가나 투자 전략가</b>로서 남들보다 한 발 앞서 시대의 방향을 제시하는 선지자의 과업을 수행하게 되었습니다.",
        "춘분의 평온함이 이름과 만나 복잡한 이해관계를 조화롭게 조율하는 부드러운 카리스마와 중재 능력을 완성했습니다. 조화로운 배경과 이름의 유연함이 상호작용하여 당신은 <b>국제기구 행정직이나 노사 조정관</b>으로서 갈등이 있는 곳에 평화의 물길을 내는 중요한 역할을 수행하게 됩니다.",
        "청명의 맑은 물처럼 투명한 당신의 성명은 사건의 본질을 꿰뚫어 보고 가공되지 않은 진실을 전달하는 미디어적 자질을 도출했습니다. 투명한 배경과 이름의 명료함이 결합하여 당신은 <b>탐사 보도 기자나 다큐멘터리 감독</b>으로서 세상에 묻혀있던 진실을 빛 가운데로 끌어올리는 인물이 되었습니다.",
        "곡우의 대지를 적시는 비처럼 당신의 이름은 방대한 지식을 흡수하여 자신의 것으로 만드는 비범한 습득 능력과 학문적 깊이를 완성했습니다. 풍요로운 배경과 이름의 수용성이 상호작용하여 당신을 <b>수석 연구원이나 인문학자</b>로서 지식의 대양을 유영하며 진리를 탐구하는 석학으로 성장시켰습니다.",
        "입하의 시작되는 열기를 식히는 이름의 수(水) 기운은 과열된 경쟁 속에서도 냉정함을 잃지 않는 포커페이스와 치밀한 계산 능력을 도출했습니다. 확산되는 배경과 이름의 냉철함이 결합하여 당신은 <b>M&A 전문가나 기업 사냥꾼</b>으로서 차가운 이성으로 거대한 자본의 흐름을 주도하는 지략가가 되었습니다.",
        "소만의 성장을 돕는 영양제 같은 이름의 수(水) 기운은 타인을 성장시켜 자신의 권위를 높이는 비밀스러운 리더십을 완성했습니다. 번영하는 배경과 이름의 지혜가 상호작용하여 당신을 <b>연구소 소장이나 대학 병원장</b>으로서 수많은 제자를 키우고 학계의 존경을 받는 인물로 만들었습니다.",
        "망종의 분주함 속에서도 자신의 흐름을 잃지 않는 이름의 수(水) 기운이 당신에게 보이지 않는 곳에서 정보를 수집하고 분석하는 첩보적 역량을 주었습니다. 역동적인 배경과 이름의 은밀함이 결합하여 당신은 <b>정보 보안 분석가나 비밀 작가</b>로서 세상의 이면에서 중요한 결정을 내리는 실력자가 되었습니다.",
        "하지의 강렬한 빛을 지혜의 눈으로 승화시키는 당신 성명은 대중을 계몽하고 사회의 품격을 높이는 스승의 운명을 도출했습니다. 가장 밝은 배경과 이름의 지성미가 상호작용하여 당신은 <b>베스트셀러 작가나 명강사</b>로서 지식의 나눔을 실천하며 세상에 선한 영향력을 끼치는 인물이 되었습니다.",
        "소서의 지열을 다스리는 깊은 물처럼 당신의 성명은 어떤 어려운 환경에서도 타인을 포용하고 상처를 씻어내는 정화 능력을 완성했습니다. 달궈지는 배경과 이름의 정화력이 결합하여 당신은 <b>정신적 지도자나 호스피스 전문가</b>로서 생의 마무리를 돕거나 영혼을 구원하는 성스러운 삶을 살게 되었습니다.",
        "대서의 폭염 아래에서 시원한 오아시스를 만들어내는 당신 성명의 수(水) 기운은 목마른 이들에게 해답을 주는 컨설팅 능력을 도출했습니다. 극한의 배경과 이름의 조화력이 상호작용하여 당신을 <b>라이프 코치나 전문 컨설턴트</b>로서 인생의 방황을 멈추게 하는 지혜의 안내자로 만들었습니다.",
        "입추의 수렴하는 기운과 이름의 지적 축적 능력이 만나 가치 있는 정보를 영구히 보존하고 기록하는 보관자의 기질을 완성했습니다. 정돈되는 배경과 이름의 기록성이 결합하여 당신은 <b>국가 기록물 관리사나 사학자</b>로서 과거의 지혜를 미래로 연결하는 징검다리 역할을 수행하게 되었습니다.",
        "처서의 정리된 기운 아래 흐르는 이름의 수(水) 기운은 불필요한 인간관계를 정리하고 소수 정예의 네트워크를 관리하는 지적 사교성을 도출했습니다. 정돈되는 배경과 이름의 선별력이 상호작용하여 당신을 <b>프라이빗 뱅커나 고위직 수행 비서</b>로서 특별한 사람들의 신뢰를 얻는 지식의 보좌관으로 성장시켰습니다.",
        "백로의 맑은 물과 당신 이름의 수(水) 기운이 만나 시공간을 초월하는 예술적 영감과 영적 통찰력을 완성했습니다. 투명한 배경과 이름의 신비로움이 결합하여 당신은 <b>작곡가나 시인, 혹은 명상가</b>로서 세상에 없는 아름다움을 소리와 글로 표현하는 아티스트의 길을 걷게 되었습니다.",
        "추분의 공정함 속에서 이름의 수(水) 기운이 법의 정신을 해석하고 정의를 실현하는 유연한 법 집행 능력을 도출했습니다. 조화로운 배경과 이름의 해석력이 상호작용하여 당신은 <b>법률 학자나 인권 변호사</b>로서 문자로 된 법을 넘어 사람의 권리를 수호하는 법의 정수를 실천하는 인물이 되었습니다.",
        "한로의 차가운 지성이 이름의 수(水) 기운과 만나 인간의 심리를 수학적으로 분석하는 프로파일링 감각을 완성했습니다. 서늘한 배경과 이름의 데이터 분석력이 결합하여 당신은 <b>UX 디자이너나 사용자 행동 분석가</b>로서 사람들의 마음이 흐르는 길을 설계하는 디지털 전략가가 되었습니다.",
        "상강의 서리가 내리는 시기에 이름의 수(水) 기운은 죽어가는 것들을 다시 살려내는 치유의 지혜와 재생 능력을 도출해냈습니다. 엄격한 배경과 이름의 생명력이 상호작용하여 당신을 <b>재활 치료사나 고고학자</b>로서 잊히고 사라진 것들에 다시 숨을 불어넣는 생명의 복원자로 만들었습니다.",
        "입동의 에너지를 비축하는 시기에 이름의 수(水) 기운이 보이지 않는 근원을 탐구하고 우주의 원리를 깨닫는 철학적 사유 능력을 완성했습니다. 수렴하는 배경과 이름의 학구열이 결합하여 당신은 <b>양자 물리학자나 동양 철학자</b>로서 세계를 지탱하는 보이지 않는 법칙을 증명하는 구도자의 삶을 살게 되었습니다.",
        "소설의 눈 내리는 풍경과 이름의 수(水) 기운이 만나 세상을 관조하고 인생의 허무를 지혜로 승화시키는 통찰을 도출했습니다. 정적인 배경과 이름의 관찰력이 상호작용하여 당신을 <b>수필가나 수도자</b>로서 바쁜 현대인들에게 멈춤의 가치를 가르치는 침묵의 스승으로 성장시켰습니다.",
        "대설의 세상을 덮는 포용력과 이름의 거대한 지혜가 만나 수많은 지식을 하나로 꿰뚫어 정리하는 백과사전적 지적 역량을 완성했습니다. 광활한 배경과 이름의 정리력이 결합하여 당신은 <b>도서관장이나 지식 플랫폼 운영자</b>로서 인류의 지적 유산을 체계화하는 지성의 거물이 되었습니다.",
        "동지의 어둠을 뚫고 나오는 이름의 수(水) 기운이 당신에게 시대를 앞서가는 천재성과 미지의 영역을 개척하는 신비로운 에너지를 부여했습니다. 심연의 배경과 이름의 비범함이 상호작용하여 당신을 <b>노벨상급 과학자나 천재 예술가</b>로서 역사의 한 페이지를 장식하며 인류의 지적 지평을 넓히는 전설적 존재로 만들었습니다."
    ]
};
const enPrescriptions24 = {
    "Wood": [
        "Born during the Minor Cold (Sohan), your innate environment was frozen, but the vitality in your name used that cold as a nutrient to take root, deriving an unmatched resilience. This interaction guides you toward becoming a <b>Venture Founder or Risk Manager</b>, finding paths in extreme pressure.",
        "The endurance of the Major Cold (Daehan) met the Wood energy of your name, forming a power that explodes condensed energy. This collision of a static background and dynamic name has grown you into a <b>Long-term Strategist or Research Director</b>.",
        "At the start of Spring (Ipchun), your name's frequency added to the budding environment, deriving a powerful energy of new beginnings. You were given the mission of a <b>Startup Planner or Innovator</b>, leading the public flow.",
        "During the gentle rains of Rain Water (Usu), the flexible Wood energy of your name intervened to maximize your mediation skills. This made you a <b>HR Specialist or Corporate Trainer</b>, establishing order between people.",
        "Just as the thunder of Insects Awaken (Gyeongchip) wakes life, your name's frequency caused a powerful pulse in a stagnant environment, deriving an innovative sense. You will exert explosive energy as a <b>Brand or Marketing Director</b>.",
        "Born in the perfect balance of the Spring Equinox (Chunbun), your name's precision design added to the environment, completing a logical power to structuralize the essence. You perform the task of a <b>Web Architect or Professional Researcher</b>.",
        "When the clear insight of Bright and Clear (Cheongmyeong) shines, your name's Wood energy added a compassionate gaze to find others' potential. You became a <b>Professional Lecturer or Life Coach</b>, helping others transform.",
        "The wisdom of Grain Rain (Gogu) met your name's learning ability to derive the power to convert vast information into practical value. You are a <b>Market Analyst or Knowledge Curator</b>, an alchemist of knowledge.",
        "During the expansion of Start of Summer (Ipha), your name's sensitivity added to create an artistic energy pursuing high ideals. You are a <b>Designer or Cultural Activist</b>, healing the world through moral values.",
        "The growth-accelerating energy of Grain Full (Soman) met your name's macroscopic perspective to derive a leader's temperament. You are destined to reach the peak of success as a <b>CEO or High-level Administrator</b>.",
        "In the busy atmosphere of Grain in Ear (Mangjong), your name's sharp intuition intervened to complete a gambler's temperament to seize moments. You will live as a <b>Professional Investor or Sales Strategy Expert</b>.",
        "The intense light of Summer Solstice (Haji) met your name's Wood energy to derive a precise analytical power. You are a <b>Urban Planner or Policy Planner</b>, a perfectionist leader creating masterworks.",
        "The heat of Minor Heat (Soseo) met your name's persistence to form the physical strength for substantial growth. You are a <b>Edutech Planner or Service Operator</b>, achieving great things behind the scenes.",
        "The extreme environment of Major Heat (Daeseo) was met by your name's strong survival instinct, deriving a management ability that shines under pressure. You are a <b>Restructuring Specialist or Professional CEO</b>.",
        "The cool air of Start of Autumn (Ipchu) met your name's sharp judgment to complete the ability to protect perfect order. You are a <b>Quality Assurance Manager or Audit Official</b>, setting unwavering standards.",
        "The organizing energy of End of Heat (Cheoseo) met your name's Wood energy to derive the ability to categorize vast data. You are a <b>Data Scientist or Records Specialist</b>, establishing a system of knowledge.",
        "The clear environment of White Dew (Baekro) met your name's perfectionist temperament to complete the energy of a master with skilled technology. You have reached the level of a master as a <b>Precision Machine Designer or Jeweler</b>.",
        "In the environment of justice during the Autumn Equinox (Chubun), your name's upright character was added to derive an energy of social balance. You are a <b>Judge or Lawyer</b>, protecting laws and principles.",
        "The cool intelligence of Cold Dew (Hallo) met your name's Wood energy to complete a sophisticated strategic thinking ability. You are a <b>Financial Analyst or Algorithm Developer</b>, a brain reading invisible flows.",
        "The strict environment of Frost Descends (Sanggang) met your name's standard to derive a clean guardian's temperament. You live as a <b>Security Chief or Cyber Investigator</b>, distancing evil and protecting order.",
        "The static environment of Start of Winter (Ipdong) met your name's insight to complete a wisdom that pierces deep places. You are a <b>Strategy Consultant or Profiler</b>, reading the hidden sides of business.",
        "The sensitive environment of Light Snow (Soseol) met your name's artistic pulse to derive a narrative ability. You are an <b>Art Therapist or Scriptwriter</b>, a healer who touches the souls of others.",
        "The immense tolerance of Heavy Snow (Daeseol) and your name's vast potential interacted to complete the energy of a teacher. You are a <b>University Professor or Bestselling Author</b>, spreading your philosophy.",
        "Born in the deepest darkness of the Winter Solstice (Dongji), your name's frequency of hope derived a genius inspiration to surprise the world. You are a <b>Philosopher or Creative Artist</b>, breaking stereotypes."
    ],
    "Fire": [
        "Born during the Minor Cold (Sohan), your name acts as a furnace melting the chill, deriving a promotional sense that fascinates the public. You shine as an <b>Advertising Planner or Stylist</b> at the center of trends.",
        "The unquenchable spark in your name during the Major Cold (Daehan) formed an overwhelming positive energy. You are a <b>Professional CEO or Marketing Director</b>, reigniting fire in stagnant organizations.",
        "The vitality of Start of Spring (Ipchun) met your name's Fire energy to derive a unique ability to visualize imagination. You are a <b>Video Editor or Webtoon Artist</b>, capturing the public's eye.",
        "The intense heat of your name during Rain Water (Usu) formed a drive to break through any obstacle. You are a <b>Sales Director or Entrepreneur</b>, expanding your territory without hesitation.",
        "The awakening energy of Insects Awaken (Gyeongchip) met your name's Fire energy to maximize your eye for catching trends. You are a <b>Media Reporter or Trend Analyst</b>, the first to announce new flows.",
        "The balanced light of the Spring Equinox (Chunbun) met your name to complete a leader's temperament with a strong presence. You are a <b>Marketing Lead or Project Manager</b>, guiding the team to success.",
        "The clear vision of Bright and Clear (Cheongmyeong) met your name's Fire energy to derive an artistic eye. You are an <b>Interior Designer or Beauty Director</b>, decorating the world brilliantly.",
        "The versatile energy of Grain Rain (Gogu) met your name's multi-talented nature to complete a breakthrough adaptability. You are a <b>Freelance Planner or Content Creator</b>, achieving limitless growth.",
        "The starting heat of Start of Summer (Ipha) met your name's Fire energy to derive an overwhelming passion. You are a <b>Restructuring Specialist or Entrepreneur</b>, turning impossible goals into reality.",
        "The radiant sunlight of Grain Full (Soman) met your name's noble honor to complete a respected leader's temperament. You are a <b>Judge or Educational Leader</b>, serving as a light for the world.",
        "The busy atmosphere of Grain in Ear (Mangjong) met your name's Fire energy to derive the ability of a hub connecting people. You are a <b>Community Manager or Management CEO</b>, a master of networking.",
        "The peak light of the Summer Solstice (Haji) met your name to complete a powerful stardom to brand yourself. You are a <b>Fashion Director or Influencer</b>, leading the era at the center of attention.",
        "The ground heat of Minor Heat (Soseo) met your name's intellectual Fire energy to derive an intellectual power. You are a <b>Social Critic or Policy Commentator</b>, awakening the public's eyes.",
        "The cold Fire energy of Major Heat (Daeseo) formed a strategist's face with a hot heart and a cool head. You are an <b>M&A Specialist or Corporate Strategist</b>, a key talent in complex interests.",
        "Your name's warmth against the coolness of Start of Autumn (Ipchu) gave you the ability of a warm counselor. You are a <b>Psychological Counselor or Welfare Specialist</b>, shining light on isolated places.",
        "The organized energy of End of Heat (Cheoseo) met your name's clarity to derive an educator's temperament. You are an <b>Academy Director or Knowledge Editor</b>, an expert increasing information's value.",
        "The Fire energy of your name shining on White Dew (Baekro) gave you the talent of an aesthetician. You are a <b>VMD or Fashion Stylist</b>, an artist creating a visual revolution.",
        "In the justice of the Autumn Equinox (Chubun), your name's Fire energy derived a firm judge's temperament. You are a <b>Compliance Officer or Labor Attorney</b>, realizing justice and social promises.",
        "In the frost of Cold Dew (Hallo), your name's Fire energy created a powerful message. You are a <b>Copywriter or PR Specialist</b>, an author engraving unforgettable sentences in people's hearts.",
        "In the strict air of Frost Descends (Sanggang), your name's brilliant sense derived the ability to create artistic value. You are a <b>Stage Designer or Exhibition Curator</b>, a creator breathing life into spaces.",
        "During the energy storage of Start of Winter (Ipdong), your name's Fire energy completed a sharp intuition to find hidden truths. You are a <b>Trend Predictor or Investment Analyst</b>, a prophet seeing the next step.",
        "In the quiet atmosphere of Light Snow (Soseol), your name's Fire energy derived a powerful storytelling ability. You are a <b>Drama Writer or Movie Director</b>, an artist making people laugh and cry.",
        "The immense tolerance of Heavy Snow (Daeseol) met your name's brilliant wisdom to complete an educational leader's quality. You are a <b>University Professor or Scholar</b>, becoming a giant in the intellectual world.",
        "The Fire energy of your name breaking through the darkness of the Winter Solstice (Dongji) gave you a philosophical leader's life. You are a <b>Politician or Social Activist</b>, a heroic figure setting new order."
    ],
    "Earth": [
        "In the Minor Cold (Sohan), your Earth-like name is a reliable guardian waiting for spring, deriving a temperament to support the organization. You shine as an <b>Asset Manager or Administrative Specialist</b>.",
        "The Earth energy of your name during the Major Cold (Daehan) completed a mountain-like center that never shakes. You are a <b>Financial Leader or Corporate Manager</b>, a key pillar protecting the organization.",
        "The Earth energy during the Start of Spring (Ipchun) derived a warm maternal quality to nurture and harmonize all things. You are an <b>Educator or Child Counselor</b>, serving as a foundation for life's growth.",
        "Like fertile soil soaking in the rains of Rain Water (Usu), your name completed a superior mediation ability. You are a <b>HR Manager or Community Developer</b>, a spiritual leader leading community harmony.",
        "The Earth energy during Insects Awaken (Gyeongchip) derived the face of a flawless planner who never shakes. You are an <b>Urban Designer or Civil Engineer</b>, responsible for the foundation of large projects.",
        "The perfect balance of the Spring Equinox (Chunbun) met your name, making you a trusted icon of principles. You are a <b>Tax Accountant or CPA</b>, practicing fair order with unique professional credibility.",
        "Under the clear air of Bright and Clear (Cheongmyeong), your name derived the qualities of an operator who optimizes the environment. You are a <b>Office Leader or Realtor</b>, a capable operator at the peak of practice.",
        "The Earth-like name protecting the abundance of Grain Rain (Gogu) gave you a persistent expert temperament. You are a <b>Chief Engineer or Technical Master</b>, completing the depth of one field.",
        "Like a wide plain accepting the heat of Start of Summer (Ipha), your name derived a savvy investor's temperament. You are a <b>Real Estate Developer or Appraiser</b>, laying the foundation for wealth.",
        "The heavy presence of Grain Full (Soman) met your name to complete a mentor's energy. You are a <b>University Professor or Policy Advisor</b>, a respected leader suggesting the right direction for life.",
        "Even in the busy flow of Grain in Ear (Mangjong), your name's Earth energy gave you a savvy manager's sense. You are a <b>Museum Curator or Cultural Heritage Expert</b>, protecting the legacy of eras.",
        "Under the intense energy of Summer Solstice (Haji), your name derived the strength of a meticulous housekeeper. You are a <b>Budget Planning Official or Tax Investigator</b>, an expert managing resources efficiently.",
        "The heated Earth of Minor Heat (Soseo) met your name to complete an endurance to mature all things. You are a <b>Welfare Center Manager or Specialist</b>, warming the world by embracing the marginalized.",
        "Your name, hardened by the intense heat of Major Heat (Daeseo), derived an iron-like will that never shakes under pressure. You are a <b>Safety Manager or Technical Chief</b>, protecting the safety of industrial sites.",
        "The cool air of Start of Autumn (Ipchu) met your name to complete a cool manager's capability. You are a <b>Quality Assurance Expert or Logistics Manager</b>, an expert maximizing performance.",
        "The organized energy of End of Heat (Cheoseo) and your name's heavy weight met to derive a recorder's temperament. You are a <b>Library Director or Data Center Chief</b>, a warehouse keeper of human knowledge.",
        "When the clear dew of White Dew (Baekro) soaks the earth, your name completed a sophisticated sense. You are a <b>Dentist or Precision Specialist</b>, a luxury technician gifting health and beauty with a delicate touch.",
        "In the equality of the Autumn Equinox (Chubun), your name derived a social mediator's capability to provide fair opportunities. You are a <b>Labor Mediator or Peace Activist</b>, a mediation expert in conflict.",
        "Like finding hidden jewels in the cool intelligence of Cold Dew (Hallo), your name completed a superior appraisal ability. You are an <b>Antique Appraiser or Investment Analyst</b>, a master of insight.",
        "The strict air of Frost Descends (Sanggang) met your name to derive a legal energy to establish order. You are a <b>Judicial Scrivener or Immigration Official</b>, a person practicing justice and protecting the system.",
        "During the energy storage of Start of Winter (Ipdong), your name completed a researcher's quality to explore the essence. You are a <b>Classicist or Geologist</b>, a seeker of knowledge exploring fundamental principles.",
        "In the quiet of Light Snow (Soseol), your Earth-like name derived a spiritual counselor's energy to provide peace. You are a <b>Meditation Expert or Yoga Master</b>, a guide for modern people's tired minds.",
        "The tolerance of Heavy Snow (Daeseol) met your name to complete a huge educational community leader's role. You are a <b>Foundation Chairperson or School Founder</b>, providing solid soil for the next generation.",
        "Like the earth preparing for spring in the darkness of the Winter Solstice (Dongji), your name derived a strategist's face. You are a <b>Political Strategist or Think-tank Researcher</b>, a hidden power designing the future."
    ],
    "Metal": [
        "In the Minor Cold (Sohan), your name derived a solver's temperament shining sharply in crises. You are a <b>Police Official or Detective</b>, a resolute guardian realizing justice and establishing order.",
        "Your name's Metal energy during the Major Cold (Daehan) completed a steel-like faith and principles. You are a <b>Prosecution Official or Surgeon</b>, a key talent making flawless judgments in critical moments.",
        "The sharpness of your name during Start of Spring (Ipchun) derived a master's face and uncompromising justice. You are an <b>Audit Official or Legal Professional</b>, a clean manager filtering out corruption.",
        "Your name, firmly fixing the flexibility of Rain Water (Usu), completed a practitioner's weapon to produce results. You are a <b>Technical Official or Security Specialist</b>, a flawless expert proving value with results.",
        "In the Insects Awaken (Gyeongchip) chaos, your name derived a system organizer's capability. You are a <b>Data Scientist or Process Designer</b>, a brain simplifying complex structures and maximizing efficiency.",
        "The Metal energy of your name during the Spring Equinox (Chunbun) completed a justice guardian temperament. You are a <b>Judge or Constitutional Expert</b>, living a honorable life protecting laws and principles.",
        "The clear air of Bright and Clear (Cheongmyeong) met your name's Metal energy to derive a master's sense. You are a <b>Precision Machine Designer or Jeweler</b>, a master creating masterworks without a single error.",
        "Your name's charisma during Grain Rain (Gogu) completed a powerful leadership to lead the organization efficiently. You are a <b>Military Officer or Corporate Executive</b>, a commander shining with great authority.",
        "The precise eye of your name during Start of Summer (Ipha) derived the power of detail to catch even fine parts. You are an <b>Ophthalmologist or Precision Engineer</b>, a specialist achieving great success in microscopic areas.",
        "The rigidity of your name during Grain Full (Soman) completed a noble guardian's temperament to correct contradictions. You are a <b>Compliance Officer or Cyber Investigator</b>, a lead player creating a transparent culture.",
        "Your name's cold brain analyzing the busy data of Grain in Ear (Mangjong) derived an ability to predict risk. You are a <b>Financial Analyst or Quant Manager</b>, a cool strategist winning in the flow of numbers.",
        "In the brilliance of the Summer Solstice (Haji), your name's Metal energy completed a powerful defense to protect the system's essence. You are a <b>Network Security Specialist or Hardware Designer</b>.",
        "Refining raw ore in the ground heat of Minor Heat (Soseo), your name derived an indomitable will to challenge limits. You are a <b>Special Forces Member or Athlete</b>, a person writing a drama of human victory.",
        "Your name's Metal energy during Major Heat (Daeseo) completed a bold decisiveness shining in crises. You are a <b>Restructuring Chief or Emergency Relief Lead</b>, a key leader calming chaos and saving lives.",
        "Like a sharp blade in the harvest of Start of Autumn (Ipchu), your name derived a fair evaluator's capability. You are a <b>Venture Capitalist or Auditor</b>, an investment expert discovering potential and sharing wealth.",
        "During End of Heat (Cheoseo), your name's Metal energy completed a wisdom to simplify complex phenomena and suggest solutions. You are a <b>Management Consultant or Innovation Expert</b>, a leader of change.",
        "Like a hard rock protecting the clear dew of White Dew (Baekro), your name derived a strong independence to pursue your beliefs. You are a <b>Creative Artist or Solopreneur</b>, a pioneer building your own empire.",
        "In the Autumn Equinox (Chubun), your name's Metal energy completed a strictness to execute law and justice. You are a <b>Correctional Official or Customs Chief</b>, a public servant protecting the nation's borders.",
        "The cool intelligence of Cold Dew (Hallo) met your name to derive a mathematical thinking power and logical perfection. You are an <b>Algorithm Developer or Chief Researcher</b>, a talent leading technological progress.",
        "During Frost Descends (Sanggang), your name's Metal energy completed a profiling sense to distinguish truth from lies. You are a <b>Profiler or Forensic Scientist</b>, an intellectual solver finding clues to mysteries.",
        "During the energy storage of Start of Winter (Ipdong), your name's firm Metal energy derived a security ability to perform operations secretly. You are an <b>Intelligence Agent or Asset Manager</b>, a hero in the dark.",
        "In the snow of Light Snow (Soseol), your name's Metal energy completed a sharp writing power to satirize and criticize the era. You are a <b>Social Critic or Columnist</b>, an intellectual checking power with one pen.",
        "Under the tolerance of Heavy Snow (Daeseol), your name derived a general designer's capability to plan the future. You are a <b>National Assembly Member or Party Leader</b>, a leader opening the nation's future.",
        "The Metal energy of your name in the darkness of the Winter Solstice (Dongji) completed an absolute value like a diamond. You are a <b>Legendary Master or Authority in Surgery</b>, a unique legend contributing to humanity."
    ],
    "Water": [
        "Like the hidden wisdom in the cold water of Minor Cold (Sohan), your name derived a wise strategist's temperament to read invisible flows. You are a <b>Strategy Consultant or Policy Planner</b>.",
        "Your name, which condensed energy waiting for the cold of Major Cold (Daehan) to pass, completed an original narrative ability. You are a <b>Novelist or Art Therapist</b>, a person healing people's wounded souls.",
        "Like the stream of water during Start of Spring (Ipchun), your name derived a guide's capability to give hope and awaken potential. You are a <b>Psychiatrist or Counselor</b>, planting new seeds of life in minds.",
        "The gentle rain of Rain Water (Usu) met your name's flexible Water energy to complete a diplomatic skill to persuade others. You are a <b>Diplomat or Global Marketer</b>, an international talent realizing national interests.",
        "In the changing energy of Insects Awaken (Gyeongchip), your name derived an amazing intuition and foresight to read the future flow. You are a <b>Trend Predictor or Investment Strategist</b>, a prophet suggesting the era's direction.",
        "The peace of the Spring Equinox (Chunbun) met your name to complete a soft charisma and mediation ability. You are an <b>International Organization Administrator or Labor Mediator</b>, opening the path to peace.",
        "Your name, clear like the water of Bright and Clear (Cheongmyeong), derived a media-like quality to see the essence and deliver truth. You are an <b>Investigative Reporter or Documentary Director</b>.",
        "Like the rain of Grain Rain (Gogu) soaking the earth, your name completed a non-ordinary learning ability and academic depth. You are a <b>Chief Researcher or Humanist</b>, an eminent scholar exploring truth.",
        "The Water energy of your name cooling the heat of Start of Summer (Ipha) derived a poker face and meticulous calculation. You are an <b>M&A Specialist or Corporate Raider</b>, a strategist leading the flow of capital.",
        "The Water energy in your name during Grain Full (Soman) completed a secret leadership to grow others and raise your authority. You are a <b>Research Director or Hospital Chief</b>, a person respected by the academic world.",
        "Even in the busy Grain in Ear (Mangjong), your name's Water energy gave you an intelligence capability to collect and analyze information secretly. You are an <b>Information Security Analyst or Secret Writer</b>.",
        "Your name, which sublimates the intense light of Summer Solstice (Haji) into wisdom, derived a teacher's mission to enlighten the public. You are a <b>Bestselling Author or Famous Lecturer</b>, practicing knowledge sharing.",
        "Like deep water controlling the heat of Minor Heat (Soseo), your name completed a purification ability to embrace others in any difficult environment. You are a <b>Spiritual Leader or Hospice Specialist</b>.",
        "The Water energy of your name creating an oasis under the Major Heat (Daeseo) derived a consulting ability to give answers. You are a <b>Life Coach or Professional Consultant</b>, a guide of wisdom.",
        "The storage energy of Start of Autumn (Ipchu) met your name's intellectual accumulation to complete a keeper's temperament. You are a <b>National Records Manager or Historian</b>, a bridge connecting the past to the future.",
        "The Water energy during End of Heat (Cheoseo) derived an intellectual sociability to manage elite networks. You are a <b>Private Banker or High-level Secretary</b>, a knowledge aide gaining trust from special people.",
        "The clear water of White Dew (Baekro) met your name's Water energy to complete an artistic inspiration and spiritual insight. You are a <b>Composer or Poet</b>, an artist expressing beauty with sound and text.",
        "In the Autumn Equinox (Chubun), your name's Water energy derived a flexible legal execution to interpret law's spirit. You are a <b>Legal Scholar or Human Rights Lawyer</b>, practicing the essence of law.",
        "The cool intelligence of Cold Dew (Hallo) met your name to complete a profiling sense to analyze human psychology mathematically. You are a <b>UX Designer or User Behavior Analyst</b>, a digital strategist.",
        "During Frost Descends (Sanggang), your name's Water energy derived a healing wisdom and regeneration ability to save dying things. You are a <b>Rehab Therapist or Archaeologist</b>, a restorer of life.",
        "During the energy storage of Start of Winter (Ipdong), your name's Water energy completed a philosophical thinking power to 깨닫다 (realize) the universe's principles. You are a <b>Quantum Physicist or Eastern Philosopher</b>.",
        "In the snow of Light Snow (Soseol), your name's Water energy derived an insight to sublimate life's futility into wisdom. You are an <b>Essayist or Monk</b>, a silent teacher teaching the value of stopping.",
        "The tolerance of Heavy Snow (Daeseol) met your name's immense wisdom to complete an encyclopedic intellectual capability. You are a <b>Library Director or Knowledge Platform Operator</b>, an intellectual giant.",
        "Your name's Water energy breaking through the darkness of the Winter Solstice (Dongji) gave you a mysterious presence with genius and pioneering energy. You are a <b>Nobel-level Scientist or Genius Artist</b>."
    ]
};
