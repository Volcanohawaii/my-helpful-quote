...
const detailedDesc81 = {
    1: "1수리는 목(木)의 에너지가 중첩되어 강력한 자립의 파동을 만듭니다. 태동하는 생명력이 주도적인 개척 정신을 부여하나, 이름에 담긴 이 강한 기운이 자칫 주변을 배제한 독단적인 판단으로 흐를 수 있으니 주의하십시오.",
    2: "2수리는 목(木)의 분산 성질이 겹쳐 유연한 공감의 파동을 만듭니다. 환경에 적응하고 협력하는 능력을 극대화하나, 이름의 파동이 응집되지 못할 경우 마무리가 흐려지거나 결단력이 약해지는 지점을 조심해야 합니다.",
    3: "3수리는 화(火)의 팽창 에너지가 만나 눈부신 발전의 파동을 만듭니다. 자기표현과 명예를 지향하는 원동력을 부여하나, 이름의 기운이 화려함에만 치중할 경우 실속 없이 에너지만 낭비될 수 있음을 경계하십시오.",
    4: "4수리는 화(火)의 과열된 기운이 변동의 파동을 일으킵니다. 낡은 질서를 깨는 혁신적 기질을 부여하나, 이름에 서린 열기가 감정의 기복을 심화시켜 중요한 순간 냉정함을 잃게 만들 수 있으니 주의가 필요합니다.",
    5: "5수리는 토(土)와 토(土)가 결합하여 흔들림 없는 안주의 파동을 만듭니다. 재물과 인복을 끌어당겨 평온한 기반을 구축하나, 이름의 기운이 안정에만 고여있을 경우 개척 정신이 사라지고 매너리즘에 빠지기 쉬움을 조심하십시오.",
    6: "6수리는 토(土)의 응집력이 기존의 자산을 지키는 계승의 파동을 만듭니다. 신뢰받는 리더의 기틀을 마련해주나, 이름의 무게감이 변화에 대한 순발력을 떨어뜨려 혁신의 타이밍을 놓치게 할 수 있음을 경계해야 합니다.",
    7: "7수리는 금(金)의 예리함이 중첩되어 정련된 칼날 같은 성취의 파동을 만듭니다. 목표를 향해 날카롭게 파고드는 전문성을 부여하나, 이름의 냉철한 기운이 주변에 날카로운 상처를 주어 적을 만들기 쉬운 구조임을 조심하십시오.",
    8: "8수리는 금(金)의 축적 성분이 단단한 집념의 파동을 만듭니다. 인내심을 바탕으로 자수성가형 부를 일구게 하나, 이름의 파동이 소통 통로를 좁게 만들어 독선적인 고집불통으로 비칠 수 있는 지점을 경계하십시오.",
    9: "9수리는 수(水)와 수(水)의 심연이 만나 천재적인 직관의 파동을 만듭니다. 보이지 않는 진리를 탐구하는 지능을 부여하나, 이름의 기운이 현실 세계와의 연결고리를 약화시켜 고독감이나 허무주의에 빠질 수 있음을 주의하십시오.",
    10: "10수리는 수(水)의 끝과 시작이 교차하며 무한한 잠재력의 파동을 만듭니다. 만물을 수용하는 다재다능함을 주나, 이름의 중심축이 약해 현실적인 결실이 흩어지고 허망한 결과를 초래할 수 있는 리스크를 조심해야 합니다.",
    11: "11수리는 목(木)의 재생 기운이 부흥의 파동을 일으키는 수리입니다. 삶에 혁신을 일으키는 주도적 리더십을 부여하나, 이름의 파동이 초기 성공에 도취될 경우 자만심으로 인해 절제력을 잃기 쉬운 점을 경계하십시오.",
    12: "12수리는 목(木)의 인내력이 척박한 환경을 뚫고 나가는 성장의 파동을 만듭니다. 깊은 사유와 내적 성장을 이끄나, 이름의 기운이 외부 압박에 취약할 경우 자신의 주권을 잃고 타인에게 휘둘릴 수 있음을 주의하십시오.",
    13: "13수리는 화(火)의 광채가 지략과 만나 명성의 파동을 만듭니다. 대중을 이끄는 탁월한 처세술을 부여하나, 이름의 기운이 가벼움으로 흐를 경우 구설에 오르거나 실언으로 화를 자초할 수 있는 지점을 조심해야 합니다.",
    14: "14수리는 화(火)의 섬세함이 분석력으로 승화되는 파동입니다. 정밀한 직관과 남다른 감수성을 주나, 이름의 예민한 기운이 정서적 완충 지대를 없애 사소한 일에도 극심한 정신적 소모를 유발할 수 있음을 경계하십시오.",
    15: "15수리는 토(土)의 조화와 덕망이 만나 부드러운 카리스마를 형성합니다. 만인을 이끄는 원만한 성품을 부여하나, 이름의 기운이 안정에만 치중할 경우 공격적인 결단력이 부족해 결정적 기회를 놓칠 수 있음을 조심하십시오.",
    16: "16수리는 토(土)의 자비로움이 재물복을 부르는 길운의 파동입니다. 자산 운영 능력을 높여주나, 이름에 서린 과한 정(情)이 냉철한 판단을 흐려 타인의 부탁을 거절하지 못하고 손해를 보는 구조를 경계하십시오.",
    17: "17수리는 금(金)의 투지가 불굴의 용기로 솟구치는 돌파의 파동입니다. 권력과 명예를 쟁취하는 강력한 힘을 주나, 이름의 기운이 유연하지 못할 경우 타협 대신 부러지기를 선택하는 극단적인 성향을 조심해야 합니다.",
    18: "18수리는 금(金)의 견고한 신념이 완성으로 향하는 파동입니다. 한 분야의 마스터가 되는 성실함을 부여하나, 이름의 파동이 고립된 고집으로 작용할 경우 주변과의 교감이 차단되어 외로운 성공에 그칠 수 있음을 경계하십시오.",
    19: "19수리는 수(水)의 깊은 통찰이 예술적 감성과 만나는 파동을 만듭니다. 예리한 직관과 천재성을 주나, 이름의 기운이 현실과의 괴리를 키울 경우 정신적 불안정이나 고독감에 깊게 침잠할 수 있는 리스크를 조심하십시오.",
    20: "20수리는 수(水)의 방대한 기운이 원대한 이상의 파동을 만듭니다. 상상력과 거대한 스케일을 부여하나, 이름의 파동이 지나치게 분산될 경우 실행력이 뒷받침되지 않아 중도 좌절할 가능성이 높음을 경계하십시오.",
    21: "21수리는 목(木)의 위엄이 두령의 기운과 만나 강력한 리더십을 만듭니다. 조직을 호령하는 카리스마를 주나, 이름의 파동이 지나치게 앞서 나갈 경우 독선으로 비쳐 내부 동료들의 거센 반발을 살 수 있음을 조심하십시오.",
    22: "22수리는 목(木)의 섬세한 기교가 창의적 파동을 일으킵니다. 전문 분야에서 매력을 발휘하는 기술력을 주나, 이름의 지지 기반이 약할 경우 내면이 늘 불안정하고 대인관계 마찰로 성과가 깎일 수 있는 지점을 경계하십시오.",
    23: "23수리는 화(火)의 폭발적 기운이 정점에 달하는 성공의 파동입니다. 압도적인 실행력으로 당신을 세상의 중심에 세우나, 이름의 조절 장치가 부족해 성공 후의 과열로 무리수를 두다 건강과 운을 해칠 수 있음을 조심하십시오.",
    24: "24수리는 화(火)의 열기가 금(金)을 제련하여 보석을 만드는 풍요의 파동입니다. 천부적인 재무 감각을 주나, 이름의 기운이 절제를 잃고 탐욕으로 흐를 경우 애써 쌓은 명예가 한순간에 실추될 수 있음을 경계하십시오.",
    25: "25수리는 토(土)의 조화로움이 지략과 만나 유연한 처세의 파동을 만듭니다. 상황 판단력으로 위기를 넘기는 영리함을 주나, 이름의 기운이 솔직함을 가릴 경우 주변에 기회주의자로 비쳐 신뢰를 잃을 수 있음을 조심하십시오.",
    26: "26수리는 토(土)가 풍파를 견디며 단단해지는 영웅적 파동입니다. 불굴의 의지와 위기관리 능력을 주나, 이름의 기운이 평온함보다 험난한 길을 스스로 자처하게 만드는 고난의 심리적 패턴을 경계해야 합니다.",
    27: "27수리는 금(金)의 날카로운 분석력이 지적 논리의 파동을 형성합니다. 시비곡직을 가려내는 명석함을 주나, 이름의 포용력이 약해질 경우 주변 사람을 비판의 잣대로만 평가하여 적을 만들기 쉬운 지점을 조심하십시오.",
    28: "28수리는 금(金)의 거대한 팽창 에너지가 야망의 파동을 만듭니다. 대범한 지략으로 영역을 확장하는 동력을 주나, 이름의 세밀한 관리력이 부족할 경우 마무리가 엉성하여 기초가 무너질 수 있는 리스크를 경계하십시오.",
    29: "29수리는 수(水)의 지혜가 신망과 만나 완성의 파동을 만듭니다. 사회적 지위와 안정을 거머쥐게 하나, 이름의 기운이 현실 안주로 흐를 경우 발전이 멈추고 운이 정체될 수 있으니 끊임없는 역동성을 유지해야 합니다.",
    30: "30수리는 수(水)의 역동성이 역전의 기운을 부르는 승부사의 파동입니다. 바닥에서도 다시 일어나는 회복력을 주나, 이름의 파동이 감정의 기복에 따라 요동칠 경우 운세 전체가 불안정해질 수 있는 지점을 조심하십시오.",
    31: "31수리는 목(木)의 인복 기운이 자수성가의 파동을 만듭니다. 주변의 도움으로 성취를 이루게 하나, 이름의 주관이 약해질 경우 타인의 의견에 이리저리 휘둘려 본연의 색깔을 잃을 수 있는 리스크를 경계하십시오.",
    32: "32수리는 목(木)의 소통력이 재물운과 결합한 순풍의 파동입니다. 자연스럽게 기회가 찾아오는 운을 주나, 이름의 성실함이 뒷받침되지 않으면 내실 없는 요행만 바라다 기회를 날려 보낼 수 있음을 조심하십시오.",
    33: "33수리는 화(火)의 실현 기운이 최고조에 달한 제왕의 파동입니다. 눈부신 성취와 명예를 가져다주나, 이름의 겸손함이 결여될 경우 독단적인 행동으로 인해 주변의 강력한 적을 만들 위험이 매우 큼을 경계하십시오.",
    34: "34수리는 화(火)의 억눌린 에너지가 인내로 연단되는 마스터의 파동입니다. 초인적인 정신력을 주나, 이름의 긍정적 에너지가 꺾일 경우 극심한 비관주의에 빠져 스스로를 파괴할 수 있는 심리적 늪을 조심하십시오.",
    35: "35수리는 토(土)의 온화함이 평화로운 가정운의 파동을 만듭니다. 안락한 행복과 포용력을 주나, 이름의 기운이 안전지대에만 머물려 할 경우 큰 성장의 기회를 놓치고 평범함에 갇힐 수 있음을 경계하십시오.",
    36: "36수리는 토(土)의 묵직함이 의리와 헌신의 파동을 일으킵니다. 타인의 추앙을 받는 리더십을 주나, 이름에 서린 희생 정신이 과할 경우 정작 자신의 경제적 기반을 챙기지 못해 실속 없는 삶이 될 수 있음을 조심하십시오.",
    37: "37수리는 금(金)의 장인 정신이 독보적인 권위의 파동을 만듭니다. 대체 불가능한 전문가의 지위를 주나, 이름의 차가운 기운이 타인에 대한 공감력을 떨어뜨려 냉정한 사람으로 오인받을 수 있는 지점을 경계하십시오.",
    38: "38수리는 금(金)의 예리함이 예술적 성취로 연결되는 표현의 파동입니다. 세밀한 미적 감각을 부여하나, 이름의 조급함이 앞설 경우 정당한 절차를 무시하고 무리수를 두어 공든 탑을 무너뜨릴 수 있음을 조심하십시오.",
    39: "39수리는 수(水)의 영광이 풍요와 만나 완성된 결실의 파동을 만듭니다. 부귀와 명예가 따르는 환경을 주나, 이름의 성공에 취해 경각심이 부족해지면 오만함으로 인해 리스크 관리에 구멍이 날 수 있음을 경계하십시오.",
    40: "40수리는 수(水)의 변동 기운이 개척의 파동을 일으키는 수리입니다. 변화에 대한 빠른 적응력을 주나, 이름의 중심축이 약해질 경우 투기적인 일에 휘말려 소중한 자산을 한순간에 잃을 위험이 큼을 조심하십시오.",
    41: "41수리는 목(木)의 통솔력이 성장의 기운과 만난 거물의 파동입니다. 조직을 호령하는 경영 능력을 주나, 이름의 기운이 성공만을 향해 폭주할 경우 과로로 건강을 크게 해치거나 사생활의 균형이 깨질 수 있음을 경계하십시오.",
    42: "42수리는 목(木)의 자생력이 고행을 내공으로 바꾸는 독자적 파동입니다. 자신의 힘으로 일어서는 강인함을 주나, 이름의 주변 지지 기반이 약해 어려울 때 타인의 조력을 받기 힘든 고립된 환경에 처할 수 있음을 조심하십시오.",
    43: "43수리는 화(火)의 과시 성분이 브랜드 가치를 높이는 매력의 파동입니다. 시선을 사로잡는 스타성을 주나, 이름의 기운이 외면의 화려함에만 쏠릴 경우 내실과 축적 에너지가 텅 빈 허울뿐인 성공이 될 수 있음을 경계하십시오.",
    44: "44수리는 화(火)의 요동치는 에너지가 비범한 창의의 파동을 만듭니다. 시대를 앞서가는 혁신적 아이디어를 주나, 이름의 평정심이 부족할 경우 부정적인 생각의 루프에 빠져 정신적인 방황을 겪을 수 있음을 조심하십시오.",
    45: "45수리는 토(土)의 통합 기운이 대성의 파동을 일으키는 수리입니다. 명예와 안정을 동시에 누리게 하나, 이름의 날카로운 안목이 무뎌질 경우 주변의 아첨이나 거짓된 정보에 속아 잘못된 판단을 내릴 수 있음을 경계하십시오.",
    46: "46수리는 토(土)의 사유 능력이 지적 성장을 이끄는 통찰의 파동입니다. 깊은 사색과 철학적 능력을 주나, 이름의 응집력이 부족할 경우 한 가지 목표에 집중하지 못하고 뛰어난 재능을 이리저리 낭비할 수 있음을 조심하십시오.",
    47: "47수리는 금(金)의 견고함이 인내 끝에 성공을 맺는 대기만성의 파동입니다. 굳건한 신용으로 거대한 부를 일구게 하나, 이름의 발산 에너지가 약해 초기 고생과 시련의 기간이 예상보다 길어질 수 있음을 경계하십시오.",
    48: "48수리는 금(金)의 덕망이 올바른 판단을 이끄는 참모의 파동입니다. 높은 도덕성과 예리한 이성을 주나, 이름의 잣대가 지나치게 엄격할 경우 주변 사람들을 숨 막히게 압박하여 인간관계의 균열을 초래할 수 있음을 조심하십시오.",
    49: "49수리는 수(水)의 유연성이 다재다능한 변신의 파동을 만듭니다. 어떠한 환경에서도 생존하는 해결 능력을 주나, 이름의 확고한 주관이 부족할 경우 상황에 따라 이리저리 휩쓸리는 기회주의적 태도를 조심해야 합니다.",
    50: "50수리는 수(水)의 담력이 협력의 기운과 만나 반전의 파동을 만듭니다. 기회를 낚아채는 배포와 승부사 기질을 주나, 이름의 이성적 통제가 약해질 경우 감정에 치우친 무리한 투자로 큰 손실을 볼 수 있음을 경계하십시오.",
    51: "51수리는 목(木)의 곡절이 노련한 지혜의 파동으로 승화되는 수리입니다. 성패의 굴곡을 통해 삶의 깊이를 새기나, 이름의 유지력이 부족할 경우 이룬 성과를 지키지 못하고 다시 원점에서 시작해야 할 리스크를 조심하십시오.",
    52: "52수리는 목(木)의 도약 기운이 지략과 만나 결정적 성취의 파동을 만듭니다. 조용히 힘을 기르다 폭발적으로 성공하는 능력을 주나, 이름의 휴식 에너지가 결여되어 목표만을 향해 달리다 만성 피로와 번아웃을 겪을 수 있음을 경계하십시오.",
    53: "53수리는 화(火)의 외양 중시 성분이 광범위한 인맥의 파동을 만듭니다. 대중적 인지도를 얻는 사교술을 주나, 이름의 관계가 깊지 못할 경우 진솔한 소통 없이 겉치레만 남는 허무한 인간관계를 조심해야 합니다.",
    54: "54수리는 화(火)의 억압된 기운이 단단한 책임감의 파동을 만듭니다. 어려움 속에서도 신의를 지키는 성품을 주나, 이름의 재물 에너지가 약해질 경우 무리한 확장이나 부채로 인해 삶의 기반이 흔들릴 수 있음을 경계하십시오.",
    55: "55수리는 토(土)의 겸손함이 깊은 내공의 파동을 일으키는 수리입니다. 신중함으로 결정적인 순간 가치를 빛내나, 이름 속에 억눌린 과시욕이 갑자기 고개를 들 경우 타인의 시기를 받아 공든 탑이 무너질 수 있음을 조심하십시오.",
    56: "56수리는 토(土)의 조심성이 신중한 포용의 파동을 만듭니다. 타인의 의견을 수용하고 실수를 차단하나, 이름의 결단력이 부족해질 경우 결정적인 순간 주저하여 남에게 기회를 뺏기는 조연의 삶에 머물 수 있음을 경계하십시오.",
    57: "57수리는 금(金)의 개척 정신이 질서의 파동을 만드는 시스템의 수리입니다. 무질서를 베어내고 완벽한 체계를 구축하나, 이름의 목표 지향성이 너무 강해질 경우 주변 사람을 수단으로 여겨 고독한 리더가 될 수 있음을 조심하십시오.",
    58: "58수리는 금(金)의 끈기가 자수성가의 파동을 일으키는 수리입니다. 견고한 자산 토대를 구축하는 인내심을 주나, 이름의 베푸는 미덕이 부족할 경우 재물에만 집착하다 노년이 외롭게 고립될 수 있는 리스크를 경계하십시오.",
    59: "59수리는 수(水)의 자유로운 기운이 창의적 상상의 파동을 만듭니다. 틀에 얽매이지 않는 재능과 넓은 시야를 주나, 이름의 지탱력이 부족할 경우 변덕이 심해져 한 분야의 전문성을 완성하지 못하고 방황할 수 있음을 조심하십시오.",
    60: "60수리는 수(水)의 풍파가 날카로운 노련함의 파동을 만드는 수리입니다. 사람을 꿰뚫어 보는 생존형 통찰을 주나, 정작 가까운 사람을 가려내는 안목이 부족해 믿었던 이에게 배신을 당하거나 이용당할 수 있는 지점을 경계하십시오.",
    61: "61수리는 목(木)의 현명함이 수장의 기운과 만나 명예의 파동을 만듭니다. 원칙 준수와 고결한 품격으로 지도자 역할을 하나, 이름에 서린 온정주의가 냉정한 판단을 가로막아 조직의 대업을 그르칠 수 있는 지점을 조심하십시오.",
    62: "62수리는 목(木)의 희생 정신이 따뜻한 봉사의 파동을 만듭니다. 자비심으로 주변을 밝히는 소금 같은 역할을 하나, 이름의 방어 기제가 약해질 경우 타인에게 무리하게 이용당해 본인의 에너지가 고갈되는 상황을 경계하십시오.",
    63: "63수리는 화(火)의 결실 기운이 성공의 파동을 일으키는 수리입니다. 재물운과 명성으로 모든 일을 성취로 이끄나, 이름의 순탄한 환경이 경각심을 무너뜨려 내부 관리 소홀로 인한 돌발 악재를 맞이할 수 있음을 조심하십시오.",
    64: "64수리는 화(火)의 응축된 에너지가 독창적 사유의 파동을 만듭니다. 신비로운 예술 감각과 지적 깊이를 주나, 이름의 현실 정리 능력이 부족할 경우 머릿속과 주변 환경이 늘 복잡하게 꼬여 실행력이 떨어지는 점을 경계하십시오.",
    65: "65수리는 토(土)의 평온함이 복덕의 파동을 만드는 명예의 수리입니다. 삶의 후반기를 황금빛 결실로 채우게 하나, 이름의 높은 자리가 나태함과 오만을 부를 경우 아랫사람들의 마음을 잃어 기반이 흔들릴 수 있음을 조심하십시오.",
    66: "66수리는 토(土)의 부드러움이 유연한 포용의 파동을 만듭니다. 상황을 둥글게 넘기는 인간적인 매력을 주나, 이름의 끊고 맺음이 약해질 경우 타인의 무리한 부탁이나 보증 요구를 거절하지 못해 큰 화를 당할 수 있음을 경계하십시오.",
    67: "67수리는 금(金)의 예술적 성분이 세련된 리더십의 파동을 형성합니다. 창의성과 체계적 운영 능력을 조화롭게 지휘하나, 이름에 서린 정서적 교류 에너지가 부족해질 경우 문득 깊은 고독과 소외감을 느낄 수 있는 점을 조심하십시오.",
    68: "68수리는 금(金)의 지략이 창업의 기운과 만나 시스템의 파동을 만듭니다. 치밀한 전략으로 무적의 체계를 구축하나, 이름의 인간미가 결여될 경우 참모와 부하 직원들을 심하게 압박하여 조직의 생기를 잃게 할 수 있음을 경계하십시오.",
    69: "69수리는 수(水)의 정체 기운이 극한의 지성으로 승화되는 수리입니다. 혼자만의 시간 속에서 심오한 학문적 성취를 이루나, 이름의 지지 기반이 없이 마음만 조급해질 경우 현실적인 실행마다 실패를 맛볼 수 있음을 조심하십시오.",
    70: "70수리는 수(水)의 공허함이 우주적 통찰로 이어지는 사유의 파동입니다. 욕망을 초월한 고결한 정신성을 주나, 이름의 생동하는 기운이 부족할 경우 현실 도피적인 경향이 강해져 무기력증이나 우울의 늪에 빠질 수 있음을 경계하십시오.",
    71: "71수리는 목(木)의 내실 기운이 완벽한 전문성의 파동을 만듭니다. 철저한 실리 추구로 흔들리지 않는 부를 누리나, 이름의 아집이 강해질 경우 융통성이 사라져 주변과 단절된 자기만의 성안에 갇힐 리스크를 조심하십시오.",
    72: "72수리는 목(木)의 팽창력이 거침없는 도전의 파동을 일으킵니다. 역동적인 에너지로 앞을 향해 추진하는 힘을 주나, 이름의 리스크 관리 능력이 무너질 경우 감정적인 과잉 투자로 인해 막대한 경제적 손실을 볼 수 있음을 경계하십시오.",
    73: "73수리는 화(火)의 마무리 기운이 지혜로운 정돈의 파동을 만듭니다. 원숙한 판단력으로 인생의 명예로운 결실을 맺으나, 이름의 기운이 과거의 영광에만 안주하려 할 경우 시대의 변화를 읽지 못해 도태될 수 있는 지점을 조심하십시오.",
    74: "74수리는 화(火)의 쇠퇴 기운을 정신력으로 제련하는 인내의 파동입니다. 고난 속에서도 도덕적 자부심을 지키는 강철 멘탈을 주나, 이름의 시련이 길어질 경우 미래에 대한 희망을 잃고 극단적인 비관주의에 빠질 수 있음을 경계하십시오.",
    75: "75수리는 토(土)의 균형 잡힌 성분이 평화의 파동을 만드는 안식의 수리입니다. 원만한 인격으로 평안한 노후를 보장하나, 이름의 날카로운 결정력이 부족해질 경우 인생의 결정적인 고비마다 자신의 권리를 챙기지 못하고 물러설 수 있음을 조심하십시오.",
    76: "76수리는 토(土)의 분산 성질이 쿨한 매력의 파동을 형성합니다. 넓은 활동 범위와 대범한 씀씀이로 호감을 얻으나, 이름의 응집력이 심각하게 결여될 경우 벌어들인 재물이 실속 없이 새어 나가 경제적 불안을 초래할 수 있음을 경계하십시오.",
    77: "77수리는 금(金)의 원칙 준수가 투쟁의 파동을 일으키는 수리입니다. 외압에 굴복하지 않고 신념을 수호하는 힘을 주나, 이름의 유연함이 부족해질 경우 적군과 아군을 극단적으로 나누어 끊임없는 마찰과 갈등을 빚어낼 수 있음을 조심하십시오.",
    78: "78수리는 금(金)의 신중함이 리스크 관리의 파동을 만듭니다. 빈틈없는 준비성으로 불확실성을 차단하나, 이름의 낙천적 에너지가 부족해질 경우 일어나지도 않을 걱정에 짓눌려 중요한 도전의 기회조차 시도하지 못할 수 있음을 경계하십시오.",
    79: "79수리는 수(水)의 은둔 기운이 깊은 지성의 파동을 형성합니다. 한 분야의 전문 지식을 쌓아 진리를 깨우치게 하나, 이름의 자기 홍보력이 약해질 경우 뛰어난 능력을 세상에 알리지 못하고 고립된 채 능력을 썩힐 수 있음을 조심하십시오.",
    80: "80수리는 수(水)의 성찰 기운이 세속의 집착을 끊는 고요의 파동입니다. 최고조의 정신적 고결함과 지혜를 주나, 이름의 역동적인 생기가 부족해질 경우 현실 세계의 활력을 잃고 무기력한 은둔자로 남을 수 있는 리스크를 경계하십시오.",
    81: "81수리는 만물의 환희와 대순환의 파동이 정점에 달한 수리입니다. 완벽한 조화로 인생의 거대한 성취를 거머쥐게 하나, 이름의 성공에 흠뻑 취해 자만심이 고개를 들 경우 오만함으로 인해 스스로 혹독한 시련의 씨앗을 뿌릴 수 있음을 조심하십시오."
};

const detailedDesc81En = {
    1: "Suri 1 creates a powerful vibration of pure independence through dual Wood energies. This vitality grants a pioneering spirit, yet be cautious as this intensity may lead to dogmatic decisions that ignore external perspectives.",
    2: "Suri 2 forms a flexible wave of empathy through dispersed Wood energy. While it maximizes cooperation, be vigilant against a lack of resolution or weak decisiveness when the vibration fails to coalesce.",
    3: "Suri 3 generates a brilliant wave of expansion through Fire energy. It drives self-expression and honor, but beware of wasting energy on surface-level vanity without building substantial internal depth.",
    4: "Suri 4 triggers a volatile vibration through overheated Fire energy. It grants an innovative spirit to break old orders, yet beware of emotional swings that may cloud your judgment at critical moments.",
    5: "Suri 5 establishes a wave of unshakeable stability through dual Earth energies. It attracts wealth and people, but guard against falling into stagnation or losing your pioneering edge due to over-reliance on comfort.",
    6: "Suri 6 creates a wave of succession through Earth's cohesive power. While it builds trust as a leader, be cautious of losing innovation timing due to a heavy temperament that resists rapid change.",
    7: "Suri 7 forges a vibration of sharp achievement through overlapping Metal energies. It provides extreme professionalism, but be wary of a cold demeanor that may inadvertently hurt others and create unnecessary friction.",
    8: "Suri 8 forms a wave of persistent tenacity through accumulated Metal energy. It builds self-made wealth, yet be vigilant as a narrowed communication channel may cause you to appear stubbornly unapproachable.",
    9: "Suri 9 generates a vibration of brilliant intuition through the depths of Water. It grants the intelligence to explore unseen truths, but guard against the risk of falling into nihilism or extreme solitude.",
    10: "Suri 10 creates a wave of infinite potential where Water's ends and beginnings meet. While versatile, be cautious of a weak core that might cause practical results to scatter into vanity.",
    11: "Suri 11 triggers a vibration of revival through Wood's regenerative energy. It grants leadership to innovate a stagnant life, but beware of losing self-control due to arrogance following early success.",
    12: "Suri 12 creates a growth wave through Wood's endurance in harsh environments. It leads to deep contemplation, but be wary of being swayed by external pressure and losing your sovereignty.",
    13: "Suri 13 forms a wave of fame as Fire's brilliance meets strategic tact. It grants the intelligence to lead the public, yet beware of being perceived as frivolous or inviting gossip through thoughtless speech.",
    14: "Suri 14 creates a vibration where Fire's delicacy sublimates into analytical power. It grants sharp intuition, but be wary of extreme mental exhaustion caused by a lack of emotional buffering.",
    15: "Suri 15 forges soft charisma through the harmony of Earth's virtue. It grants a well-rounded character to lead many, yet beware of missing decisive opportunities by prioritizing stability over aggression.",
    16: "Suri 16 generates a wave of fortune through Earth's benevolence. While enhancing asset management, guard against excessive emotions that might cloud cold judgment and lead to financial losses from others' requests.",
    17: "Suri 17 creates a breakthrough vibration as Metal's fighting spirit surges. It grants the power to seize honor, but be cautious of an extreme tendency to break rather than bend when flexibility is required.",
    18: "Suri 18 forms a vibration of completion through Metal's solid conviction. It grants mastery in a field, yet beware of isolated stubbornness that might block empathy and result in a lonely success.",
    19: "Suri 19 generates a wave of genius where Water's deep insight meets artistic sensitivity. Guard against the risk of submerging into mental instability or solitude if the gap between ideals and reality widens.",
    20: "Suri 20 creates a vibration of grand ideals through Water's vast energy. While it provides great scale, be cautious of a high failure rate if your execution is scattered by over-ambition.",
    21: "Suri 21 establishes powerful leadership as Wood's dignity meets command energy. It grants charisma, but beware of appearing dogmatic and triggering fierce backlash from within your organization.",
    22: "Suri 22 triggers a creative wave through Wood's delicate artistry. It grants technical excellence, yet be wary of internal instability and performance devaluation due to interpersonal friction.",
    23: "Suri 23 forms a wave of success as Fire's explosive energy peaks. It places you at the center of the world, but be cautious of overreaching after success, which could damage both your health and luck.",
    24: "Suri 24 creates a wave of abundance as Fire's heat refines Metal into jewels. It grants innate financial sense, yet guard against greed that could instantly tarnish the honor you've worked hard to build.",
    25: "Suri 25 generates a vibration of flexible tact through Earth's harmony. It grants the cleverness to navigate crises, but beware of being perceived as an opportunist if you fail to maintain sincerity.",
    26: "Suri 26 is a heroic vibration where Earth hardens through trials. It grants unyielding will, yet you must be wary of a psychological pattern that seeks out hardship rather than enjoying peace.",
    27: "Suri 27 forms a vibration of intellectual logic through Metal's sharp analysis. While brilliant at discerning right from wrong, be cautious of alienating others by judging them solely through critical standards.",
    28: "Suri 28 creates an ambitious wave through Metal's massive expansion. It provides the drive for growth, yet beware of an unstable foundation or poor finishing caused by a lack of detailed management.",
    29: "Suri 29 establishes a wave of completion as Water's wisdom meets public trust. It brings social status, but guard against stagnation; you must maintain constant dynamism to prevent your luck from halting.",
    30: "Suri 30 is a gambler's vibration where Water's dynamism calls for reversal. It grants resilience, yet be cautious of a life rendered unstable by luck that fluctuates with your emotional swings.",
    31: "Suri 31 creates a vibration of self-made success through Wood's interpersonal luck. While it drives achievement through help from others, beware of losing your identity by being overly swayed by others' opinions.",
    32: "Suri 32 forms a favorable wave as Wood's communication meets wealth luck. It brings natural opportunities, but be cautious of relying on mere luck without the diligence to build solid internal skills.",
    33: "Suri 33 is an imperial vibration as Fire's manifestation reaches its peak. It brings eye-catching achievement, yet you face a high risk of creating powerful enemies if you lack the humility to recognize others.",
    34: "Suri 34 creates a master's vibration where suppressed Fire energy is refined through patience. It grants superhuman willpower, but beware of a psychological abyss that can lead to self-destruction if you lose optimism.",
    35: "Suri 35 generates a wave of peaceful family luck through Earth's gentleness. It provides comfort, yet guard against becoming trapped in a comfort zone and missing grand opportunities for growth.",
    36: "Suri 36 triggers a vibration of loyalty and devotion through Earth's weight. It brings a leadership that others admire, but be wary of neglecting your own financial base due to excessive self-sacrifice.",
    37: "Suri 37 creates a vibration of exclusive authority through Metal's craftsmanship. It grants irreplaceable expert status, yet guard against being misidentified as cold or heartless due to a lack of empathy.",
    38: "Suri 38 forms an expressive wave where Metal's sharpness connects to artistic achievement. It grants aesthetic sense, but be cautious of ruining your progress by ignoring proper procedures in haste.",
    39: "Suri 39 creates a vibration of completed fruition as Water's glory meets abundance. It provides a stable environment, but beware of a lack of vigilance that could lead to arrogance and systemic risks.",
    40: "Suri 40 is a vibration of survival as Water's fluctuation triggers pioneering. It grants rapid adaptability, yet be wary of losing precious assets in a moment through speculative ventures caused by a weak core.",
    41: "Suri 41 generates a tycoon's vibration as Wood's command meets growth energy. It grants management skill, but guard against a total breakdown of work-life balance or health by obsessively pursuing success.",
    42: "Suri 42 creates a self-reliant wave as Wood's independence turns trials into inner strength. It grants the power to stand alone, but be cautious of an isolated environment where it is difficult to receive help when needed.",
    43: "Suri 43 forms a vibration of charm as Fire's ostentation enhances brand value. It grants star quality, yet beware of a success that is hollow if you focus only on outward appearance rather than internal assets.",
    44: "Suri 44 creates a vibration of extraordinary creativity through Fire's turbulent energy. It leads to innovative ideas, but be cautious of mental wandering caused by a lack of composure and negative thought loops.",
    45: "Suri 45 is a vibration of great success through Earth's integrative energy. It brings honor and stability, yet guard against poor judgment caused by flattery or false information by keeping critical advisors nearby.",
    46: "Suri 46 generates a vibration of insight through Earth's contemplative power. While it grants deep philosophical ability, be cautious of wasting your talent by failing to concentrate on a single goal.",
    47: "Suri 47 forms a vibration of late bloom as Metal's solidity bears fruit through patience. It builds massive wealth through trust, but beware of a long initial period of hardship due to weak initial expansion.",
    48: "Suri 48 is a strategist's vibration as Metal's virtue leads to correct judgment. It grants moral standards, but be wary of alienating others by imposing excessively strict standards on them.",
    49: "Suri 49 creates a vibration of versatile transformation through Water's flexibility. It grants survival skills in any environment, yet be cautious of being seen as an opportunist if you lack firm core values.",
    50: "Suri 50 generates a vibration of reversal as Water's courage meets cooperation. It grants a bold gambler's spirit, but beware of massive losses through emotional investments if your rational control weakens.",
    51: "Suri 51 is a vibration of seasoned wisdom sublimated from Wood's ups and downs. It grants a positive dynamism, but be cautious of losing your achievements if you lack the solidity to maintain stability.",
    52: "Suri 52 forms a vibration of decisive achievement as Wood's leap meets strategic tact. It grants the power to explode into success, but beware of chronic fatigue and burnout by neglecting the energy of rest.",
    53: "Suri 53 creates a vibration of broad networking through Fire's outward focus. It grants the ability to gain public recognition, yet guard against shallow relationships that lack sincerity and substance.",
    54: "Suri 54 generates a vibration of solid responsibility through Fire's suppressed energy. It grants a character that keeps faith through hardship, yet beware of financial instability caused by over-expansion.",
    55: "Suri 55 is a vibration of dignity as Earth's humility creates deep inner strength. It makes your value shine at critical moments, but be wary of envy from others if a suppressed desire for display suddenly surfaces.",
    56: "Suri 56 forms a wave of cautious embrace through Earth's vigilance. It blocks fatal errors, yet beware of staying in a supporting role by hesitating at the moment a decisive move is required.",
    57: "Suri 57 is a vibration of systemization as Metal's pioneering spirit creates order. It establishes perfect structures, but be cautious of becoming a lonely, dogmatic leader by viewing people merely as means to an end.",
    58: "Suri 58 creates a vibration of diligence as Metal's persistence drives self-made success. It builds a solid asset base, yet beware of a lonely retirement if you obsess over wealth while neglecting the virtue of giving.",
    59: "Suri 59 forms a wave of creative imagination through Water's free spirit. It grants versatile talent, but be wary of mental wandering and a failure to master a field due to excessive fickleness.",
    60: "Suri 60 is a vibration of sharp experience where Water's trials create insight. It grants survival intuition, yet be cautious of betrayal by failing to accurately discern the character of those close to you.",
    61: "Suri 61 creates a leader's vibration as Wood's wisdom meets command energy. It grants honor through principles, but beware of letting personal sentimentality cloud the cold judgment required for great tasks.",
    62: "Suri 62 forms a wave of warm service through Wood's spirit of sacrifice. While you act as the salt of the earth, be cautious of being exploited by others and depleting your own energy due to weak defense mechanisms.",
    63: "Suri 63 is a vibration of abundance where Fire's fruition triggers success. It brings wealth and fame, yet guard against unexpected crises caused by a loss of vigilance in a seemingly perfect environment.",
    64: "Suri 64 generates a vibration of original thought through Fire's condensed energy. While providing intellectual depth, beware of falling execution power due to a cluttered mind and unorganized environment.",
    65: "Suri 65 is an honorable vibration where Earth's serenity creates fortune. It fills the latter half of life with golden results, but be cautious of losing the support of others if high status leads to laziness and pride.",
    66: "Suri 66 forms a wave of flexible embrace through Earth's gentleness. While it provides human charm, beware of serious damage caused by an inability to refuse unreasonable requests or financial guarantees.",
    67: "Suri 67 establishes a vibration of sophisticated leadership through Metal's artistic sense. It manages systems with creativity, yet beware of deep solitude if you fail to maintain emotional resonance with your team.",
    68: "Suri 68 creates a vibration of systemization as Metal's strategic tact meets entrepreneurial energy. It builds invincible structures, but beware of stifling the organization by lacking human warmth.",
    69: "Suri 69 is a vibration where Water's stagnation sublimates into extreme intelligence. It brings academic achievement in solitude, but be cautious of practical failures if you act with haste without a solid foundation.",
    70: "Suri 70 forms a wave of contemplation as Water's emptiness leads to cosmic insight. While it grants deep wisdom, guard against the risk of escaping reality into listlessness or a swamp of nihilism.",
    71: "Suri 71 creates a vibration of perfect professionalism through Wood's internal solidity. It brings unshakeable wealth, yet beware of being trapped in your own fortress due to a lack of flexibility and extreme stubbornness.",
    72: "Suri 72 triggers a vibration of bold challenge through Wood's expansion. It provides a powerful engine for progress, yet beware of massive financial losses through emotional over-investments if risk management fails.",
    73: "Suri 73 forms a wave of wise organization through Fire's finishing energy. It settles life with honor, but beware of becoming obsolete by clinging to past glories and failing to read the changes of the new era.",
    74: "Suri 74 is a vibration of endurance as Fire's decline is refined through willpower. It grants an iron mentality, yet guard against extreme pessimism and loss of hope if trials persist for an extended period.",
    75: "Suri 75 is a vibration of rest where Earth's balance creates peace. It ensures a tranquil old age, but be cautious of losing your rights at critical junctures by prioritizing harmony over decisive self-interest.",
    76: "Suri 76 forms a vibration of cool charm through Earth's dispersed nature. While it gains favor through broad activities, beware of economic instability if a lack of cohesion causes your wealth to leak away without substance.",
    77: "Suri 77 is a vibration where Metal's principles trigger a spirit of struggle. It grants the power to protect convictions, but beware of constant friction if a lack of flexibility causes you to polarize people into friends and foes.",
    78: "Suri 78 creates a vibration of risk management through Metal's vigilance. It blocks uncertainty through preparedness, yet guard against missing challenges by being overwhelmed by worries that may never manifest.",
    79: "Suri 79 forms a vibration of deep intelligence through Water's reclusive energy. It grants mastery in a field, yet be wary of wasting your talent in isolation if you lack the self-promotion skills to inform the world.",
    80: "Suri 80 is a vibration of stillness where Water's reflection cuts off worldly attachments. It grants peak spiritual dignity, but beware of remaining a listless recluse by losing the dynamic vitality of the real world.",
    81: "Suri 81 is a vibration where the joy of all things and the great cycle reach their peak. It brings grand achievement, but be cautious of sowing seeds of hardship through arrogance if you become intoxicated by your own success."
};
