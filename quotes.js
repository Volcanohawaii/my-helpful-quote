...
const nameNumerology = (() => {
    ...
    for (let n = 1; n <= 81; n++) {
        ...
        out[n] = { title: `${String(n).padStart(2, "0")}수·${baseKo[a].key}`, desc: `${baseKo[a].core}의 기운이 발현됩니다.`, titleEn: `No.${n}·${baseEn[a].key}`, descEn: `Your energy is in ${stageEn[b]} phase.` };
    }
    return out;
})();
...
const reasonKo = { "木": "성장", "火": "열정", "土": "안정", "金": "결단", "水": "통찰" };
const reasonEn = { "木": "Growth", "火": "Passion", "土": "Stability", "金": "Logic", "水": "Insight" };

const pastLifeData = Array.from({ length: 81 }, (_, i) => ({ job: pastJobsKo[i%9], desc: `${i+1}수 성향.`, homework: "조화로운 삶." }));
const pastLifeDataEn = Array.from({ length: 81 }, (_, i) => ({ job: pastJobsEn[i%9], desc: `No.${i+1} trace.`, homework: "Balance." }));
...
// nicknamesKo 정의 (HTML 크래시 방지용)
const nicknamesKo = { "木": { veryStrong: "개척자", strong: "기획자", normal: "중재자", weak: "싹", veryWeak: "가지" }, "火": { veryStrong: "태양", strong: "리더", normal: "등불", weak: "별빛", veryWeak: "온기" }, "土": { veryStrong: "산", strong: "수호자", normal: "관리자", weak: "언덕", veryWeak: "정령" }, "金": { veryStrong: "심판자", strong: "검객", normal: "조각가", weak: "세공사", veryWeak: "철학자" }, "水": { veryStrong: "소용돌이", strong: "항해사", normal: "시냇물", weak: "예술가", veryWeak: "연
