...
const elementPrescriptions24 = {
    "목(木)": [
        "당신의 시그니처인 목(木)은 정체된 환경을 뚫고 솟아오르는 강력한 독립심과 자생력을 의미합니다. 본래 정적인 기운이 강한 환경에서 태어났으나, 성명의 목(木) 에너지가 이를 자극하여 부모의 도움 없이 스스로 길을 개척하려는 독고다이적 사고를 갖게 되었습니다. 당신은 간섭받는 것을 극도로 싫어하며, 직업적으로는 <b>벤처 파운더, 현장 지휘관, 혹은 독립적인 시스템 설계자</b> 분야에서 독보적입니다. 에너지를 잘 활용하기 위해 독단적인 결정을 경계하고, 자신의 기술을 매뉴얼화하는 습관을 실천하십시오.",
        "당신의 시그니처인 목(木)은 멈추지 않는 확장과 실전적 지도력을 상징합니다. 타고난 생명력이 이름의 기운과 중첩되어, 단순히 이론을 가르치는 것을 넘어 현장에서 직접 시범을 보이고 이끄는 혁신가적 기질을 완성했습니다. 당신은 행동으로 증명하는 것을 선호하며, <b>경찰 간부, 특수 전문 교사, 혹은 현장 프로젝트 매니저</b> 분야에서 최고의 효율을 냅니다. 에너지를 관리하려면 고집스러운 완벽주의를 조금 내려놓고 타인의 속도에 맞추는 유연함을 실천하십시오.",
        "당신의 시그니처인 목(木)은 사람과 상황을 연결하여 질서를 잡는 강직한 중재 에너지를 의미합니다. 본래 수용적인 성품이었으나 성명이 원칙을 더해주어, 부드러움 속에 날카로운 판단력을 가진 해결사가 되었습니다. 당신은 혼란 속에서 기준을 세우는 것을 좋아하며, <b>기업 분쟁 조정관, 인사(HR) 전략가, 혹은 전문 수사관</b>이 잘 어울립니다. 에너지를 높이기 위해 공과 사의 경계를 철저히 하고, 주기적으로 혼자만의 시간을 통해 정신적 에너지를 충전하십시오.",
        "당신의 시그니처인 목(木)은 정체된 판을 단숨에 뒤엎는 강력한 변화의 주파수를 가집니다. 각성 에너지가 성명의 파동과 만나 잠자던 조직을 흔들어 깨우는 실행가적 사고를 갖게 되었습니다. 당신은 기존 관습을 타파하는 파격적인 제안을 즐기며, <b>전략 마케팅 리더, 보안 시스템 혁신가, 혹은 트렌드 디렉터</b> 분야에서 빛이 납니다. 에너지를 활용하기 위해 쏟아지는 영감을 데이터로 수치화하고, 자원을 효율적으로 배분하는 법을 실천하십시오.",
        "당신의 시그니처인 목(木)은 사물의 본질을 설계하고 원칙을 고수하는 논리적 설계 능력을 의미합니다. 균형의 기운이 성명에 깃들어 감정에 휘둘리지 않고 최적의 해답을 찾아내는 이성적 사고를 갖게 되었습니다. 당신은 복잡한 세상을 단순한 매뉴얼로 정리하는 것을 좋아하며, <b>웹 아키텍트, 정밀 설계자, 혹은 법공학 연구원</b> 계열이 잘 어울립니다. 에너지를 잘 활용하기 위해 자신의 논리에만 갇히지 말고, 현장의 목소리를 설계에 반영하는 유연함을 실천하십시오.",
        "당신의 시그니처인 목(木)은 타인의 잠재력을 발견하여 올바른 길로 안내하는 네비게이터를 상징합니다. 맑은 통찰력이 성명의 기운과 결합하여 사람의 강점과 약점을 즉각 파악하고 교정하려는 사고를 갖게 되었습니다. 당신은 타인이 올바르게 성장할 때 큰 성취감을 느끼며, <b>기술 전수 전문가, 커리어 멘토, 혹은 전문 교육 행정가</b> 분야에서 독보적입니다. 에너지를 지키기 위해 타인의 문제에 지나치게 개입하지 말고, 본인의 정서적 주권을 지키는 연습을 실천하십시오.",
        "당신의 시그니처인 목(木)은 정보를 체계화하여 실용적 자산으로 전환하는 실전 경제 지혜를 의미합니다. 풍요로운 기운이 성명과 만나 지식을 현실의 물류와 자본으로 바꾸는 비즈니스 사고를 갖게 되었습니다. 당신은 가치 있는 정보를 선별하고 전달하는 것을 선호하며, <b>약사, 제약 유통 전략가, 혹은 데이터 에디터</b> 분야가 천직입니다. 에너지를 활용하기 위해 머릿속의 지식을 즉시 실용적인 유통망이나 결과물로 연결하는 기계적 습관을 실천하십시오.",
        "당신의 시그니처인 목(木)은 고결한 이상을 실현하며 사회에 강력한 영향력을 주는 에너지를 상징합니다. 성명의 화려함이 더해져 미적 가치와 공적인 명예를 동시에 실현하려는 고결한 사고를 갖게 되었습니다. 당신은 정의로운 아름다움을 통해 세상을 정화하는 것을 좋아하며, <b>공간 브랜딩 전문가, 문화 콘텐츠 기획자, 혹은 환경 법률가</b> 계열이 잘 어울립니다. 에너지를 높이기 위해 자신만의 가치를 대중의 언어로 당당히 설득하는 커뮤니케이션을 실천하십시오.",
        "당신의 시그니처인 목(木)은 조직 전체의 흐름을 한눈에 장악하고 통제하는 거시적 리더십을 의미합니다. 충만한 기운이 성명과 만나 큰 대의를 주도하고 정점을 향해 나아가는 야망가적 사고를 갖게 되었습니다. 당신은 거대 프로젝트를 진두지휘하는 것을 즐기며, <b>사업 총괄 본부장, 고위 관리직 공무원, 혹은 글로벌 운영 이사</b> 분야에서 성공합니다. 에너지를 잘 쓰기 위해 자리에 오를수록 낮은 곳의 소리를 경청하고 포용력을 갖추는 리더의 덕목을 실천하십시오.",
        "당신의 시그니처인 목(木)은 찰나의 기회를 포착하여 승리로 이끄는 예리한 직관을 의미합니다. 분주한 환경 속에서 성명의 날카로운 기운이 결합하여 리스크를 수익으로 바꾸는 승부사적 사고를 갖게 되었습니다. 당신은 경쟁을 통해 성과를 쟁취하는 과정을 선호하며, <b>전문 투자자, 글로벌 영업 디렉터, 혹은 전문 딜러</b> 분야가 천직입니다. 에너지를 보존하기 위해 단기적인 승리보다 장기적인 공존의 가치를 먼저 계산하는 거시적 습관을 실천하십시오.",
        "당신의 시그니처인 목(木)은 흔들리지 않는 중심을 바탕으로 군더더기를 걷어내는 정밀 분석력을 의미합니다. 강력한 빛 아래에서 성명의 냉철함이 더해져 본질적인 것만 남기는 완벽주의적 사고를 갖게 되었습니다. 당신은 결점 없는 시스템을 만들어내는 공정을 선호하며, <b>정책 기획가, 공정 설계 전문가, 혹은 품질 관리 실장</b> 계열이 잘 어울립니다. 에너지를 잘 활용하기 위해 주변의 유혹에 흔들리지 않고 오직 본질에만 집중하는 결단력을 매 순간 실천하십시오.",
        "당신의 시그니처인 목(木)은 보이지 않는 곳에서 거대한 시스템을 지탱하는 인내심을 의미합니다. 열기를 성명이 흡수하여 내실 있는 성장을 추구하는 실속가적 사고를 갖게 되었습니다. 당신은 기초를 튼튼히 다지고 시스템을 안착시키는 과정을 선호하며, <b>플랫폼 운영 매니저, 전략 연구원, 혹은 전문 기술 가이드</b> 분야에서 탁월합니다. 에너지를 높이기 위해 작은 성취를 이룰 때마다 스스로에게 명확한 보상을 주어 지속 가능한 에너지를 관리하십시오.",
        "당신의 시그니처인 목(木)은 극한의 압박 속에서도 해답을 찾아내는 강인한 생존력을 상징합니다. 혹독한 환경을 성명이 정면 돌파하며 어떤 위기도 성장의 발판으로 삼는 해결사적 사고를 갖게 되었습니다. 당신은 복잡하게 얽힌 문제를 푸는 과정에서 희열을 느끼며, <b>위기관리 매니저, 구조조정 전문가, 혹은 전문 경영 컨설턴트</b> 분야가 천직입니다. 에너지를 잘 활용하기 위해 자신의 독단적인 판단보다는 지혜로운 조언자를 곁에 두는 유연함을 실천하십시오.",
        "당신의 시그니처인 목(木)은 결실의 가치를 미리 파악하고 질서를 수호하는 냉철한 판단력을 의미합니다. 서늘한 기운이 성명의 단호함과 만나 조직의 기준을 세우고 투명성을 지키는 수호자적 사고를 갖게 되었습니다. 당신은 흐트러짐 없는 원칙을 고수하는 환경을 좋아하며, <b>준법 감사인, 품질 책임자, 혹은 법률 조력자</b> 계열이 잘 어울립니다. 에너지를 높이기 위해 비판 뒤에 반드시 건설적인 대안을 제시하여 사람을 살리는 언어 습관을 실천하십시오.",
        "당신의 시그니처인 목(木)은 파편화된 정보를 하나로 묶어 가치를 극대화하는 갈무리 능력을 의미합니다. 정리의 기운이 성명과 만나 방대한 데이터를 본질 위주로 재구성하는 분석적 사고를 갖게 되었습니다. 당신은 무질서 속에서 일관된 규칙을 찾아내는 것을 선호하며, <b>데이터 사이언티스트, 기록물 전문가, 혹은 정보 전략가</b> 분야에서 활약합니다. 에너지를 활용하기 위해 '완벽보다는 완결'을 최우선으로 삼아 실행의 속도를 높이는 연습을 실천하십시오.",
        "당신의 시그니처인 목(木)은 미세한 틈조차 놓치지 않는 장인 정신과 하이엔드 감각을 상징합니다. 투명한 환경이 성명의 완벽주의와 결합하여 한 치의 오차도 허용하지 않는 전문가적 사고를 갖게 되었습니다. 당신은 최고급 퀄리티의 결과물을 생산하는 것을 즐기며, <b>정밀 설계 전문가, 기술 고문, 혹은 특수 공정 전문가</b> 분야가 천직입니다. 에너지를 보존하기 위해 주기적으로 미시적인 작업에서 벗어나 세상 전체의 흐름을 살피는 안목을 실천하십시오.",
        "당신의 시그니처인 목(木)은 사회적 균형을 수호하고 공정한 가치를 실천하는 정의감을 의미합니다. 조화로운 기운이 성명의 강직함과 만나 옳고 그름을 명확히 판별하는 법치주의적 사고를 갖게 되었습니다. 당신은 약속과 규칙을 준수하며 공평한 보상을 중시하며, <b>판사, 변호사, 혹은 시민 활동가</b> 계열이 잘 어울립니다. 에너지를 잘 쓰기 위해 법의 논리 이전에 사람의 삶에 담긴 수많은 사연을 포용하려는 유연한 태도를 실천하십시오.",
        "당신의 시그니처인 목(木)은 서늘한 지성으로 다가올 위기를 대비하는 치밀한 전략적 사고를 의미합니다. 차가운 기운이 성명의 지능과 만나 보이지 않는 흐름을 읽고 대안을 세우는 지략가적 사고를 갖게 되었습니다. 당신은 리스크를 예측하고 시나리오별 대응책을 짜는 것을 즐기며, <b>금융 분석가, 미래 전략 기획자, 혹은 알고리즘 개발자</b> 분야가 천직입니다. 에너지를 높이기 위해 디지털 정보 뒤에 숨겨진 '사람의 진짜 열망'을 읽어내는 감성 훈련을 실천하십시오.",
        "당신의 시그니처인 목(木)은 조직의 안정과 기강을 수호하며 부정을 경계하는 강인한 가디언을 상징합니다. 엄격한 환경이 성명과 만나 자신의 신념을 끝까지 관철하는 단단한 사고를 갖게 되었습니다. 당신은 원칙을 지키며 조직을 수호하는 것을 선호하며, <b>경찰, 형사, 혹은 국보급 보안 책임자</b> 분야에서 명성을 얻습니다. 에너지를 활용하기 위해 자신의 신념이 독단이 되지 않도록 타인과 타협할 줄 아는 부드러운 화법을 실천하십시오.",
        "당신의 시그니처인 목(木)은 인간사와 비즈니스 이면에 숨겨진 본질을 꿰뚫어 보는 통찰력을 의미합니다. 정적인 환경이 성명과 만나 근본적인 원인을 탐구하고 철학적 해답을 찾는 사고를 갖게 되었습니다. 당신은 '왜'라는 질문을 던지고 본질을 파고드는 과정을 좋아하며, <b>전략 컨설턴트, 심리 프로파일러, 혹은 전문 연구원</b> 계열이 잘 어울립니다. 에너지를 지키기 위해 규칙적인 생활로 뇌의 과부하를 막고 현실적인 경제 안정을 최우선으로 관리하십시오.",
        "당신의 시그니처인 목(木)은 사람의 마음을 움직이고 위기 상황에서 희망을 주는 섬세한 조력자의 힘을 상징합니다. 감성적인 분위기가 성명의 예술적 파동과 만나 타인의 고통을 공감하고 실질적인 해결책을 주는 사고를 갖게 되었습니다. 당신은 전문적인 조언으로 사람들을 돕는 것을 선호하며, <b>보험 전략 전문가, 전화 상담 매니저, 혹은 심리 치료사</b> 분야가 천직입니다. 에너지를 높이기 위해 감성에만 치우치지 않도록 구체적인 목표 수치를 설정하는 습관을 실천하십시오.",
        "당신의 시그니처인 목(木)은 세상을 깨우는 지식을 보급하고 포용하는 거대한 교육 리더를 의미합니다. 광활한 기운이 성명의 잠재력과 상호작용하여 자신의 철학을 널리 알리는 스승의 사고를 갖게 되었습니다. 당신은 지식을 체계화하여 전수하는 것을 즐기며, <b>전문 강연가, 지식 콘텐츠 디렉터, 혹은 학술 에디터</b> 분야에서 성공합니다. 에너지를 잘 활용하기 위해 자신의 지혜가 세상의 실질적인 부와 연결되는 선순환의 비즈니스 구조를 실천하십시오.",
        "당신의 시그니처인 목(木)은 어둠 속에서 가능성을 발견하고 새 시대를 제안하는 선지자적 에너지를 상징합니다. 강력한 주파수가 고정관념을 깨고 파격적인 대안을 제시하는 사고를 갖게 되었습니다. 당신은 새로운 패러다임을 설계하는 것을 좋아하며, <b>사회 혁신가, 창의적 아티스트, 혹은 미래학 사상가</b> 계열이 잘 어울립니다. 에너지를 보존하기 위해 자신의 비범함을 믿되, 대중의 이해 속도를 기다려주는 인내심을 실천하십시오.",
        "당신의 시그니처인 목(木)은 극한의 역경을 견디고 기어이 성공의 싹을 틔우는 강인한 자생력을 의미합니다. 차가운 땅을 뚫고 나오는 성명의 에너지가 시련 속에서도 실질적인 성취를 일구는 집념의 실행가적 사고를 갖게 되었습니다. 당신은 역경을 딛고 성공하는 과정을 즐기며, <b>군인, 경찰 특공대, 혹은 특수 물류 전문가</b> 분야가 천직입니다. 에너지를 강화하기 위해 독자적인 행동보다는 유력한 파트너와 전략적 동맹을 맺는 기술을 실천하십시오."
    ],
    "화(火)": [
        ...
        "당신의 시그니처인 화(火)는 상상을 현실로 시각화하여 널리 퍼뜨리는 표현의 에너지를 의미합니다. 입춘의 기운과 성명의 화려한 감각이 중첩되어 독창적인 세계관을 구축하는 표현주의적 사고를 갖게 되었습니다. 당신은 새로운 이미지를 창조할 때 가장 강력한 동력을 얻으며, <b>비주얼 디렉터, 영상 크리에이터, 혹은 디지털 아티스트</b> 분야에서 독보적입니다. 에너지를 관리하려면 아이디어를 반드시 결과물로 완성하는 마무리의 집념을 실천하십시오.",
        ...
        "당신의 시그니처인 화(火)는 어떠한 상황에서도 자신을 빛나게 만드는 다재다능한 적응력을 의미합니다. 곡우의 변화무쌍한 에너지가 성명의 다재다능함과 만나 어떤 환경에서도 기회를 만들어내는 자유로운 창작자적 사고를 갖게 되었습니다. 당신은 정해진 틀을 벗어난 자유로운 삶을 추구하며, <b>자유직 기획자, 콘텐츠 디렉터, 혹은 로컬 크리에이터</b> 분야가 잘 어울립니다. 에너지를 지키기 위해 자신만의 확고한 철학적 기준점을 세우고 외부의 평가에 흔들리지 않는 훈련을 실천하십시오.",
    ...
    "토(土)": [
        ...
        "당신의 시그니처인 토(土)는 섬세한 손길로 가치를 창조하고 사람들에게 아름다움을 선물하는 명품 기술자를 의미합니다. 백로의 투명한 이슬값이 대지를 적시듯 성명의 정밀함이 더해져 세밀한 디테일까지 놓치지 않는 장인적 사고를 갖게 되었습니다. 당신은 완벽한 기술적 완성도를 구현하는 일에서 자부심을 느끼며, <b>치과 전문의, 정밀 기공 전문가, 혹은 럭셔리 제품 설계자</b> 분야가 천직입니다. 에너지를 보충하기 위해 기존의 방식에 안주하지 말고 끊임없이 최신 기술을 습득하여 자신의 노하우를 현대화하십시오.",
    ...
    "금(金)": [
        "당신의 시그니처인 금(金)은 어떠한 시련 속에서도 흔들리지 않는 날카로운 결단력과 결기를 의미합니다. 대한의 혹한 속에서 더욱 단단하게 벼려진 성명의 에너지가 위기 상황에서 가장 강력하게 발현되는 해결사적 사고를 갖게 되었습니다. 당신은 혼란을 잠재우고 질서를 완벽히 바로잡는 과정을 즐기며, <b>외과 수술 전문의, 보안 전략 책임자, 혹은 특수 수사 관리직</b> 계열이 천직입니다. 에너지를 잘 쓰기 위해 날카로운 원칙 위에 따뜻한 인간미를 더해 주변 구성원들의 진심 어린 지지를 이끌어내는 유외내강을 실천하십시오.",
        ...
        "당신의 시그니처인 금(金)은 미세한 결함까지 찾아내어 완벽을 완성하는 디테일의 힘을 의미합니다. 입하의 시작되는 열기를 성명이 차갑게 응축하여 견고한 기술적 결과물로 바꿔놓는 전문가적 사고를 갖게 되었습니다. 당신은 현미경처럼 세밀하게 관찰하고 논리적으로 분석하는 과정을 좋아하며, <b>정밀 공학 리더, 하이엔드 기기 제작자, 혹은 안과 전문의</b> 계열이 잘 어울립니다. 에너지를 잘 활용하기 위해 주기적으로 미시적인 업무에서 벗어나 세상 전체의 트렌드를 살피는 거시적 안목을 기르는 여행을 실천하십시오.",
        ...
        "당신의 시그니처인 금(金)은 세상의 난제를 명쾌하게 해결하는 수학적 사고력과 논리적 완결성을 상징합니다. 한로의 서늘한 지성이 성명과 결합하여 난공불락의 문제를 풀어내고 기술의 정점을 선도하는 인재적 사고를 갖게 되었습니다. 당신은 복잡 알고리즘을 설계하고 논리적으로 증명하는 과정을 선호하며, <b>수석 연구 연구원, 기술 전략 수립 전문가, 혹은 알고리즘 설계 리더</b> 분야에서 명성을 얻습니다. 에너지를 높이기 위해 지적인 몰입 뒤에 육체적인 활동으로 에너지를 순환시키는 고강도 운동 루틴을 실천하십시오.",
        ...
        "당신의 시그니처인 금(金)은 역사에 기록될 만한 독보적인 성취와 절대적 가치를 실현하는 전설적 존재를 의미합니다. 동지의 가장 깊은 어둠 속에서 성명의 강직함이 빛나 다이아몬드처럼 찬란한 존재감을 발휘하는 명장적 사고를 갖게 되었습니다. 당신은 인류에 기여하는 거대 과업을 완수하는 것을 좋아하며, <b>하이테크 발명가, 역사적 아티스트, 혹은 전문의 권위자</b> 계열이 잘 어울립니다. 에너지를 보존하기 위해 자신의 비범함을 뽐내기보다 겸손하게 후학을 양성하고 인재를 키우는 덕목을 실천하십시오.",
    ...
    "수(水)": [
        ...
        "당신의 시그니처인 수(水)는 특별한 가치를 알아보는 소수 정예와 깊은 신뢰를 쌓고 자산을 증식시키는 지적인 사교를 의미합니다. 처서의 정돈된 기운 아래 흐르는 성명의 선별력이 당신을 럭셔리 시장의 보좌관으로 성장시켰습니다. 당신은 신뢰 관계와 퀄리티를 중시하며 상류 사회의 길잡이 역할을 선호하며, 에너지를 잘 쓰기 위해 불필요한 인간관계를 과감하게 정리하고 핵심 인맥에만 집중하는 선별의 미학을 실천하십시오.",
        ...
        "당신의 시그니처인 수(水)는 공정함 속에서 법의 정신을 해석하고 사람의 권리를 수호하는 법의 정수를 의미합니다. 추분의 균형감 속에서 성명이 해석의 지혜를 더해 문자를 넘어 정의를 실천하는 투사적 사고를 갖게 되었습니다. 당신은 인권 보호와 정의로운 판결을 선호하며, <b>인권 보호 가이드, 국제법 전략가, 혹은 사회 혁신가</b> 계열이 잘 어울립니다. 에너지를 지키기 위해 세상에 존재하는 수많은 회색 지대를 인정하고 법의 온기를 전하는 따뜻한 법 집행자의 면모를 실천하십시오.",
        ...
        "당신의 시그니처인 수(水)는 복잡한 국제 정세 속에서 해답을 찾아내는 지략가와 글로벌 유통 리더를 상징합니다. 소한의 차가운 물속에 숨겨진 깊은 지혜가 성명과 만나 위기 상황에서 명쾌한 답을 제시하는 지략가적 사고를 갖게 되었습니다. 당신은 큰 판을 짜고 자본과 물류의 흐름을 지휘하는 것을 선호하며, <b>글로벌 유통 가이드, 무역 정책 기획자, 혹은 대기업 전략 지략가</b> 분야에서 전설이 됩니다. 에너지를 지키기 위해 상황이 복잡할수록 단순한 원칙을 고수하는 결단력을 실천하십시오."
    ]
};

const enPrescriptions24 = {
    "Wood": [
        "Your signature Wood represents a powerful life force and planning ability that pierces through stagnant environments. Originally born during the peak of winter's extreme cold with strong static energy, your name's Wood energy intervened to grant you a pioneering mindset that seeks absolute independence and refuses outside help. You enjoy creating your own path; careers in <b>Venture Building, Field Command, or Independent System Design</b> are your true calling. To utilize your energy well, trust your intuition and practice the habit of manualizing your skills.",
        "Your signature Wood symbolizes unstoppable expansion and practical leadership. Born during the vibrant awakening of spring, your name's energy amplified your innate life force, leading you to a mindset of teaching through action rather than just theory. You prefer proving yourself through results; careers as a <b>Police Officer, Specialized Vocational Teacher, or Field Project Manager</b> are where you excel. To manage your energy, let go of stubborn perfectionism and practice the flexibility to match others' paces.",
        "Your signature Wood signifies a flexible communicative energy that establishes order in chaotic situations. Born during the arrival of gentle spring rains, you originally had a highly receptive nature, but your name added firm principles to make you a solver with a sharp inner edge. You like establishing standards amidst confusion; <b>Corporate Dispute Mediation, HR Strategy, or Professional Investigation</b> suits you well. To increase your energy, define clear boundaries between work and life and recharge through regular periods of solitude.",
        "Your signature Wood possesses an innovative frequency that instantly breaks through stagnant atmospheres. Born as nature awakens from its slumber, your name's pulse combined with this energy to grant you an executive mind that brings powerful change to dormant organizations. You enjoy reversing situations through unconventional proposals, excelling in <b>Strategy Marketing Leadership, Security System Innovation, or Trend Directing</b>. To utilize your energy, practice quantifying your inspirations into data and distributing resources efficiently.",
        "Your signature Wood represents a logical design capability that structuralizes the essence of things. Born during the period of perfect balance between day and night in spring, your name allows you to find optimal algorithms between emotion and reason without being swayed by feelings. You like organizing the complex world into simple manuals; <b>Web Architecture, Precision Design, or Forensic Engineering Research</b> are your true calling. To use your energy well, practice reflecting field voices into your designs rather than staying in your logic.",
        "Your signature Wood symbolizes a compassionate guide who discovers others' potential and leads them to the right path. Born during the season of clear vision and insight, your name combined with this energy to grant you an intuitive mind for identifying strengths and correcting flaws. You feel the greatest achievement when seeing others grow correctly; <b>Technical Training Specialist, Career Mentoring, or Professional Educational Administration</b> are your callings. To protect your energy, avoid over-intervening in others' problems and guard your emotional sovereignty.",
        "Your signature Wood signifies the wisdom to systematize vast information and extract practical value. Born when the earth is soaked for a rich harvest, your name grants you a practical economic mindset that turns knowledge into capital and logistics. You prefer curating and delivering valuable information; <b>Pharmacist, Pharmaceutical Distribution Strategy, or Data Editing</b> are your true calling. To utilize your energy, build a mechanical habit of immediately transforming conceptual knowledge into commercial distribution networks.",
        "Your signature Wood symbolizes a noble mindset that seeks high ideals and positively influences society. Born as the first greenery of summer expands, your name's splendor was added to grant you a mindset that pursues both aesthetic and public honor. You like purifying the world through righteous beauty; <b>Visual Branding, Cultural Content Planning, or Environmental Law</b> suit you well. To increase your energy, practice the process of proudly persuading your values through public communication.",
        "Your signature Wood signifies macroscopic leadership that commands an entire organization at a glance. Born during the height of early growth energy, your name grants you an ambitious mind that leads big causes and aims for the top. You enjoy commanding large-scale projects, succeeding in <b>Chief Strategic Operations, High-level Administration, or Global Operations Directing</b>. To use your energy well, practice the 'Leadership of Virtue' by listening to those in lower positions as you reach higher peaks.",
        ...
        "Your signature Wood signifies a precise analytical power that removes unnecessary clutter based on an unshakable center. Born under the intense light of the summer solstice, your name's coolness was added to grant you a perfectionist mind that leaves only the essence. You like flawless production systems, making <b>Policy Planning, Process Engineering Lead, or Quality Assurance Management</b> suit you well. To utilize your energy well, ignore distractions and focus only on the core at every moment.",
        "Your signature Wood signifies persistent patience that achieve great results behind the scenes. Your name absorbed the gradual buildup of late summer heat to grant you a practical mind that pursues solid growth and system stability. You prefer laying strong foundations, excelling in <b>Platform Operations, Strategic Research, or Technical Guidance</b>. To increase your energy, build a habit of giving yourself clear rewards for small achievements to maintain a sustainable working environment.",
        "Your signature Wood symbolizes strong survival skills that find answers even under extreme pressure. Your name broke through the peak heat of summer, granting you a managerial mind that treats any crisis as a growth point. You enjoy solving complex, entangled problems, making <b>Crisis Management, Restructuring, or Corporate Strategy Consulting</b> your true calling. To use your energy well, practice the flexibility of listening to wise advisors rather than relying solely on your own judgment.",
        ...
        "Your signature Wood symbolizes the power of delicate narratives that touch people's hearts and heal souls. Born in the sensitive atmosphere of early snow, your name's artistic pulse grants you an artist's mind that provides hope and empathy. You prefer communicating through writing and artistic media, making <b>Insurance Strategy, Counseling Management, or Psychology</b> your calling. To increase your energy, build a habit of setting clear and realistic numerical goals to balance your natural sensitivity.",
    ...
    "Earth": [
        "Your signature Earth signifies a reliable ground that embraces and supports all life. Born in the peak of winter's extreme cold, your name's tolerance combined with this weight to create a guardian mind. You pursue stability and like being faithful to the basics, making <b>Administrative Policy, Asset Management Lead, or Financial Security</b> your calling. To use your energy well, guard against daily mannerisms and practice the habit of trying intentional small changes every day.",
    ...
    "Metal": [
        "Your signature Metal signifies sharp decisiveness and resolve that does not shake under any trial. Hardened further by the frost of the peak winter cold, your name's energy has resulted in a solver's mind that shines brightest in crisis. You enjoy the process of quieting chaos and correcting order, making <b>Specialized Surgery, Security Strategy, or Criminal Investigation Lead</b> your true calling. To use your energy well, practice adding warm humanity to your sharp principles to gain the sincere support of your team.",
    ...
    "Water": [
        ...
        "Your signature Water signifies originality and mysterious inspiration that will surprise the world by pioneering unknown areas. The extraordinary energy of your name, piercing through the deepest darkness, led you to a genius mind for guiding the future era. You like new trials and creative inventions, making <b>Specialized Specialist, Creative Arts Guide, or High-tech Invention Lead</b> suit you well. To utilize your energy, trust your own uniqueness and move forward unwaveringly while maintaining the virtue of the middle path.",
        "Your signature Water symbolizes a benevolent strategist and global distribution leader who finds answers in international affairs. The deep wisdom hidden in the cold water of late winter met your name, resulting in a strategist's mind for guiding others through crisis. You prefer designing big boards and commanding the flow of capital and logistics, making <b>Global Distribution Guide, Trade Policy Planner, or Corporate Strategy Lead</b> roles your legend. To protect your energy, practice decisiveness by sticking to simple principles as situations become more complex."
    ]
};
